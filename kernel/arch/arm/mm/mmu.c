...
static void __init early_paging_init(const struct machine_desc *mdesc)
{
	...
	/*
	 * FIXME: I don't know why we need to call flush_cache_all here, but
	 * without it, the kernel can't boot up successfully on PZ1, and on
	 * FPGA environment the kernel will boot up more slowly than normal.
	 */
	flush_cache_all();
#endif
