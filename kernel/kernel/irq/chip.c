...
#if defined(CONFIG_ARCH_SSTAR) && defined(CONFIG_SSTAR_SWLA)
#include "../drivers/sstar/include/sstar_swla.h"
#endif
...
void handle_fasteoi_nmi(struct irq_desc *desc)
{
    ...
    #if defined(CONFIG_ARCH_SSTAR) && defined(CONFIG_SSTAR_SWLA)
    sys_swla_log_add_irq(irq, SS_SWLA_LOG_START);
    #endif
	/*
    ...
    #if defined(CONFIG_ARCH_SSTAR) && defined(CONFIG_SSTAR_SWLA)
    sys_swla_log_add_irq(irq, SS_SWLA_LOG_STOP);
    #endif
	if (chip->irq_eoi)
		chip->irq_eoi(&desc->irq_data);
}
