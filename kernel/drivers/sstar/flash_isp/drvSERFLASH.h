...
//  Macro and Define
//-------------------------------------------------------------------------------------------------
#define MSIF_SPIF_LIB_CODE \
    {                      \
        'S', 'P', 'I', 'F' \
    } // Lib code
#define MSIF_SPIF_LIBVER \
    {                    \
        '0', '1'         \
    } // LIB version
#define MSIF_SPIF_BUILDNUM \
    {                      \
        '0', '1'           \
    } // Build Number
#define MSIF_SPIF_CHANGELIST                   \
    {                                          \
        '0', '0', '1', '1', '4', '5', '3', '4' \
...
#define MSIF_CUS  0x0000UL // Sstar Common library
...
#define SPIF_DRV_VERSION                         /* Character String for DRV/API version             */ \
    MSIF_TAG,                                    /* 'MSIF'                                           */ \
        ...
        MSIF_CUS,                                /* 0x0000                                           */ \
        MSIF_MOD,                                /* 0x0000                                           */ \
        MSIF_CHIP, MSIF_CPU, MSIF_SPIF_LIB_CODE, /* IP__                                             */ \
...
#define DEBUG_SER_FLASH(debug_level, x)           \
    do                                            \
    {                                             \
        if (_u8SERFLASHDbgLevel >= (debug_level)) \
            (x);                                  \
    } while (0)
//-------------------------------------------------------------------------------------------------
//  Type and Structure
...
/// [fw : drvBDMA ]
//-------------------------------------------------------------------------------------------------
MS_BOOL MDrv_SERFLASH_CopyHnd(MS_PHYADDR u32FlashAddr, MS_PHYADDR u32DstAddr, MS_U32 u32Len, SPIDMA_Dev eDstDev,
                              MS_U8 u8OpCfg);
