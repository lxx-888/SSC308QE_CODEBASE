...
#define HAL_MIU_MMU_ENTRY_BIT (13)
...
#define hal_miu_err(fmt, args...)  CamOsPrintf("[HAL MIU ERR] [%s@%d] " fmt, __FUNCTION__, __LINE__, ##args)
#define hal_miu_info(fmt, args...) CamOsPrintf(fmt, ##args)
