...
//#define SUPPORT_MULTI_PSRATE
#define MI_AI_SRATE_SUPPORT_NUM 4
extern unsigned int MI_AI_SRATE_SUPPORT_LIST[MI_AI_SRATE_SUPPORT_NUM];
#endif
...
int u_audio_set_rate(struct g_audio *g_audio, int playback, u16 val);
