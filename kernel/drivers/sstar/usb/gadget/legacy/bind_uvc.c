...
static struct UVC_INPUT_HEADER_DESCRIPTOR(1, 6)
...
static struct UVC_FRAME_UNCOMPRESSED(3) uvc_frame_yuy2_5mp = {
	.bLength = UVC_DT_FRAME_UNCOMPRESSED_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_UNCOMPRESSED,
	.bFrameIndex = 6,
	...
	.dwMinBitRate = cpu_to_le32(2592 * 1944 * 2.0 * 8 * 10),
	.dwMaxBitRate = cpu_to_le32(2592 * 1944 * 2.0 * 8 * 10),
	.dwMaxVideoFrameBufferSize = cpu_to_le32(2592 * 1944 * 2.0),
	.dwDefaultFrameInterval = cpu_to_le32(333333),
	.bFrameIntervalType = 3,
	.dwFrameInterval[0] = cpu_to_le32(333333),
	.dwFrameInterval[1] = cpu_to_le32(666666),
...
#define UVC_DESCRIPTOR_HEADERS_OF_YUY2_FRAME                                   \
	(struct uvc_descriptor_header *)&uvc_format_yuy2,                      \
		...
		(struct uvc_descriptor_header *)&uvc_frame_yuy2_5mp,           \
...
static struct UVC_FRAME_UNCOMPRESSED(3) uvc_frame_nv12_5mp = {
	.bLength = UVC_DT_FRAME_UNCOMPRESSED_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_UNCOMPRESSED,
	.bFrameIndex = 6,
	...
	.wWidth = cpu_to_le16(2592),
	.wHeight = cpu_to_le16(1944),
	.dwMinBitRate = cpu_to_le32(2592 * 1944 * 1.5 * 8 * 10),
	.dwMaxBitRate = cpu_to_le32(2592 * 1944 * 1.5 * 8 * 10),
	.dwMaxVideoFrameBufferSize = cpu_to_le32(2592 * 1944 * 1.5),
	.dwDefaultFrameInterval = cpu_to_le32(333333),
	.bFrameIntervalType = 3,
	.dwFrameInterval[0] = cpu_to_le32(333333),
	.dwFrameInterval[1] = cpu_to_le32(666666),
...
#define UVC_DESCRIPTOR_HEADERS_OF_NV12_FRAME                                   \
	(struct uvc_descriptor_header *)&uvc_format_nv12,                      \
		...
		(struct uvc_descriptor_header *)&uvc_frame_nv12_5mp,           \
...
static struct UVC_FRAME_MJPEG(3) uvc_frame_mjpg_5mp = {
	.bLength = UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_MJPEG,
	.bFrameIndex = 6,
	...
	.wWidth = cpu_to_le16(2592),
	.wHeight = cpu_to_le16(1944),
	.dwMinBitRate = cpu_to_le32(2592 * 1944 * 2 * 8 * 10),
	.dwMaxBitRate = cpu_to_le32(2592 * 1944 * 2 * 8 * 10), //overflow
	.dwMaxVideoFrameBufferSize = cpu_to_le32(2592 * 1944 * 2),
	.dwDefaultFrameInterval = cpu_to_le32(333333),
	.bFrameIntervalType = 3,
	.dwFrameInterval[0] = cpu_to_le32(333333),
	.dwFrameInterval[1] = cpu_to_le32(666666),
...
#define UVC_DESCRIPTOR_HEADERS_OF_MJPG_FRAME                                   \
	(struct uvc_descriptor_header *)&uvc_format_mjpg,                      \
		...
		(struct uvc_descriptor_header *)&uvc_frame_mjpg_5mp,           \
...
static struct UVC_FRAME_FRAMEBASE(3) uvc_frame_h264_5mp = {
	.bLength = UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_FRAME_BASED,
	.bFrameIndex = 6,
	...
	.wHeight = cpu_to_le16(1944),
	.dwMinBitRate = cpu_to_le32(2592 * 1944 * 2 * 8 * 10),
	.dwMaxBitRate = cpu_to_le32(2592 * 1944 * 2 * 8 * 10),
	.dwDefaultFrameInterval = cpu_to_le32(333333),
	.bFrameIntervalType = 3,
	.dwFrameInterval[0] = cpu_to_le32(333333),
	.dwFrameInterval[1] = cpu_to_le32(666666),
...
#define UVC_DESCRIPTOR_HEADERS_OF_H264_FRAME                                   \
	(struct uvc_descriptor_header *)&uvc_format_h264,                      \
		...
		(struct uvc_descriptor_header *)&uvc_frame_h264_5mp,           \
...
static struct UVC_FRAME_FRAMEBASE(3) uvc_frame_h265_5mp = {
	.bLength = UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_FRAME_BASED,
	.bFrameIndex = 6,
...
#define UVC_DESCRIPTOR_HEADERS_OF_H265_FRAME                                   \
	(struct uvc_descriptor_header *)&uvc_format_h265,                      \
		...
		(struct uvc_descriptor_header *)&uvc_frame_h265_5mp,           \
...
#ifdef SUPPORT_AV01
static struct uvc_format_framebase uvc_format_av01 = {
	.bLength = UVC_DT_FORMAT_FRAMEBASE_SIZE,
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FORMAT_FRAME_BASED,
	.bFormatIndex = 6,
	.bNumFrameDescriptors = 7,
	.guidFormat = { 'A', 'V', '0', '1', 0x00, 0x00, 0x10, 0x00, 0x80, 0x00,
			0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71 },
	.bBitsPerPixel = 16,
	.bDefaultFrameIndex = 1,
	.bAspectRatioX = 0,
...
static struct UVC_FRAME_FRAMEBASE(3) uvc_frame_av01_240p = {
	.bLength = UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_FRAME_BASED,
	.bFrameIndex = 1,
...
static struct UVC_FRAME_FRAMEBASE(3) uvc_frame_av01_480p = {
	.bLength = UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_FRAME_BASED,
	.bFrameIndex = 2,
...
static struct UVC_FRAME_FRAMEBASE(3) uvc_frame_av01_720p = {
	.bLength = UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_FRAME_BASED,
	.bFrameIndex = 3,
...
static struct UVC_FRAME_FRAMEBASE(3) uvc_frame_av01_1080p = {
	.bLength = UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_FRAME_BASED,
	.bFrameIndex = 4,
...
static struct UVC_FRAME_FRAMEBASE(3) uvc_frame_av01_2kp = {
	.bLength = UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_FRAME_BASED,
	.bFrameIndex = 5,
...
static struct UVC_FRAME_FRAMEBASE(3) uvc_frame_av01_5mp = {
	.bLength = UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_FRAME_BASED,
	.bFrameIndex = 6,
...
static struct UVC_FRAME_FRAMEBASE(3) uvc_frame_av01_4kp = {
	.bLength = UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_FRAME_BASED,
	.bFrameIndex = 7,
...
#define UVC_DESCRIPTOR_HEADERS_OF_AV01_FRAME                                   \
	(struct uvc_descriptor_header *)&uvc_format_av01,                      \
		(struct uvc_descriptor_header *)&uvc_frame_av01_240p,          \
		(struct uvc_descriptor_header *)&uvc_frame_av01_480p,          \
		(struct uvc_descriptor_header *)&uvc_frame_av01_720p,          \
		(struct uvc_descriptor_header *)&uvc_frame_av01_1080p,         \
		(struct uvc_descriptor_header *)&uvc_frame_av01_2kp,           \
		(struct uvc_descriptor_header *)&uvc_frame_av01_5mp,           \
		(struct uvc_descriptor_header *)&uvc_frame_av01_4kp,           \
		(struct uvc_descriptor_header *)&uvc_frame_av01_still_image,   \
		(struct uvc_descriptor_header *)&uvc_color_matching,
#else
#define UVC_DESCRIPTOR_HEADERS_OF_AV01_FRAME
#endif
...
static struct UVC_FRAME_UNCOMPRESSED(3) uvc_frame_ir_340p = {
	.bLength = UVC_DT_FRAME_UNCOMPRESSED_SIZE(3),
	.bDescriptorType = USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_UNCOMPRESSED,
	.bFrameIndex = 1,
	.bmCapabilities = 0,
	.wWidth = cpu_to_le16(340),
	.wHeight = cpu_to_le16(340),
	.dwMinBitRate = cpu_to_le32(340 * 340 * 1.0 * 8 * 10),
	.dwMaxBitRate = cpu_to_le32(340 * 340 * 1.0 * 8 * 30),
	.dwMaxVideoFrameBufferSize = cpu_to_le32(340 * 340 * 1.0),
	.dwDefaultFrameInterval = cpu_to_le32(333333),
	.bFrameIntervalType = 3,
	.dwFrameInterval[0] = cpu_to_le32(333333),
	.dwFrameInterval[1] = cpu_to_le32(666666),
...
#define UVC_DESCRIPTOR_HEADERS_OF_IR_FRAME                                     \
	(struct uvc_descriptor_header *)&uvc_format_ir,                        \
		(struct uvc_descriptor_header *)&uvc_frame_ir_340p,            \
		(struct uvc_descriptor_header *)&uvc_color_matching,
#else
#define UVC_DESCRIPTOR_HEADERS_OF_IR_FRAME
#endif
...
#define UVC_DESCRIPTOR_HEADERS_OF_FRAMES                                       \
	...
	UVC_DESCRIPTOR_HEADERS_OF_AV01_FRAME

#define MAX_FORMAT_COUNT 64
	...
	*uvc_streaming_cls_std[MAX_STREAM_SUPPORT][MAX_FORMAT_COUNT] = {
		{
			...
			UVC_DESCRIPTOR_HEADERS_OF_FRAMES NULL,
		},
		{
...
#else
			UVC_DESCRIPTOR_HEADERS_OF_FRAMES
#endif
				NULL,
		},
		{
