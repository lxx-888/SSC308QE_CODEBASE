...
#define HAL_I2C_REG_FORCE_PUSH_PULL  (0x007)
#define HAL_I2C_MASK_MULT_PUSHEN     BIT0
#define HAL_I2C_MASK_FORCE_DRIVE_OEN BIT1
#define HAL_I2C_MASK_MULT_PUSHEN_NUM (0xFF00)
...
#define HAL_I2C_MASK_INT_BY_PASS     BIT0
#define HAL_I2C_MASK_TSUTDH_OPEN     (BIT5 | BIT4)
#define HAL_I2C_MASK_SCL_ODN_SDA_OEN BIT6
...
#define HAL_I2C_REG_RD_ACK_SCL_DELAY_CNT  (0x0015)
#define HAL_I2C_MASK_RD_ACK_SCL_DELAY_CNT (0xFFFF)
#define HAL_I2C_REG_RD_ACK_SCL_DELAY_EN   (0x0016)
#define HAL_I2C_MASK_RD_ACK_SCL_DELAY_EN  BIT0
#define HAL_I2C_REG_RD_ACK_SDA_DELAY_CNT  (0x0017)
#define HAL_I2C_MASK_RD_ACK_SDA_DELAY_CNT (0xFFFF)
#define HAL_I2C_REG_RD_ACK_SDA_DELAY_EN   (0x0016)
#define HAL_I2C_MASK_RD_ACK_SDA_DELAY_EN  BIT1
...
#define HAL_I2C_BNK_PUSHEN       (IO_ADDRESS(BASE_REG_RIU_PA + (0x1007 << 9)))
#define HAL_I2C_REG_PUSHEN_SCL0  (0x21)
#define HAL_I2C_REG_PUSHEN_SCL1  (0x22)
#define HAL_I2C_REG_PUSHEN_SCL2  (0x23)
#define HAL_I2C_REG_PUSHEN_SCL3  (0x24)
#define HAL_I2C_REG_PUSHEN_SCL4  (0x25)
#define HAL_I2C_REG_PUSHEN_SCL5  (0x26)
#define HAL_I2C_MASK_PUSHEN_SCL0 (BIT0)
#define HAL_I2C_MASK_PUSHEN_SCL1 (BIT0)
#define HAL_I2C_MASK_PUSHEN_SCL2 (BIT0)
#define HAL_I2C_MASK_PUSHEN_SCL3 (BIT0)
#define HAL_I2C_MASK_PUSHEN_SCL4 (BIT0)
#define HAL_I2C_MASK_PUSHEN_SCL5 (BIT0)
