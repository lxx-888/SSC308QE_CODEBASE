...
#define HAL_I2C_CNT_DEC_12M (7)
#define HAL_I2C_CNT_DEC_54M (6)
#define HAL_I2C_CNT_DEC_72M (5)
...
// if set one push enable, it will wait 1T pulse for pull-up
// if don`t set offset h0010 bit6, SCL / SDA waveform is below
//       _
//      / |
// ____|  |___
// it we set offset h0010 bit6, SCL waveform like below
//      __
//     |
// ____/('/' is the time)
//

#define HAL_I2C_SUPPLY_PUSHPULL_12M (2)
#define HAL_I2C_SUPPLY_PUSHPULL_54M (5)
#define HAL_I2C_SUPPLY_PUSHPULL_72M (8)
