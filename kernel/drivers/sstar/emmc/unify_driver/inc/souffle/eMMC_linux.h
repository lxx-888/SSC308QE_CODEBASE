...
#ifndef __eMMC_INFINITY7_LINUX__
#define __eMMC_INFINITY7_LINUX__
...
#define BIT_CLKGEN_FCIE_MASK (BIT6 | BIT5 | BIT4 | BIT3 | BIT2)
...
#define PAD_CHIPTOP_BASE   GET_REG_ADDR(RIU_BASE, REG_BANK_PADTOP)  // 0x103C
#define PAD_CHIPTOP_2_BASE GET_REG_ADDR(RIU_BASE, REG_BANK_CHIPTOP) // 0x101E
...
#define REG_BANK_MIU       GET_REG_ADDR(RIU_PM_BASE, 0xB2B80)       // 1657h
#define PADGPIO_BASE       REG_BANK_PADGPIO2                        // 1104h

#define reg_all_pad_in GET_REG_ADDR(PAD_CHIPTOP_2_BASE, 0x50)
...
#define ENABLE_eMMC_INTERRUPT_MODE 1 // 0 1 for interrupt
#define ENABLE_eMMC_RIU_MODE       0 // for debug cache issue

#define ENABLE_EMMC_POWER_SAVING_MODE 0 // psm on
