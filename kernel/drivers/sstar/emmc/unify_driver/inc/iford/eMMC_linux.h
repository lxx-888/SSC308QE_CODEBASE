...
#define EMMC_NUM_TOTAL 4 // EMMC IP number total
...
#define PAD_CHIPTOP_2_BASE GET_REG_ADDR(RIU_BASE, REG_BANK_CHIPTOP)
...
#define PM_CLKGEN_BANK  GET_REG_ADDR(RIU_PM_BASE, 0x700)  // 0eh
#define PM_PADTOP_BANK  GET_REG_ADDR(RIU_PM_BASE, 0x1F80) // 3fh
#define PM_PADGPIO_BANK GET_REG_ADDR(RIU_PM_BASE, 0x1F80) // 3fh
