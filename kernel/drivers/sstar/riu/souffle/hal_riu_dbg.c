...
static const u16 riu_bridge_range[HAL_RIU_BRIDGE_NUM][2] = {
    {0x1001, 0x166f}, {0x1A00, 0x1B00}, {0x1680, 0x168c}, {0x1300, 0x13ff}, {0x1201, 0x196f}};
#endif
...
s8 hal_riu_bank_to_bridge(u16 bank)
{
    ...
    {
        if ((bank >= riu_bridge_range[bridge][0]) && (bank <= riu_bridge_range[bridge][1]))
            return bridge;
    }
    return -1;
}
