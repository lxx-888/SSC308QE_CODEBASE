...
typedef enum
{
    E_MI_SYS_MBX_DIRECT_CM4_TO_ARM,
    E_MI_SYS_MBX_DIRECT_ARM_TO_CM4,
    E_MI_SYS_MBX_DIRECT_MAX,
} MI_SYS_MbxDirect_e;

typedef enum
{
    E_MI_SYS_DMA_DRAM_TO_PM_SRAM,
    E_MI_SYS_DMA_PM_SRAM_TO_DRAM,
    E_MI_SYS_DMA_DIRECT_MAX,
} MI_SYS_DmaMemCpyDirect_e;
...
typedef struct MI_SYS_FrameData_s
{
    ...
    MI_U16 u16RingBufStartLine; // Valid in case RINGBUF_FRAME_DATA,  u16RingBufStartLine must be LGE than 0 and less
                                // than u16Height
    MI_U16
    u16RingBufRealTotalHeight; /// Valid in case RINGBUF_FRAME_DATA,  u16RingBufStartLine must be LGE than u16Height
