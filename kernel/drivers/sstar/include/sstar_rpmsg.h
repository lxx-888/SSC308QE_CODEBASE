...
#define SS_RPMSG_CREATE_EPT_IOCTL   CAM_OS_IOWR(0xb6, 0x1, struct ss_rpmsg_endpoint_info)
#define SS_RPMSG_DESTROY_EPT_IOCTL  CAM_OS_IO(0xb6, 0x2)
#define SS_RPMSG_DEVICES_INFO_IOCTL CAM_OS_IOWR(0xb6, 0x3, struct ss_rpmsg_devices_info)
#define SS_RPMSG_QUERY_IOCTL        CAM_OS_IOWR(0xb6, 0x4, struct ss_rpmsg_query_info)
#define SS_RPMSG_LOAD_IMAGE_IOCTL   CAM_OS_IOW(0xb6, 0x5, struct ss_rpmsg_image_info)
#define SS_RPMSG_BOOTUP_IOCTL       CAM_OS_IOW(0xb6, 0x6, struct ss_rpmsg_bootup_info)
#define SS_RPMSG_BOOTUP_DONE_IOCTL  CAM_OS_IOW(0xb6, 0x7, struct ss_rpmsg_bootup_done)
