...
#define MIU0_BASE UL(CONFIG_MIU0_BUS_BASE)
#else
#define MIU0_BASE 0x20000000
#endif
#define MIU0_LOW_BASE 0x20000000

/*#define ARM_MIU0_BUS_BASE  UL(CONFIG_MIU0_BUS_BASE)
...
/************************************************
ENABLE LPAE:
0x100000000~0x180000000-1(PA)
0x180000000~0x1a0000000-1(RESERVED)
0x1a0000000~0X200000000-1(VPA)

DISABLE LPAE:
0x20000000~0x40000000-1(PA)
0x40000000~0x50000000-1(RESERVED)
0x50000000~0x60000000-1(VPA)
************************************************/

#define LPAE_MMU_START_BASE 0x1a0000000
#define MMU_START_BASE      0x50000000
...
#define RECORD_IPL_ADDR (IMI_VIRT | 0x18000UL) // IPL
#define RECORD_BL_ADDR  (IMI_VIRT | 0x18800UL) // BL
...
#define BASE_REG_PMPOR_PA          GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x0600)
...
#define BASE_REG_XTAL_ATOP_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x1300)
#define BASE_REG_PMSAR_PA          GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x1400)
#define BASE_REG_PMSAR1_PA         GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x1500)
#define BASE_REG_UPLL2_PA          GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x1800)
#define BASE_REG_RADAR_ADC_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x1B00)
#define BASE_REG_RTCPLL_PA         GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x1D00)
...
#define BASE_REG_WDT_PA            GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x3000)
#define BASE_REG_RTC_PA            GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x3400)
#define BASE_REG_DIDKEY_PA         GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x3800)
#define BASE_REG_PMPADTOP_PA       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x3F00)
#define BASE_REG_PATGEN_USB30_PA   GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0xA100)
#define BASE_REG_UTMI0_PA          GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0xAA00)
#define BASE_REG_UTMI2_PA          GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0xB200)
#define BASE_REG_USB3_DRD_PHYD_PA  GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0xB400)
#define BASE_REG_USB3_DRD_PHYA0_PA GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0xB500)
#define BASE_REG_PATGEN_LPC2_PA    GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x011600)
#define BASE_REG_LPC2_TOP_PA       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x011700)

#define BASE_REG_BDMA0_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100200)
#define BASE_REG_BDMA1_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100240)
#define BASE_REG_BDMA2_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100280)
#define BASE_REG_BDMA3_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x1002C0)
#define BASE_REG_SEM_PA        GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100300)
...
#define BASE_REG_INTRCTL2_PA   GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x101500)
...
#define BASE_REG_MIU_ARB       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x101100)
#define BASE_REG_MIU_E_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x101300)
...
#define BASE_REG_MCU_PA        GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x102000)
#define BASE_REG_L3_BRIDGE_PA  GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x102200)
#define BASE_REG_OTP3_PA       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x102300)
#define BASE_REG_RISCVPLL_PA   GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x102b00)
#define BASE_REG_VENPLL_PA     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x102c00)
#define BASE_REG_ISPPLL_PA     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x102d00)
#define BASE_REG_MIUPLL_PA     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103100)
#define BASE_REG_CPUPLL_PA     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103200)
#define BASE_REG_IPUPLL_PA     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103500)
#define BASE_REG_DISPPLL_PA    GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103700)
#define BASE_REG_CLKGEN_PA     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103800)
#define BASE_REG_GMACPLLTOP_PA GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103A00)
...
#define BASE_REG_CLKGEN2_PA    GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103F00)
...
#define BASE_REG_SDPLL_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x141900)
#define BASE_REG_EMMCPLL_PA    GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x141A00)
#define BASE_REG_AUPLL_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x141D00)
...
#define BASE_REG_BACHPLL_PA    GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x150600)
#define BASE_REG_ALBANY0_PA    GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x151800)
#define BASE_REG_ALBANY1_PA    GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x151900)
#define BASE_REG_ALBANY2_PA    GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x151A00)

#define BASE_REG_MIU_PA     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x161000)
#define BASE_REG_MIU_PA_CFG GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x161100)

#define BASE_REG_MIU_DIG GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x101200)

#define BASE_REG_MIU_MISC_CH0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x164200)

#define BASE_REG_MIU_ATOP GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x164700)

#define BASE_REG_MIU_GRP_SC0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165000)
#define BASE_REG_MIU_GRP_SC1 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165100)

//#define BASE_REG_MIU_GRP_SC2     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165D00)
#define BASE_REG_MIU_GRP_ISP0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165200)
//#define BASE_REG_MIU_GRP_DISP0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165400)
#define BASE_REG_MIU_GRP_MISC0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165700)
//#define BASE_REG_MIU_GRP_DIG0    GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x166600)
#define BASE_REG_MIU_GRP_MISC1 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x166A00)
//#define BASE_REG_MIU_GRP_NET0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x150A00)

#define BASE_REG_MIU_PRE_ARB0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165800)
#define BASE_REG_MIU_PRE_ARB1 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x161200)

#define BASE_REG_MIU_MMU GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165900)

#define BASE_REG_MIU_PROTECT     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165A00)
#define BASE_REG_MIU_PROTECT_SUB GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165B00)
#define BASE_REG_MMU_PROTECT     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165C00)
#define BASE_REG_PROTECT_ID      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165F00)

#define BASE_REG_MIU_EFFI_SC0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x166800)
#define BASE_REG_MIU_EFFI_SC1 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x166900)
//#define BASE_REG_MIU_EFFI_SC2    GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x166A00)
#define BASE_REG_MIU_EFFI_ISP0  GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x166B00)
#define BASE_REG_MIU_EFFI_MISC0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x166C00)
#define BASE_REG_MIU_EFFI_MISC1 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x166A00)
//#define BASE_REG_MIU_EFFI_DISP0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x166D00)
//#define BASE_REG_MIU_EFFI_DIG0   GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x166700)
//#define BASE_REG_MIU_EFFI_NET0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x150B00)

#define BASE_REG_MIU_TZSP_PA        GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x161900)
#define BASE_REG_MIU_TZSP_GRP_ISP0  GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x161A00)
#define BASE_REG_MIU_TZSP_GRP_MISC0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x161B00)
#define BASE_REG_MIU_TZSP_GRP_MISC1 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x161C00)
#define BASE_REG_MIU_TZSP_GRP_SC0   GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x161D00)
#define BASE_REG_MIU_TZSP_GRP_SC1   GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x161E00)
#define BASE_REG_TZMISC             GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x11FE00)

#define BASE_REG_MIU0_0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x1AA000)
#define BASE_REG_MIU0_1 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x1AA100)
