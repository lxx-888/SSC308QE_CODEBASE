...
#define _IOC(dir, type, nr, size) (((dir) << 0) | ((type) << 8) | ((nr) << 16) | ((size) << 24))
...
#define CamDevOpen(a)         (0)
#define CamDevClose(a)        (0)
#define CamDevIoctl(a, b, c)  (0)
#define CamDevPoll(a, b, c)   (0)
#define CamDevMmap(a, b, c)   (0)
#define CamDevMunmap(a, b, c) (0)
#define CamDevRead(a, b, c)   (0)
#define CamDevWrite(a, b, c)  (0)
