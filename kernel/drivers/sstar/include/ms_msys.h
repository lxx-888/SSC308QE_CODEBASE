...
extern void msys_watchdog_notify(const unsigned int time);
#ifndef ALKAID_SDK
...
#endif
extern struct CamClass *msys_get_sysfs_camclass(void);
extern struct CamClass *msys_get_sysfs_ut_camclass(void);
...
extern int  msys_dma_copy_to_pmimi(MSYS_DMA_COPY *cfg);
extern int  msys_dma_copy_from_pmimi(MSYS_DMA_COPY *cfg);
extern int  msys_dma_copy_to_psram(MSYS_DMA_COPY *cfg);
extern int  msys_dma_copy_from_psram(MSYS_DMA_COPY *cfg);
