...
/* REG FILENAME: iford\iford_reg_CLKGEN.xls, iford\iford_reg_CLKGEN2.xls, iford\iford_reg_pm_sleep.xls,
 * iford\iford_reg_block.xls, iford\iford_reg_CHIPTOP.xls */
...
#define REG_SPI_CTL_BASE      0x1F202A00

//====SPECIAL_CKG_REG==============================================
#define REG_CKG_SPI        (REG_SPI_CTL_BASE + 0x2A * 4)
#define REG_CKG_SPI_OFFSET (0)

#define REG_BACH_SW_RSTN_BASE   (REG_SC_GP_CTRL_BASE + 0x48 * 4)
#define REG_BACH_SW_RSTN_OFFSET (0)
...
#define REG_SW_RSTZ_LDC_BASE   (REG_SC_GP_CTRL_BASE + 0x41 * 4)
#define REG_SW_RSTZ_LDC_OFFSET (0)

//====PM_CKG_REG==============================================
#define REG_CKG_BIST_PM_BASE   (REG_PM_SLEEP_CKG_BASE + 0x42 * 4)
#define REG_CKG_BIST_PM_OFFSET (0)

#define REG_CKG_CM4_BASE   (REG_PM_SLEEP_CKG_BASE + 0x59 * 4)
#define REG_CKG_CM4_OFFSET (0)

#define REG_CKG_IR_BASE   (REG_PM_SLEEP_CKG_BASE + 0x21 * 4)
#define REG_CKG_IR_OFFSET (5)

#define REG_CKG_PIR_PM_BASE   (REG_PM_SLEEP_CKG_BASE + 0x26 * 4)
#define REG_CKG_PIR_PM_OFFSET (5)

#define REG_CKG_PM_FUART0_BASE   (REG_PM_SLEEP_CKG_BASE + 0x42 * 4)
#define REG_CKG_PM_FUART0_OFFSET (8)

#define REG_CKG_PM_FUART1_BASE   (REG_PM_SLEEP_CKG_BASE + 0x42 * 4)
#define REG_CKG_PM_FUART1_OFFSET (12)
...
#define REG_CKG_PM_MODE_BASE   (REG_PM_SLEEP_CKG_BASE + 0x6A * 4)
#define REG_CKG_PM_MODE_OFFSET (0)

#define REG_CKG_PM_PSPI0_BASE   (REG_PM_SLEEP_CKG_BASE + 0x21 * 4)
#define REG_CKG_PM_PSPI0_OFFSET (10)
...
#define REG_CKG_PM_SDIO_BASE   (REG_PM_SLEEP_CKG_BASE + 0x24 * 4)
#define REG_CKG_PM_SDIO_OFFSET (11)

#define REG_CKG_PM_SLEEP_BASE   (REG_PM_SLEEP_CKG_BASE + 0x22 * 4)
#define REG_CKG_PM_SLEEP_OFFSET (10)

#define REG_CKG_PM_SR_MCLK_BASE   (REG_PM_SLEEP_CKG_BASE + 0x45 * 4)
#define REG_CKG_PM_SR_MCLK_OFFSET (8)
...
#define REG_CKG_SDIO_PHASE_BASE   (REG_PM_SLEEP_CKG_BASE + 0x24 * 4)
#define REG_CKG_SDIO_PHASE_OFFSET (0)

#define REG_CKG_SSI_DPHY_BASE   (REG_PM_SLEEP_CKG_BASE + 0x46 * 4)
#define REG_CKG_SSI_DPHY_OFFSET (4)

#define REG_CKG_TIMER_BASE   (REG_PM_SLEEP_CKG_BASE + 0x33 * 4)
#define REG_CKG_TIMER_OFFSET (0)

#define REG_CKG_VIF_PM_BASE   (REG_PM_SLEEP_CKG_BASE + 0x45 * 4)
#define REG_CKG_VIF_PM_OFFSET (0)

#define REG_CKG_WDT_BASE   (REG_PM_SLEEP_CKG_BASE + 0x23 * 4)
#define REG_CKG_WDT_OFFSET (4)

//====NORMAL_CKG_REG==============================================
#define REG_ARMPLL_37P125M_FORCE_OFF_BASE   (REG_CKG_BASE + 0x74 * 4)
#define REG_ARMPLL_37P125M_FORCE_OFF_OFFSET (8)
...
#define REG_CKG_BIST_ISP_GP_OFFSET (4)
...
#define REG_CKG_CSI0_MAC_LPTX_TOP_I_BASE   (REG_CKG_BASE + 0x58 * 4)
#define REG_CKG_CSI0_MAC_LPTX_TOP_I_OFFSET (0)

#define REG_CKG_CSI0_MAC_TOP_I_BASE   (REG_CKG_BASE + 0x58 * 4)
#define REG_CKG_CSI0_MAC_TOP_I_OFFSET (8)

#define REG_CKG_CSI0_NS_TOP_I_BASE   (REG_CKG_BASE + 0x59 * 4)
#define REG_CKG_CSI0_NS_TOP_I_OFFSET (0)

#define REG_CKG_CSI1_MAC_LPTX_TOP_I_BASE   (REG_CKG_BASE + 0x59 * 4)
#define REG_CKG_CSI1_MAC_LPTX_TOP_I_OFFSET (8)

#define REG_CKG_CSI1_MAC_TOP_I_BASE   (REG_CKG_BASE + 0x5A * 4)
#define REG_CKG_CSI1_MAC_TOP_I_OFFSET (0)

#define REG_CKG_CSI1_NS_TOP_I_BASE   (REG_CKG_BASE + 0x5A * 4)
#define REG_CKG_CSI1_NS_TOP_I_OFFSET (8)
...
#define REG_CKG_HEMCU_BASE   (REG_CKG_BASE + 0x21 * 4)
#define REG_CKG_HEMCU_OFFSET (0)
...
#define REG_CKG_PM_HIGH_EXT_BASE   (REG_CKG_BASE + 0x10 * 4)
#define REG_CKG_PM_HIGH_EXT_OFFSET (0)
...
#define REG_CKG_SPI_NONPM_BASE   (REG_CKG_BASE + 0x32 * 4)
#define REG_CKG_SPI_NONPM_OFFSET (0)
...
#define REG_CKG_UPLL_SYN_GATE_BASE   (REG_CKG2_BASE + 0x4E * 4)
#define REG_CKG_UPLL_SYN_GATE_OFFSET (4)

#define REG_CKG_VEN_AXI_BASE   (REG_CKG_BASE + 0x69 * 4)
#define REG_CKG_VEN_AXI_OFFSET (8)

#define REG_CKG_VEN_SCDN_BASE   (REG_CKG2_BASE + 0x79 * 4)
#define REG_CKG_VEN_SCDN_OFFSET (0)

#define REG_CKG_VEN_SC_IF_BASE   (REG_CKG2_BASE + 0x12 * 4)
#define REG_CKG_VEN_SC_IF_OFFSET (8)
...
#define REG_CLK_AESDMA_DFS_CFG_BASE   (REG_CKG_BASE + 0x7A * 4)
#define REG_CLK_AESDMA_DFS_CFG_OFFSET (1)

#define REG_CLK_AESDMA_DFS_EN_BASE   (REG_CKG_BASE + 0x7A * 4)
#define REG_CLK_AESDMA_DFS_EN_OFFSET (0)

#define REG_CLK_CSI0_MAC_LPTX_DFS_CFG_BASE   (REG_CKG_BASE + 0x7A * 4)
#define REG_CLK_CSI0_MAC_LPTX_DFS_CFG_OFFSET (9)

#define REG_CLK_CSI0_MAC_LPTX_DFS_EN_BASE   (REG_CKG_BASE + 0x7A * 4)
#define REG_CLK_CSI0_MAC_LPTX_DFS_EN_OFFSET (8)

#define REG_CLK_CSI0_MAC_TOP_I_DFS_CFG_BASE   (REG_CKG_BASE + 0x7C * 4)
#define REG_CLK_CSI0_MAC_TOP_I_DFS_CFG_OFFSET (1)

#define REG_CLK_CSI0_MAC_TOP_I_DFS_EN_BASE   (REG_CKG_BASE + 0x7C * 4)
#define REG_CLK_CSI0_MAC_TOP_I_DFS_EN_OFFSET (0)

#define REG_CLK_CSI0_NS_TOP_I_DFS_CFG_BASE   (REG_CKG_BASE + 0x7B * 4)
#define REG_CLK_CSI0_NS_TOP_I_DFS_CFG_OFFSET (9)

#define REG_CLK_CSI0_NS_TOP_I_DFS_EN_BASE   (REG_CKG_BASE + 0x7B * 4)
#define REG_CLK_CSI0_NS_TOP_I_DFS_EN_OFFSET (8)

#define REG_CLK_CSI1_MAC_LPTX_DFS_CFG_BASE   (REG_CKG_BASE + 0x7C * 4)
#define REG_CLK_CSI1_MAC_LPTX_DFS_CFG_OFFSET (9)

#define REG_CLK_CSI1_MAC_LPTX_DFS_EN_BASE   (REG_CKG_BASE + 0x7C * 4)
#define REG_CLK_CSI1_MAC_LPTX_DFS_EN_OFFSET (8)

#define REG_CLK_CSI1_MAC_TOP_I_DFS_CFG_BASE   (REG_CKG_BASE + 0x7D * 4)
#define REG_CLK_CSI1_MAC_TOP_I_DFS_CFG_OFFSET (9)

#define REG_CLK_CSI1_MAC_TOP_I_DFS_EN_BASE   (REG_CKG_BASE + 0x7D * 4)
#define REG_CLK_CSI1_MAC_TOP_I_DFS_EN_OFFSET (8)

#define REG_CLK_CSI1_NS_TOP_I_DFS_CFG_BASE   (REG_CKG_BASE + 0x7D * 4)
#define REG_CLK_CSI1_NS_TOP_I_DFS_CFG_OFFSET (1)

#define REG_CLK_CSI1_NS_TOP_I_DFS_EN_BASE   (REG_CKG_BASE + 0x7D * 4)
#define REG_CLK_CSI1_NS_TOP_I_DFS_EN_OFFSET (0)
...
#define REG_CLK_EMAC_DFS_CFG_BASE   (REG_CKG_BASE + 0x75 * 4)
#define REG_CLK_EMAC_DFS_CFG_OFFSET (9)

#define REG_CLK_EMAC_DFS_EN_BASE   (REG_CKG_BASE + 0x75 * 4)
#define REG_CLK_EMAC_DFS_EN_OFFSET (8)
...
#define REG_CLK_LDCFEYE_DFS_CFG_BASE   (REG_CKG_BASE + 0x78 * 4)
#define REG_CLK_LDCFEYE_DFS_CFG_OFFSET (1)

#define REG_CLK_LDCFEYE_DFS_EN_BASE   (REG_CKG_BASE + 0x78 * 4)
#define REG_CLK_LDCFEYE_DFS_EN_OFFSET (0)

#define REG_CLK_MFE0_DFS_CFG_BASE   (REG_CKG2_BASE + 0x3A * 4)
#define REG_CLK_MFE0_DFS_CFG_OFFSET (1)

#define REG_CLK_MFE0_DFS_EN_BASE   (REG_CKG2_BASE + 0x3A * 4)
#define REG_CLK_MFE0_DFS_EN_OFFSET (0)
...
#define REG_CLK_SD_DFS_CFG_BASE   (REG_CKG_BASE + 0x6F * 4)
#define REG_CLK_SD_DFS_CFG_OFFSET (1)

#define REG_CLK_SD_DFS_EN_BASE   (REG_CKG_BASE + 0x6F * 4)
#define REG_CLK_SD_DFS_EN_OFFSET (0)

#define REG_CLK_SR00_MCLK_DFS_CFG_BASE   (REG_CKG_BASE + 0x76 * 4)
#define REG_CLK_SR00_MCLK_DFS_CFG_OFFSET (9)

#define REG_CLK_SR00_MCLK_DFS_EN_BASE   (REG_CKG_BASE + 0x76 * 4)
#define REG_CLK_SR00_MCLK_DFS_EN_OFFSET (8)

#define REG_CLK_SR01_MCLK_DFS_CFG_BASE   (REG_CKG_BASE + 0x77 * 4)
#define REG_CLK_SR01_MCLK_DFS_CFG_OFFSET (9)

#define REG_CLK_SR01_MCLK_DFS_EN_BASE   (REG_CKG_BASE + 0x77 * 4)
#define REG_CLK_SR01_MCLK_DFS_EN_OFFSET (8)

#define REG_CLK_SR02_MCLK_DFS_CFG_BASE   (REG_CKG_BASE + 0x78 * 4)
#define REG_CLK_SR02_MCLK_DFS_CFG_OFFSET (9)

#define REG_CLK_SR02_MCLK_DFS_EN_BASE   (REG_CKG_BASE + 0x78 * 4)
#define REG_CLK_SR02_MCLK_DFS_EN_OFFSET (8)

#define REG_CLK_SR03_MCLK_DFS_CFG_BASE   (REG_CKG_BASE + 0x79 * 4)
#define REG_CLK_SR03_MCLK_DFS_CFG_OFFSET (9)

#define REG_CLK_SR03_MCLK_DFS_EN_BASE   (REG_CKG_BASE + 0x79 * 4)
#define REG_CLK_SR03_MCLK_DFS_EN_OFFSET (8)

#define REG_CLK_VEN0_AXI_DFS_CFG_BASE   (REG_CKG2_BASE + 0x39 * 4)
#define REG_CLK_VEN0_AXI_DFS_CFG_OFFSET (9)

#define REG_CLK_VEN0_AXI_DFS_EN_BASE   (REG_CKG2_BASE + 0x39 * 4)
#define REG_CLK_VEN0_AXI_DFS_EN_OFFSET (8)

#define REG_CLK_VEN0_SCDN_DFS_CFG_BASE   (REG_CKG2_BASE + 0x78 * 4)
#define REG_CLK_VEN0_SCDN_DFS_CFG_OFFSET (1)

#define REG_CLK_VEN0_SCDN_DFS_EN_BASE   (REG_CKG2_BASE + 0x78 * 4)
#define REG_CLK_VEN0_SCDN_DFS_EN_OFFSET (0)

#define REG_CLK_VEN0_SC_IF_DFS_CFG_BASE   (REG_CKG2_BASE + 0x3A * 4)
#define REG_CLK_VEN0_SC_IF_DFS_CFG_OFFSET (9)

#define REG_CLK_VEN0_SC_IF_DFS_EN_BASE   (REG_CKG2_BASE + 0x3A * 4)
#define REG_CLK_VEN0_SC_IF_DFS_EN_OFFSET (8)

#define REG_CLK_VHE0_DFS_CFG_BASE   (REG_CKG2_BASE + 0x39 * 4)
#define REG_CLK_VHE0_DFS_CFG_OFFSET (1)

#define REG_CLK_VHE0_DFS_EN_BASE   (REG_CKG2_BASE + 0x39 * 4)
#define REG_CLK_VHE0_DFS_EN_OFFSET (0)

#define REG_DBG_WDMA_CLK_MIU_CKG_BASE   (REG_CKG2_BASE + 0x7B * 4)
#define REG_DBG_WDMA_CLK_MIU_CKG_OFFSET (0)

#define REG_DISPPLL_FORCE_OFF_BASE   (REG_CKG_BASE + 0x72 * 4)
#define REG_DISPPLL_FORCE_OFF_OFFSET (15)

#define REG_DISPPLL_FORCE_ON_BASE   (REG_CKG_BASE + 0x71 * 4)
#define REG_DISPPLL_FORCE_ON_OFFSET (15)

#define REG_MIUPLL_FORCE_OFF_BASE   (REG_CKG_BASE + 0x74 * 4)
#define REG_MIUPLL_FORCE_OFF_OFFSET (10)

#define REG_MIUPLL_FORCE_ON_BASE   (REG_CKG_BASE + 0x74 * 4)
#define REG_MIUPLL_FORCE_ON_OFFSET (13)
...
#define REG_SPIPLL_FORCE_OFF_BASE   (REG_CKG_BASE + 0x74 * 4)
#define REG_SPIPLL_FORCE_OFF_OFFSET (9)

#define REG_SPIPLL_FORCE_ON_BASE   (REG_CKG_BASE + 0x74 * 4)
#define REG_SPIPLL_FORCE_ON_OFFSET (12)

#define REG_TESTCLK_SEL_BASE   (REG_CKG_BASE + 0x74 * 4)
#define REG_TESTCLK_SEL_OFFSET (0)

#define REG_TOP_CNTVALUEB_DFS_CLK_DIV_CFG_BASE   (REG_CKG2_BASE + 0x7A * 4)
#define REG_TOP_CNTVALUEB_DFS_CLK_DIV_CFG_OFFSET (0)

#define REG_TOP_CNTVALUEB_DFS_CLK_UPDATE_CFG_BASE   (REG_CKG2_BASE + 0x7A * 4)
#define REG_TOP_CNTVALUEB_DFS_CLK_UPDATE_CFG_OFFSET (8)

#define REG_TOP_CNTVALUEB_DFS_EN_CFG_BASE   (REG_CKG2_BASE + 0x7A * 4)
