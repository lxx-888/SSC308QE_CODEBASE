...
#define INT_IRQ_UART2MCU         (GIC_SPI_MS_IRQ_START + 13)
#define INT_IRQ_MMU              (GIC_SPI_MS_IRQ_START + 14)
#define INT_IRQ_OTP              (GIC_SPI_MS_IRQ_START + 15)
#define INT_IRQ_IRQ2HST_0        (GIC_SPI_MS_IRQ_START + 16)
...
#define INT_IRQ_IMI              (GIC_SPI_MS_IRQ_START + 39)
...
#define INT_IRQ_SC_DISP          (GIC_SPI_MS_IRQ_START + 46)
...
#define INT_IRQ_LDC_FEYE_0       (GIC_SPI_MS_IRQ_START + 62)
...
#define INT_FIQ_DUMMY_18        (GIC_SPI_MS_FIQ_START + 18)
