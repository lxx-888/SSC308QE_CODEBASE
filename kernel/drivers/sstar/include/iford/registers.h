...
#define BASE_REG_IRQ_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x2B00)
...
#define BASE_REG_RIUDBG_PA   GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100100)
#define BASE_REG_RIUDBG1_PA  GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x167000)
...
#define BASE_REG_GPI_INT2_PA   GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x110500)
#define BASE_REG_XTAL_ATOP_PA  GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x111B00)
...
#define BASE_REG_VENPLL_PA     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103600)
#define BASE_REG_L3BRIDGE      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x102200)
...
#define BASE_REG_MIU_DFS1_AC GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x161400)

#define BASE_REG_MIU_MISC_CH0 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x164200)
#define BASE_REG_MIU_MISC_CH1 GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x164500)
#define BASE_REG_MIU_ATOP     GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x164700)
#define BASE_REG_MIU_ATOP_G   GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x164A00)
...
#define BASE_REG_MIU_PRE_ARB GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x165800)
...
#define BASE_REG_MIU_DFS GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x161400)
...
#define REG_MAILBOX_PARTNAME      (BASE_REG_MAILBOX_PA + REG_ID_0F)
#define PARTNAME_PACKAGE_SHIFT    (11)
#define PARTNAME_PACKAGE_MASK     (3 << PARTNAME_PACKAGE_SHIFT)
#define PARTNAME_PACKAGE_QFN88    (0 << PARTNAME_PACKAGE_SHIFT)
#define PARTNAME_PACKAGE_QFN128   (1 << PARTNAME_PACKAGE_SHIFT)
#define PARTNAME_PACKAGE_BGA8x8   (2 << PARTNAME_PACKAGE_SHIFT)
#define PARTNAME_PACKAGE_BGA11x11 (3 << PARTNAME_PACKAGE_SHIFT)

#define RECORD_IPL_ADDR (0xC0002000UL)        // IPL
