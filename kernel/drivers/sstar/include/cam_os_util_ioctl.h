...
#define CAM_OS_IOC(dir, type, nr, size)                                                               \
    (((dir) << CAM_OS_IOC_DIRSHIFT) | ((type) << CAM_OS_IOC_TYPESHIFT) | ((nr) << CAM_OS_IOC_NRSHIFT) \
...
#define CAM_OS_IOWR(type, nr, size) \
    CAM_OS_IOC(CAM_OS_IOC_READ | CAM_OS_IOC_WRITE, (type), (nr), (CAM_OS_IOC_TYPECHECK(size)))
