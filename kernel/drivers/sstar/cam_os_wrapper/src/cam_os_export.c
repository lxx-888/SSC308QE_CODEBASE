...
EXPORT_SYMBOL(CamOsSscanf);
EXPORT_SYMBOL(CamOsGetChar);
EXPORT_SYMBOL(CamOsSprintf);
EXPORT_SYMBOL(CamOsSnprintf);
EXPORT_SYMBOL(CamOsVsnprintf);
EXPORT_SYMBOL(CamOsHexdump);
EXPORT_SYMBOL(CamOsMsSleep);
EXPORT_SYMBOL(CamOsMsSleepInterruptible);
...
EXPORT_SYMBOL(CamOsGetTaskSchedRunTime);
EXPORT_SYMBOL(CamOsTimeDiff);
EXPORT_SYMBOL(CamOsGetTimeInMs);
EXPORT_SYMBOL(CamOsGetJiffies);
EXPORT_SYMBOL(CamOsGetHz);
EXPORT_SYMBOL(CamOsJiffiesToMs);
EXPORT_SYMBOL(CamOsJiffiesToNs);
EXPORT_SYMBOL(CamOsMsToJiffies);
EXPORT_SYMBOL(CamOsNsToJiffies);
EXPORT_SYMBOL(CamOsJiffiesDiff);
EXPORT_SYMBOL(CamOsThreadCreate);
EXPORT_SYMBOL(CamOsThreadChangePriority);
EXPORT_SYMBOL(CamOsThreadChangePriorityByPid);
EXPORT_SYMBOL(CamOsThreadSetAffinity);
EXPORT_SYMBOL(CamOsThreadSetAffinityByPid);
...
EXPORT_SYMBOL(CamOsThreadGetPID);
EXPORT_SYMBOL(CamOsCpumaskSetCpu);
EXPORT_SYMBOL(CamOsCpumaskSetAll);
EXPORT_SYMBOL(CamOsCpumaskClearCpu);
EXPORT_SYMBOL(CamOsCpumaskClearAll);
EXPORT_SYMBOL(CamOsCpumaskGetOnline);
...
EXPORT_SYMBOL(CamOsWorkQueueCreateExt);
EXPORT_SYMBOL(CamOsWorkQueueDestroy);
EXPORT_SYMBOL(CamOsWorkQueueAdd);
EXPORT_SYMBOL(CamOsWorkQueueCancel);
EXPORT_SYMBOL(CamOsMsgQueueCreate);
EXPORT_SYMBOL(CamOsMsgQueueDestroy);
EXPORT_SYMBOL(CamOsMsgQueueEnqueue);
EXPORT_SYMBOL(CamOsMsgQueueDequeue);
EXPORT_SYMBOL(CamOsMsgQueueAvailable);
EXPORT_SYMBOL(CamOsMemAlloc);
EXPORT_SYMBOL(CamOsMemAllocAtomic);
EXPORT_SYMBOL(CamOsMemCalloc);
EXPORT_SYMBOL(CamOsMemCallocAtomic);
...
EXPORT_SYMBOL(CamOsContiguousMemAlloc);
EXPORT_SYMBOL(CamOsContiguousMemRelease);
EXPORT_SYMBOL(CamOsContiguousMemStat);
EXPORT_SYMBOL(CamOsMemPhysToMiu);
EXPORT_SYMBOL(CamOsMemMiuToPhys);
EXPORT_SYMBOL(CamOsMemVirtToPhys);
EXPORT_SYMBOL(CamOsAccessOk);
EXPORT_SYMBOL(CamOsIoremap);
...
EXPORT_SYMBOL(CamOsTimerDeinit);
...
EXPORT_SYMBOL(CamOsAtomic64Read);
EXPORT_SYMBOL(CamOsAtomic64Set);
EXPORT_SYMBOL(CamOsAtomic64AddReturn);
EXPORT_SYMBOL(CamOsAtomic64SubReturn);
EXPORT_SYMBOL(CamOsAtomic64SubAndTest);
EXPORT_SYMBOL(CamOsAtomic64IncReturn);
EXPORT_SYMBOL(CamOsAtomic64DecReturn);
EXPORT_SYMBOL(CamOsAtomic64IncAndTest);
EXPORT_SYMBOL(CamOsAtomic64DecAndTest);
EXPORT_SYMBOL(CamOsAtomic64AddNegative);
EXPORT_SYMBOL(CamOsAtomic64CompareAndSwap);
EXPORT_SYMBOL(CamOsAtomic64AndFetch);
EXPORT_SYMBOL(CamOsAtomic64FetchAnd);
EXPORT_SYMBOL(CamOsAtomic64NandFetch);
EXPORT_SYMBOL(CamOsAtomic64FetchNand);
EXPORT_SYMBOL(CamOsAtomic64OrFetch);
EXPORT_SYMBOL(CamOsAtomic64FetchOr);
EXPORT_SYMBOL(CamOsAtomic64XorFetch);
EXPORT_SYMBOL(CamOsAtomic64FetchXor);
EXPORT_SYMBOL(CamOsIdrInit);
EXPORT_SYMBOL(CamOsIdrInitEx);
EXPORT_SYMBOL(CamOsIdrDestroy);
EXPORT_SYMBOL(CamOsIdrAlloc);
EXPORT_SYMBOL(CamOsIdrAllocCyclic);
...
EXPORT_SYMBOL(CamOsMemcpy);
EXPORT_SYMBOL(CamOsMemmove);
EXPORT_SYMBOL(CamOsMemset);
EXPORT_SYMBOL(CamOsMemcmp);
EXPORT_SYMBOL(CamOsStrstr);
EXPORT_SYMBOL(CamOsStrncpy);
EXPORT_SYMBOL(CamOsStrncmp);
EXPORT_SYMBOL(CamOsStrncasecmp);
EXPORT_SYMBOL(CamOsStrlen);
EXPORT_SYMBOL(CamOsStrcat);
EXPORT_SYMBOL(CamOsStrsep);
EXPORT_SYMBOL(CamOsStrchr);
EXPORT_SYMBOL(CamOsStrrchr);
EXPORT_SYMBOL(CamOsStrtol);
EXPORT_SYMBOL(CamOsStrtoul);
EXPORT_SYMBOL(CamOsStrtoull);
EXPORT_SYMBOL(_CamOsFindFirstZeroBit);
EXPORT_SYMBOL(CamOsListSort);
EXPORT_SYMBOL(CamOsQsort);
EXPORT_SYMBOL(CamOsConditionInit);
EXPORT_SYMBOL(CamOsConditionDeinit);
EXPORT_SYMBOL(CamOsConditionWakeUpAll);
EXPORT_SYMBOL(_CamOsConditionTokenAlloc);
EXPORT_SYMBOL(_CamOsConditionTokenWait);
EXPORT_SYMBOL(_CamOsConditionTokenTimedWait);
EXPORT_SYMBOL(_CamOsConditionTokenFree);
