...
struct dummy_ac_property
{
    int online;
};
struct dummy_ac_property *ac_property;
...
static int dummy_ac_get_property(struct power_supply *psy, enum power_supply_property psp,
...
static int dummy_ac_set_property(struct power_supply *psy, enum power_supply_property psp,
...
static int dummy_ac_property_is_writeable(struct power_supply *psy, enum power_supply_property psp)
{
    return psp == POWER_SUPPLY_PROP_ONLINE;
}

static int dummy_battery_get_property(struct power_supply *psy, enum power_supply_property psp,
                                      union power_supply_propval *val)
{
    int ret = 0;
    switch (psp)
...
static int dummy_battery_set_property(struct power_supply *psy, enum power_supply_property psp,
                                      const union power_supply_propval *val)
{
    int ret = 0;
    switch (psp)
...
static int dummy_battery_property_is_writeable(struct power_supply *psy, enum power_supply_property psp)
{
    return psp == POWER_SUPPLY_PROP_ONLINE;
}
...
static const struct power_supply_desc dummy_power_desc[] = {
    ...
    },
    {
        ...
        .set_property          = dummy_ac_set_property,
        .get_property          = dummy_ac_get_property,
        .name                  = "ac",
        .property_is_writeable = dummy_ac_property_is_writeable,
...
static int __init dummy_power_init(void)
{
    ...
    ac_property         = (struct dummy_ac_property *)kmalloc(sizeof(struct dummy_ac_property), GFP_KERNEL);
    ac_property->online = 1;
    ...
    {
        dummy_power_supplies[i] = power_supply_register(NULL, &dummy_power_desc[i], &psy_cfg);
