...
bool CamClkIsEnable(struct clk *clk)
{
 ...
 */
int msys_of_address_to_resource(struct device_node *dev, int index, struct resource *r)
{
    return of_address_to_resource(dev, index, r);
}

int msys_of_irq_to_resource(struct device_node *dev, int index, struct resource *r)
{
    return of_irq_to_resource(dev, index, r);
}

int msys_of_property_read_u32_index(const struct device_node *np, const char *propname, u32 index, u32 *out_value)
{
    return of_property_read_u32_index(np, propname, index, out_value);
}

int msys_of_property_read_variable_u32_array(const struct device_node *np, const char *propname, u32 *out_values,
 ...
 * @num: resource index
 */
struct resource *msys_platform_get_resource(struct platform_device *dev, unsigned int type, unsigned int num)
{
