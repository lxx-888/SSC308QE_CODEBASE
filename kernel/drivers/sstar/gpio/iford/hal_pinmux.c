...
const u32 hal_gpio_st_padmux_size = sizeof(m_hal_gpio_st_padmux_entry) / sizeof(m_hal_gpio_st_padmux_entry[0]);

const hal_gpio_st_padmode_info m_hal_gpio_st_padmode_info_tbl[] = {
    {"GPIO_MODE", 0, 0, 0},
#ifdef CONFIG_OPTEE
...
const u32 hal_gpio_st_padmode_size = sizeof(m_hal_gpio_st_padmode_info_tbl) / sizeof(m_hal_gpio_st_padmode_info_tbl[0]);
