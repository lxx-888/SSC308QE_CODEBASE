...
static int __init GpioIrqTestInit(void)
{
    ...
    {
        case 0:
            tri_type = IRQF_TRIGGER_FALLING;
            break;
        case 1:
            tri_type = IRQF_TRIGGER_RISING;
            break;
        case 2:
            tri_type = IRQF_TRIGGER_RISING | IRQF_TRIGGER_FALLING;
            break;
        default:
            tri_type = 0;
    }
    ...
    if (request_irq(gpio_irq_num, gpio_test_isr, tri_type, "PAD", NULL))
    {
