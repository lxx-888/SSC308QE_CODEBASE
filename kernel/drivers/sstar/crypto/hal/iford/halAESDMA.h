...
#define CONFIG_SSTAR_CRYPTO_SUPPORT_AES256 1
#define CONFIG_SSTAR_CRYPTO_SUPPORT_SCA    1
...
#define AESDMA2_BASE_ADDR (0x112E00)
#define RNG_BASE_ADDR     (0x112F00)
#define RNG_CLK_ADDR      (0x103F00)
...
#define RSA_A_BASE_ADDR (0x00)
#define RSA_E_BASE_ADDR (0x80)
#define RSA_N_BASE_ADDR (0x100)
#define RSA_Z_BASE_ADDR (0x180)
...
#define AESDMA_MULTIPLE_ROUND 1
#define AESDMA_ENABLE_RNG_INIT
...
void HAL_RSA_LoadKeyEInverse(u32 *ptr_A, u16 u16Alentgh);
