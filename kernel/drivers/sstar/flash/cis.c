...
#if IS_ENABLED(CONFIG_SSTAR_NOR) && IS_ENABLED(CONFIG_SSTAR_NAND)
...
#if IS_ENABLED(CONFIG_SSTAR_NAND)
EXPORT_SYMBOL_GPL(sstar_cis_get_sni_from_dram);
EXPORT_SYMBOL_GPL(sstar_cis_get_sni);
#endif
#if IS_ENABLED(CONFIG_SSTAR_NOR)
EXPORT_SYMBOL_GPL(sstar_cis_get_nri_from_dram);
EXPORT_SYMBOL_GPL(sstar_cis_get_nri);
#endif
EXPORT_SYMBOL_GPL(sstar_cis_update_pni);
EXPORT_SYMBOL_GPL(sstar_cis_get_pni);
EXPORT_SYMBOL_GPL(sstar_cis_init);
EXPORT_SYMBOL_GPL(sstar_cis_deinit);
