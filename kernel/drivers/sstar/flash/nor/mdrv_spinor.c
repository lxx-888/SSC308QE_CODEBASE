...
EXPORT_SYMBOL_GPL(mdrv_spinor_read_to_xzdec);
#endif

EXPORT_SYMBOL_GPL(mdrv_spinor_info);
EXPORT_SYMBOL_GPL(mdrv_spinor_setup_by_default);
EXPORT_SYMBOL_GPL(mdrv_spinor_setup_by_nri);
EXPORT_SYMBOL_GPL(mdrv_spinor_hardware_init);
EXPORT_SYMBOL_GPL(mdrv_spinor_reset);
EXPORT_SYMBOL_GPL(mdrv_spinor_is_nri_match);
EXPORT_SYMBOL_GPL(mdrv_spinor_unlock_whole_flash);
EXPORT_SYMBOL_GPL(mdrv_spinor_read);
EXPORT_SYMBOL_GPL(mdrv_spinor_program);
EXPORT_SYMBOL_GPL(mdrv_spinor_erase);
