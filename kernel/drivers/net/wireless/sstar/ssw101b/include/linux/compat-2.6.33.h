...
int compat_request_firmware_nowait(struct module *module, int uevent,
...
static inline int
request_firmware_nowait(struct module *module, int uevent, const char *name,
...
int pccard_loop_tuple(struct pcmcia_socket *s, unsigned int function,
		      ...
		      int (*loop_tuple)(tuple_t *tuple, cisparse_t *parse,
					void *priv_data));
