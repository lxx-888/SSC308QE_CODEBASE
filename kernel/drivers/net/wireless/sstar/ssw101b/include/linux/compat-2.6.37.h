...
#define pcmcia_enable_device(link)                                             \
...
#define genl_register_mc_group(_fam, _grp)                                     \
	genl_register_mc_group(&(_fam)->family, _grp)
#define genl_unregister_mc_group(_fam, _grp)                                   \
	genl_unregister_mc_group(&(_fam)->family, _grp)
