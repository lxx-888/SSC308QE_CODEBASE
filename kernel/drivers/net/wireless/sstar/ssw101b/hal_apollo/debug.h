...
#define SSTAR_APOLLO_DBG_LEVEL                                                 \
	(SSTAR_APOLLO_DBG_INIT | SSTAR_APOLLO_DBG_NIY | SSTAR_APOLLO_DBG_ERROR)
...
#define VDEBUG_PRINTF(a, ...)                                                  \
	a->cout += snprintf(a->buff + a->cout, a->size - a->cout, __VA_ARGS__)
#define VDEBUG_PUTS(a, b)                                                      \
	a->cout += snprintf(a->buff + a->cout, a->size - a->cout, b)
#define VDEBUG_PRIV(seq) ((seq)->private)
#endif
#ifdef CONFIG_SSTAR_APOLLO_DEBUG
int Sstar_debug_init_common(struct Sstar_common *hw_priv);
int Sstar_debug_init_priv(struct Sstar_common *hw_priv, struct Sstar_vif *priv);
...
static inline void Sstar_debug_txed_multi(struct Sstar_vif *priv, int count)
{
	++priv->debug.tx_multi;
...
static inline void Sstar_debug_ba(struct Sstar_common *hw_priv, int ba_cnt,
				  int ba_acc, int ba_cnt_rx, int ba_acc_rx)
{
