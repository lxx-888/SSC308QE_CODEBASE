...
static inline void
rate_control_tx_status(struct ieee80211_local *local,
...
static inline void
rate_control_rate_update(struct ieee80211_local *local,
			 struct ieee80211_supported_band *sband,
			 ...
			 enum nl80211_channel_type oper_chan_type)
{
	...
	if (ref && ref->ops->rate_update)
		ref->ops->rate_update(ref->priv, sband, ista, priv_sta, changed,
				      oper_chan_type);
}
