...
extern void *ieee80211_Sstar_kcalloc(size_t n, size_t size, gfp_t gfp,
				     const char *func);
extern void *ieee80211_Sstar_krealloc(void *p, size_t new_size, gfp_t gfp,
				      const char *func);
...
#define Sstar_kcalloc(_n, _size, _gfp)                                         \
	ieee80211_Sstar_kcalloc(_n, _size, _gfp, __func__)
#define Sstar_krealloc(_p, _new_size, _gfp)                                    \
	ieee80211_Sstar_krealloc(_p, _new_size, _gfp, __func__)
