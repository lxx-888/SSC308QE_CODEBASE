...
static void tpt_trig_timer(unsigned long data)
{
	...
	Sstar_mod_timer(&tpt_trig->timer, round_jiffies(jiffies + HZ));
				...
				unsigned int blink_table_len)
{
	...
	Sstar_setup_timer(&tpt_trig->timer, tpt_trig_timer, (unsigned long)local);
...
static void ieee80211_stop_tpt_led_trig(struct ieee80211_local *local)
{
	...
	Sstar_del_timer_sync(&tpt_trig->timer);
