...
#define GMAC_PACKET_FILTER_DAIF		BIT(3)
#endif
#define GMAC_PACKET_FILTER_PM		BIT(4)
#ifdef CONFIG_ARCH_SSTAR
#define GMAC_PACKET_FILTER_DBF		BIT(5)
#endif
...
#define GMAC_MAX_PERFECT_ADDRESSES	(SSTAR_GMAC_MAC_ADDR_NUM)
#else
...
/* MAC Flow Control TX */
#ifdef CONFIG_ARCH_SSTAR
#define GMAC_TX_FLOW_CTRL_FCB_BPA	BIT(0)
#endif
