...
struct stmmac_extra_stats {
	...
	unsigned long napi_poll_tx;
	unsigned long napi_poll_rx;
	unsigned long last_tx_dma_en_jiffies;
	unsigned long last_rx_dma_en_jiffies;
	unsigned long last_hw_irq_jiffies;
	unsigned long last_hw_irq_tx_jiffies;
	unsigned long last_hw_irq_rx_jiffies;
	unsigned long last_napi_poll_tx_jiffies;
	unsigned long last_napi_poll_rx_jiffies;
	long          max_napi_poll_tx_time;//jiffies
	long          max_napi_poll_rx_time;//jiffies
#endif
