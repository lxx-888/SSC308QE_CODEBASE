...
{
	u64 uRegBase = IO_ADDRESS(BASE_REG_ALBANY);
	u32 tempvalue, val;
	...
	tempvalue = *(volatile unsigned int*)(uintptr_t)(uRegBase + 0x04);
	tempvalue |= 0x0004;
	*(volatile unsigned int*)(uintptr_t)(uRegBase + 0x04) = tempvalue;
	udelay(1);
	val = *(volatile unsigned int*)(uintptr_t)(uRegBase + (phyreg << 2));
			     ...
			     u16 phydata)
{
	...
	*(volatile unsigned int*)(uintptr_t)(uRegBase + (phyreg << 2)) = phydata;
	udelay(1);
