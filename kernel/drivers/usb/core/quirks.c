...
static const struct usb_device_id usb_quirk_list[] = {
	...
	/* SONY STORAGE DEVICE */
	{ USB_DEVICE(0x0011, 0x7788), .driver_info = USB_QUIRK_RESET },
	{ USB_DEVICE(0x1058, 0x2626), .driver_info = USB_QUIRK_NO_LPM },
	/* URGEEN Card Reader DEVICE */
	{ USB_DEVICE(0x05e3, 0x0747), .driver_info = USB_QUIRK_RESET },
#endif
