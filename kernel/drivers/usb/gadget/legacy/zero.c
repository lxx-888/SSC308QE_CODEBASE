...
static struct usb_zero_options gzero_options = {
	...
	.bulk_buflen_vary = GZERO_BULK_BUFLEN_VARY,
#endif
	.qlen = GZERO_QLEN,
...
#ifdef CONFIG_ARCH_SSTAR
module_param_named(buflen_vary, gzero_options.bulk_buflen_vary, uint, S_IRUGO|S_IWUSR);
#endif
...
#ifdef CONFIG_ARCH_SSTAR
	ss_opts->bulk_buflen_vary = gzero_options.bulk_buflen_vary;
#endif
