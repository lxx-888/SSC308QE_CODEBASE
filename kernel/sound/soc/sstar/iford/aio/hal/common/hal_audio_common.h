...
#define AIO_ARRAY_SIZE(arr) (sizeof(arr) / sizeof(arr[0]))
...
typedef enum
{
    ...
    E_AI_CH_I2S_RX_D_14,
    E_AI_CH_I2S_RX_D_15,
    E_AI_CH_SPDIF_RX_A_0,
    E_AI_CH_SPDIF_RX_A_1,
    E_AI_CH_TOTAL,
...
typedef enum
{
    ...
    E_AO_CH_I2S_TX_C_0,
    E_AO_CH_I2S_TX_C_1,
    E_AO_CH_SPDIF_TX_A_0,
    E_AO_CH_SPDIF_TX_A_1,
    E_AO_CH_ARC_A_0,
    E_AO_CH_ARC_A_1,
    E_AO_CH_TOTAL,
...
typedef enum
{
    ...
    E_AO_DEV_I2S_TX_B,
    E_AO_DEV_I2S_TX_C,
    E_AO_DEV_I2S_TX_END = E_AO_DEV_I2S_TX_C,
    E_AO_DEV_TOTAL,
...
typedef enum
{
    ...
    E_AUDIO_TDM_TXB,
    E_AUDIO_TDM_TXC,
    E_AUDIO_TDM_END = E_AUDIO_TDM_TXC,
    E_AUDIO_TDM_TOTAL,
...
typedef enum
{
    E_AUDIO_DMA_CACHE_START = 0,
    E_AUDIO_DMA_CACHE_W_0   = E_AUDIO_DMA_CACHE_START,
    E_AUDIO_DMA_CACHE_W_1,
    E_AUDIO_DMA_CACHE_TOTAL,
} AUDIO_DMA_CACHE_e;

typedef enum
{
    E_AUDIO_DMA_CLOCK_REFER_NULL = 0,
    E_AUDIO_DMA_CLOCK_REFER_HDMI_RX,
} AUDIO_DMA_CLOCK_e;
