...
enum {
	...
	IH_OS_SS_RTOS		= 48,	/* SigmaStar RTOS */
	IH_OS_SS_HYPERVISOR	= 49,	/* SigmaStar Hypervisor */
...
enum {
	...
	IH_COMP_RESERVED1,		/* null  Compression Used	*/
	IH_COMP_RESERVED2,		/* null  Compression Used	*/
	IH_COMP_MZ,				/* mz    Compression Used	*/
	IH_COMP_XIP,			/* mz    Compression Used	*/
	IH_COMP_LZMA2,			/* lzma2 Compression Used	*/
	IH_COMP_COUNT
};
