...
#define FWFS_TRACE(...) EXPAND(FWFS_TRACE_(__VA_ARGS__, ""))
#else
#define FWFS_TRACE(...)
#endif
...
#define FWFS_DEBUG(...) EXPAND(FWFS_DEBUG_(__VA_ARGS__, ""))
#else
#define FWFS_DEBUG(...)
#endif
...
#define FWFS_WARN(...) EXPAND(FWFS_WARN_(__VA_ARGS__, ""))
#else
#define FWFS_WARN(...)
#endif
...
#define FWFS_INFO(...) EXPAND(FWFS_INFO_(__VA_ARGS__, ""))
#else
#define FWFS_INFO(...)
#endif
...
#define FWFS_ERROR(...) EXPAND(FWFS_ERROR_(__VA_ARGS__, ""))
#else
#define FWFS_ERROR(...)
#endif
...
// Note, memory must be 64-bytes aligned
...
//Workaround for __VA_ARGS__ expansion issue in MSVC's preprocessor
#define EXPAND(x) x
