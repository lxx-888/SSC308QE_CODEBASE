...
#ifndef __INFINITY6F_H
#define __INFINITY6F_H

/*------------------------------------------------------------------------------
  Constant
  -------------------------------------------------------------------------------*/
/* This is columbus2 hardware */
#define CONFIG_ARCH_MERCURY6P 1
...
#define CONFIG_SYS_MALLOC_LEN                                                  \
  (CONFIG_ENV_SIZE + 7 * 1024 * 1024) /* (CONFIG_ENV_SIZE + 512*1024) */
#endif
...
#define CONFIG_G_DNL_PRODUCT_NUM 0x0301
...
#define RSA_SIG_LEN          (U16)((((*(volatile unsigned short*)(0x1f000000+(0x101f00<<1)+(0x70<<2)))>>15)&0x1)?(512):(256))
