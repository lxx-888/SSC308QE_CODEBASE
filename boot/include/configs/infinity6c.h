...
#ifndef __INFINITY6C_H
#define __INFINITY6C_H

/*------------------------------------------------------------------------------
  Constant
  -------------------------------------------------------------------------------*/
/* This is columbus2 hardware */
#define CONFIG_ARCH_MERCURY6C 1
#define CONFIG_ARMCORTEXA7     /* This is an ARM V7 CPU core */
#define CONFIG_SYS_L2CACHE_OFF /* No L2 cache */
//#define CONFIG_SSTAR_PIU_TIMER 1
...
#define CONFIG_SYS_HZ_CLOCK 36000000
...
/* OTP Base Address */
#define CONFIG_OTPCTRL_FUN_ADDRESS 0xA0000020
...
#define CONFIG_SPL_MSTAR_SUPPORT
...
//#define CONFIG_SPL_TEXT_BASE           0x23400000
#define CONFIG_SPL_MAX_SIZE            (0xF000)
//#define CONFIG_SPL_LDSCRIPT "arch/arm/cpu/armv7/infinity6c/spl/u-boot-spl.lds"
#define CONFIG_SPL_STACK  0x23424000
#define CONFIG_SPL_EARLY_BSS
...
#define CONFIG_SYS_MALLOC_LEN                                                  \
  (CONFIG_ENV_SIZE + 4 * 1024 * 1024) /* (CONFIG_ENV_SIZE + 512*1024) */
#endif
...
#define CONFIG_SYS_MEMTEST_END 0x22000000   /* 0 ... 64 MB in DRAM	*/

#define CONFIG_SYS_SDRAM_BASE PHYS_SDRAM_1
#define CONFIG_SYS_INIT_SP_ADDR (CONFIG_SYS_TEXT_BASE - GENERATED_GBL_DATA_SIZE)

#define CONFIG_UBOOT_RAM_SIZE                                                  \
  CONFIG_SSTAR_RAM_SIZE // let us to use only 64MB for uboot

/* RAM base address */
#define RAM_START_ADDR 0x20000000
#define IMI_START_ADDR 0xA0000000
#define CONFIG_SYS_SDRAM_SIZE CONFIG_SSTAR_RAM_SIZE
/* RAM size */
...
//#if defined(CONFIG_SSTAR_SDMMC) || defined(CONFIG_SSTAR_EMMC) ||
//defined(CONFIG_SSTAR_USB) #define CONFIG_CMD_FAT #endif

#ifdef CONFIG_SSTAR_SDMMC
#ifndef CONFIG_MMC
#define CONFIG_MMC 1
#endif /* CONFIG_MMC */
...
#define CONFIG_SSTAR_SDMMC_MAX_READ_BLOCKS 1024
#define CONFIG_FAT_WRITE
#endif

#ifdef CONFIG_SSTAR_EMMC
#ifndef CONFIG_MMC
#define CONFIG_MMC 1
#endif /* CONFIG_MMC */
 ...
 * "mtdparts=nand0:0x60000@0x140000(IPL0),0x60000(IPL1),0x60000(IPL_CUST0),0x60000(IPL_CUST1),0xC0000(UBOOT0),0xC0000(UBOOT1),0x60000(ENV),0x340000(KERNEL),0x340000(RECOVERY),-(UBI)"*/
...
#ifdef CONFIG_SSTAR_EMMC
#ifdef CONFIG_SSTAR_SAVE_ENV_IN_EMMC
#define CONFIG_ENV_IS_IN_MMC 1
#define CONFIG_SYS_MMC_ENV_DEV 0
#define CONFIG_SSTAR_EMMC_DEV_INDEX 1
...
#else
#define CONFIG_SSTAR_EMMC_DEV_INDEX 0
#define CONFIG_EMMC_PARTITION
#endif
#endif /* CONFIG_SSTAR_EMMC */
 ...
 *
 *  #define CONFIG_SSTAR_SDMMC     1
 *  #define CONFIG_SSTAR_EMMC      1
 *  #define CONFIG_SSTAR_NAND      1
 *
 */

/* Ethernet configuration */
#ifdef CONFIG_SSTAR_EMAC
#define CONFIG_MINIUBOOT
#ifndef CONFIG_BOOTP_GATEWAY
...
#if defined(CONFIG_ARMCORTEXA7) && !defined(CONFIG_SYS_CACHELINE_SIZE)
#define CONFIG_SYS_CACHELINE_SIZE (64)
#endif
#if defined(CONFIG_USBDOWNLOAD_GADGET) || defined(CONFIG_CMD_SSTAR_UFU)
#define CONFIG_G_DNL_VENDOR_NUM 0x1B20
