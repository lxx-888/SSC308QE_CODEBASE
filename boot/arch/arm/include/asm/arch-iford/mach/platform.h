...
#define BASE_REG_PMTOP_PA           GET_BASE_ADDR_BY_BANK(SSTAR_BASE_REG_RIU_PA, 0x001E00)
#define BASE_REG_OTP2_PA            GET_BASE_ADDR_BY_BANK(SSTAR_BASE_REG_RIU_PA, 0x101F00)

#define REG_ADDR_BASE_PM_RIU_DBG    GET_BASE_ADDR_BY_BANK(SSTAR_BASE_REG_RIU_PA, 0x000100)
#define REG_ADDR_BASE_DIG_RIU_DBG   GET_BASE_ADDR_BY_BANK(SSTAR_BASE_REG_RIU_PA, 0x100100)
#define REG_ADDR_BASE_XIU_RIU_DBG   GET_BASE_ADDR_BY_BANK(SSTAR_BASE_REG_RIU_PA, 0x167000)
#define REG_ADDR_BASE_ISP0_RIU_DBG  GET_BASE_ADDR_BY_BANK(SSTAR_BASE_REG_RIU_PA, 0x167800)
#define REG_ADDR_BASE_CMD_RIU_DBG   GET_BASE_ADDR_BY_BANK(SSTAR_BASE_REG_RIU_PA, 0x120100)
#define REG_ADDR_BASE_MAILBOX       GET_BASE_ADDR_BY_BANK(SSTAR_BASE_REG_RIU_PA, 0x100400)

/* RIU DEBUG REG & BITMAP */
#define HAL_RIU_REG_FLAG 0x01
...
/* RESERVED for TF-A region */

#define TF_A_START_ADDR         0x20FC0000
#define TF_A_SIZE               0x00040000
#define TF_A_END_ADDR           (TF_A_START_ADDR + TF_A_SIZE)

/* RESERVED for OP-TEE region */

#ifdef CONFIG_SSTAR_VERSION_FPGA
#define OPTEE_START_ADDR        0x29800000
#else
#define OPTEE_START_ADDR        0x24200000
#endif
#define OPTEE_SIZE              0x00800000
#define OPTEE_END_ADDR          (OPTEE_START_ADDR + OPTEE_SIZE - 1)
...
extern void Chip_Set_RebootType(uint16_t arg);
extern uint16_t Chip_Get_RebootType(void);
