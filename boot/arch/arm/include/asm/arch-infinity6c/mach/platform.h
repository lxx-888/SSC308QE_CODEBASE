...
#define BASE_REG_PMPOR_PA                   GET_BASE_ADDR_BY_BANK(MS_BASE_REG_RIU_PA, 0x0600)
#define BASE_REG_WDT_PA                     GET_BASE_ADDR_BY_BANK(MS_BASE_REG_RIU_PA, 0x3000)
#define MS_BASE_REG_UART0_PA              	GET_BASE_ADDR_BY_BANK(MS_BASE_REG_RIU_PA, 0x110800)
#define SSTAR_BASE_REG_TIMER0_PA              	GET_BASE_ADDR_BY_BANK(MS_BASE_REG_RIU_PA, 0x003020)
...
#define REG_ADDR_BASE_PM_SLEEP              GET_BASE_ADDR_BY_BANK( MS_BASE_REG_RIU_PA, 0x000E00 )
#define REG_ADDR_BASE_MIU					GET_BASE_ADDR_BY_BANK( MS_BASE_REG_RIU_PA, 0x101200 )
#define BASE_REG_OTP2_PA            GET_BASE_ADDR_BY_BANK(MS_BASE_REG_RIU_PA, 0x101F00)
#define SSTAR_BASE_REG_UART0_PA         GET_BASE_ADDR_BY_BANK(MS_BASE_REG_RIU_PA, 0x110800)
...
#define UBOOT_LOAD_ADDRESS      CONFIG_SS_LOAD_ADDR
#define UBOOT_RUN_ADDRESS       CONFIG_SS_RUN_ADDR
