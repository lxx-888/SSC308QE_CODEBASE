...
#define BASE_REG_TZMISC             GET_BASE_ADDR_BY_BANK(SSTAR_BASE_REG_RIU_PA, 0x11FE00)
...
#define TF_A_START_ADDR         0x24000000
#define TF_A_SIZE               0x00040000
#define TF_A_END_ADDR           (TF_A_START_ADDR + TF_A_SIZE - 1)
...
#define CORE_WAKEUP_CONFIG_ADDR 0x1F204058
