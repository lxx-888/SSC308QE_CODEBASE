...
config AUTOBOOT_RUN_FASTBOOT_MODE
	bool "Autoboot fastboot mode for sigmastar USB boot"
	depends on FASTBOOT_FLASH_MMC || FASTBOOT_FLASH_NAND
	help
	  It is selected for build special bootloader which will autoboot
	  to fastboot mode. Normal boot bootloader should not select this
	  option.
