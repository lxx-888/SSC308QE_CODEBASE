		       ...
		       char *const argv[])
{
	...
	printf("gd->ram_top: 0x%08lx\n", gd->ram_top);
	printf("gd->ram_size: 0x%08lx\n", gd->ram_size);
	printf("gd->mon_len: 0x%08lx\n", gd->mon_len);
	printf("gd->relocaddr: 0x%08lx\n", gd->relocaddr);
	printf("gd->start_addr_sp: 0x%08lx\n", gd->start_addr_sp);
	printf("malloc len: %08lx\n", CONFIG_SYS_MALLOC_LEN);
