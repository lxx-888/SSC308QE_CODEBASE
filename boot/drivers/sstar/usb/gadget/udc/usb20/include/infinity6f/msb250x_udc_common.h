...
#define UTMI_BASE_ADDR    GET_REG8_ADDR(RIU_BASE_ADDR, 0x0B200)
#define USBC_BASE_ADDR    GET_REG8_ADDR(RIU_BASE_ADDR, 0x0A400)
#define OTG0_BASE_ADDR    GET_REG8_ADDR(RIU_BASE_ADDR, 0x0A600)
