...
#define UTMI_BASE_ADDR    GET_REG8_ADDR(RIU_BASE_ADDR, 0x0142100)
#define USBC_BASE_ADDR    GET_REG8_ADDR(RIU_BASE_ADDR, 0x0142300)
#define OTG0_BASE_ADDR    GET_REG8_ADDR(RIU_BASE_ADDR, 0x0142500)
#define CHIPTOP_BASE_ADDR GET_REG8_ADDR(RIU_BASE_ADDR, 0x101E00)

//#define UTMI1_BASE_ADDR GET_REG8_ADDR(RIU_BASE_ADDR, 0x0AA00)
...
#define MSB250X_USB_DMA_CHANNEL 4
