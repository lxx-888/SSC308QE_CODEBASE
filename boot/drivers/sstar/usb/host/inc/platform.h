...
//#define SERET_ENV
#define SSTAR_UBOOT_ENV

#define USB_WAIT_LOOP_COUNT 10 // for super speed device
...
//#define CONFIG_MIU0_BUSADDR 0x00000000
//#define CONFIG_MIU1_BUSADDR 0x00000000
...
#if defined(SSTAR_UBOOT_ENV)
extern u32  MsOS_USB_VA2PA(u32 addr);
extern u32  MsOS_USB_PA2KSEG0(u32 addr);
extern u32  MsOS_USB_PA2KSEG1(u32 addr);
...
#define KSEG02KSEG1(addr)    (unsigned long)addr
#define KSEG12KSEG0(addr)    (unsigned long)addr
#define GET_REG16_ADDR(x, y) (unsigned long)((x) + ((y) << 2))

/* virtual address to physical address translation */

extern unsigned long VA2PA(unsigned int u32_DMAAddr);
extern unsigned long PA2VA(unsigned int u32_DMAAddr);

#define ENABLE_USB_NEW_MIU_SEL 1    /* Unit: 4GB / 16 = 256MB */
#define USB_MIU_SEL0           0x70 /* MIU0: 2GB */
#define USB_MIU_SEL1           0xEF /* MIU1: 2GB F8*/
