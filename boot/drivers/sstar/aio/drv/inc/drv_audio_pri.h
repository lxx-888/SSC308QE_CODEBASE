...
typedef enum
{
    E_PCM_STREAM_PLAYBACK,
    E_PCM_STREAM_CAPTURE,
} PcmStream_e;
...
typedef struct PcmRuntimeData_s
{
    ...
    u16          nHwFrameBits;
    u16          nStatus;
    s32 (*copy)(struct PcmRuntimeData_s *ptRuntimeData, u32 nHwoff, u8 *pBuf, u32 nBufSize, u32 nPos,
                PcmFrames_t tFrames);
} PcmRuntimeData_t;
