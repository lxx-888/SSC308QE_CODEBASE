...
#define RTC_MAGIC_NUMBER   0xBEEF
...
{
    /*
     * input parameters for hal driver
     */
    ...
    /*
     * output parameters for hal driver
     */
    struct hal_fail_count fail_count;

    /*
     * local parameters don't modify !!!
     */
    u8                default_state;
    u8                alm_inited;
    struct hal_shadow sw0;
    struct hal_shadow sw2;
    struct hal_shadow sw3;
    struct hal_shadow base_time;
...
extern void   hal_rtc_set_alarm_and_enable(struct hal_rtcpwc_t *hal, u32 seconds);
