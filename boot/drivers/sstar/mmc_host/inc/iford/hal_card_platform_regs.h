...
#define A_FCIE2_0_BANK GET_CARD_REG_ADDR(A_RIU_BASE, 0x2100) // SDIO2_0_BANK 1416h
#define A_FCIE2_1_BANK GET_CARD_REG_ADDR(A_RIU_BASE, 0x2180)
#define A_FCIE2_2_BANK GET_CARD_REG_ADDR(A_RIU_BASE, 0x2200)
