...
#define WT_EVENT_RSP   100   //(ms)
#define WT_EVENT_READ  20000 //(ms)
#define WT_EVENT_WRITE 30000 //(ms)
#else
#define WT_EVENT_RSP   10   //(ms)
#define WT_EVENT_READ  2000 //(ms)
#define WT_EVENT_WRITE 3000 //(ms)
#endif
#define DEF_CDZ_PAD_SLOT0 (PAD_UNKNOWN) // PAD_SD0_CDZ)
#define DEF_CDZ_PAD_SLOT1 (PAD_UNKNOWN) // PAD_SD1_CDZ)
#define DEF_CDZ_PAD_SLOT2 0

#define DEF_PWR_PAD_SLOT0 (PAD_UNKNOWN) // PAD_SD_GPIO0)
#define DEF_PWR_PAD_SLOT1 (PAD_UNKNOWN) // PAD_SD1_GPIO0)
