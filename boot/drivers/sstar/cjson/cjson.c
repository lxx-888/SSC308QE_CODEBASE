...
static int g_needCjsonNodeCnt = 0;
...
int Get_cJosnNeedNodeCnt(void)
{
    return g_needCjsonNodeCnt;
}
...
static double strtod_cjson(const char *s, char **endptr)
{
    register const char *p     = s;
    register double      value = 0.L;
    int                  sign  = 0;
    double               factor;
    unsigned int         expo;
...
loop_end:
    ...
    number = strtod_cjson(number_c_string, &after_end);
