...
#define NEED_CALB ((Chip_Get_Revision() <= 0x01) ? 1 : 0)
...
#if defined(CONFIG_GMAC_RGMII0_TXC_PHASE_1G_DEGREE_0)
#define gmac0_txc_delay_phase_1g 0x0000
#elif defined(CONFIG_GMAC_RGMII0_TXC_PHASE_1G_DEGREE_90)
#define gmac0_txc_delay_phase_1g 0x1000
#elif defined(CONFIG_GMAC_RGMII0_TXC_PHASE_1G_DEGREE_180)
#define gmac0_txc_delay_phase_1g 0x800
#elif defined(CONFIG_GMAC_RGMII0_TXC_PHASE_1G_DEGREE_270)
#define gmac0_txc_delay_phase_1g 0x1800
#endif

#if defined(CONFIG_GMAC_RGMII0_TXC_PHASE_100M_DEGREE_0)
#define gmac0_txc_delay_phase_100m 0x0000
#elif defined(CONFIG_GMAC_RGMII0_TXC_PHASE_100M_DEGREE_90)
#define gmac0_txc_delay_phase_100m 0x1000
#elif defined(CONFIG_GMAC_RGMII0_TXC_PHASE_100M_DEGREE_180)
#define gmac0_txc_delay_phase_100m 0x800
#elif defined(CONFIG_GMAC_RGMII0_TXC_PHASE_100M_DEGREE_270)
#define gmac0_txc_delay_phase_100m 0x1800
#endif

#if defined(CONFIG_GMAC_RGMII1_TXC_PHASE_1G_DEGREE_0)
#define gmac1_txc_delay_phase_1g 0x0000
#elif defined(CONFIG_GMAC_RGMII1_TXC_PHASE_1G_DEGREE_90)
#define gmac1_txc_delay_phase_1g 0x1000
#elif defined(CONFIG_GMAC_RGMII1_TXC_PHASE_1G_DEGREE_180)
#define gmac1_txc_delay_phase_1g 0x800
#elif defined(CONFIG_GMAC_RGMII1_TXC_PHASE_1G_DEGREE_270)
#define gmac1_txc_delay_phase_1g 0x1800
#endif

#if defined(CONFIG_GMAC_RGMII1_TXC_PHASE_100M_DEGREE_0)
#define gmac1_txc_delay_phase_100m 0x0000
#elif defined(CONFIG_GMAC_RGMII1_TXC_PHASE_100M_DEGREE_90)
#define gmac1_txc_delay_phase_100m 0x1000
#elif defined(CONFIG_GMAC_RGMII1_TXC_PHASE_100M_DEGREE_180)
#define gmac1_txc_delay_phase_100m 0x800
#elif defined(CONFIG_GMAC_RGMII1_TXC_PHASE_100M_DEGREE_270)
#define gmac1_txc_delay_phase_100m 0x1800
#endif
