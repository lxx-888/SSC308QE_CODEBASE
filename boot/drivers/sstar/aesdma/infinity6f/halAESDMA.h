...
#define AESDMA_BASE_ADDR    (0x12A000)
#define SHARNG_BASE_ADDR    (0x12A000)
#define RSA_BASE_ADDR       (0x12A000)
#define AESDMA2_BASE_ADDR   (0x12A100)
#define AESDMA_RNG_CLK_ADDR (0x103F00)
