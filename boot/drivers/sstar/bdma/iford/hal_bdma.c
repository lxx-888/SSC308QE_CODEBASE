...
HalBdmaErr_e HalBdma_DoTransfer(u8 u8DmaCh, HalBdmaParam_t *ptBdmaParam)
{
    ...
    {
        g_ptKeBdma->reg_ch0_src_width_low   = 0x400;
        g_ptKeBdma->reg_ch0_src_width_high  = 0x0;
        g_ptKeBdma->reg_ch0_src_offset_low  = 0x400;
        g_ptKeBdma->reg_ch0_src_offset_high = 0x0;
        g_ptKeBdma->reg_ch0_dst_width_low   = 0x400;
        g_ptKeBdma->reg_ch0_dst_width_high  = 0x0;
        g_ptKeBdma->reg_ch0_dst_offset_low  = 0x400;
        g_ptKeBdma->reg_ch0_dst_offset_high = 0x0;
        g_ptKeBdma->reg_ch0_offset_en       = 1;
    }
    else
    {
