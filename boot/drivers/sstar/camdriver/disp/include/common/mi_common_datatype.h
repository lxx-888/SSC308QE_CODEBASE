        ...
        {                                                                                       \
            ...
            {                                                                                   \
                ...
                if (__num > 0 && __num <= (sizeof(ptr64) / sizeof(ptr64[0]))                    \
                    && __num <= (sizeof(ptr) / sizeof(ptr[0])) && TYPECHECK(MI_PTR64, ptr64[0]) \
                    && TYPECHECK(MI_PTR, ptr[0]))                                               \
                {                                                                               \
                    MI_S32 i = 0;                                                               \
                    for (i = __num - 1; i >= 0; i--)                                            \
                    {                                                                           \
        ...
        {                                                                                       \
            ...
            {                                                                                   \
                ...
                if (__num > 0 && __num <= (sizeof(ptr) / sizeof(ptr[0]))                        \
                    && __num <= (sizeof(ptr64) / sizeof(ptr64[0])) && TYPECHECK(MI_PTR, ptr[0]) \
                    && TYPECHECK(MI_PTR64, ptr64[0]))                                           \
                {                                                                               \
                    MI_U32 i = 0;                                                               \
                    for (i = 0; i <= __num - 1; i++)                                            \
                    {                                                                           \
