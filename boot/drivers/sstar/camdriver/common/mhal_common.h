...
#define MHAL_DEF_ERR(module, level, errid) ((MS_S32)((MHAL_ERR_ID) | ((module) << 16) | ((level) << 13) | (errid)))
...
typedef enum
{
    ...
    E_MHAL_ERR_SYS_NOTREADY = 16, /**< System is not ready,maybe not initialed or loaded. Returning the error code when
...
{
    E_MHAL_CRC_OFF       = 0,
    E_MHAL_CRC_FRM_LAST  = 1,
    E_MHAL_CRC_AFTER_FRM = 2,
    E_MHAL_RGB_ONLY_CAL  = 3,
} MHalCrcMode_e;
