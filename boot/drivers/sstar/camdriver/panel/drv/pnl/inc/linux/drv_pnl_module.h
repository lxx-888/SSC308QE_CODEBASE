...
DrvPnlModuleDevice_t g_tPnlDevice = {
    .tDevNumber = 0,
    .refCnt     = 0,
    .devicenode = NULL,
    .cdev =
...
struct class *g_tPnlClass    = NULL;
char *        g_pnlClassName = "m_pnl_class";

u64 u64Pnl_DmaMask = 0xffffffffUL;

struct platform_device g_stDrvPnlPlatformDevice = {
    .name = DRV_PNL_DEVICE_NAME,
    .id   = 0,
    .dev  = {.of_node = NULL, .dma_mask = &u64Pnl_DmaMask, .coherent_dma_mask = 0xffffffffUL}};
