...
INTERFACE bool  DrvPnlOsSetClkOn(void *pClkEn, void *pClkRate, u32 u32ClkRateSize);
INTERFACE bool  DrvPnlOsSetClkOff(void *pClkEn, void *pClkRate, u32 u32ClkRateSize);
INTERFACE u32   DrvPnlOsGetFileSize(DrvPnlOsFileConfig_t *pFileCfg);
INTERFACE s32   DrvPnlOsOpenFile(u8 *path, s32 flag, s32 mode, DrvPnlOsFileConfig_t *pstFileCfg);
INTERFACE s32   DrvPnlOsWriteFile(DrvPnlOsFileConfig_t *pFileCfg, u8 *buf, s32 writelen);
INTERFACE s32   DrvPnlOsReadFile(DrvPnlOsFileConfig_t *pFileCfg, u8 *buf, s32 readlen);
INTERFACE s32   DrvPnlOsCloseFile(DrvPnlOsFileConfig_t *pFileCfg);
