...
U32 eMMC_clock_setting(U16 u16_ClkParam)
{
    ...
    switch (u16_ClkParam)
    {
        case BIT_FCIE_CLK_24M:
            g_eMMCDrv.u32_ClkKHz = 24000;
            break;
        ...
        case BIT_FCIE_CLK_48M:
            ...
            break;
        case BIT_FCIE_CLK_86M:
            g_eMMCDrv.u32_ClkKHz = 86000;
            break;
        case BIT_FCIE_CLK_108M:
            g_eMMCDrv.u32_ClkKHz = 108000;
            break;
        case BIT_FCIE_CLK_123M:
            g_eMMCDrv.u32_ClkKHz = 123000;
            break;
        case BIT_FCIE_CLK_144M:
            g_eMMCDrv.u32_ClkKHz = 144000;
            break;
        case BIT_FCIE_CLK_172M:
            g_eMMCDrv.u32_ClkKHz = 172000;
            break;
        case BIT_FCIE_CLK_192M:
            g_eMMCDrv.u32_ClkKHz = 192000;
            break;
        case BIT_FCIE_CLK_216M:
            g_eMMCDrv.u32_ClkKHz = 216000;
            break;
        case BIT_FCIE_CLK_240M:
            g_eMMCDrv.u32_ClkKHz = 240000;
            break;
        case BIT_FCIE_CLK_345M:
            g_eMMCDrv.u32_ClkKHz = 345000;
            break;
        case BIT_FCIE_CLK_432M:
            g_eMMCDrv.u32_ClkKHz = 432000;
            break;
        case BIT_FCIE_CLK_1200K:
            g_eMMCDrv.u32_ClkKHz = 1200;
            break;
        ...
        case BIT_FCIE_CLK_43_2M:
            ...
            break;
        case BIT_FCIE_CLK_54M:
            g_eMMCDrv.u32_ClkKHz = 54000;
            break;
        case BIT_FCIE_CLK_62M:
            g_eMMCDrv.u32_ClkKHz = 62000;
            break;
        case BIT_FCIE_CLK_72M:
            g_eMMCDrv.u32_ClkKHz = 72000;
            break;
        case BIT_FCIE_CLK_80M:
            g_eMMCDrv.u32_ClkKHz = 80000;
            break;
...
U16 gau16_FCIEClkSel[eMMC_FCIE_VALID_CLK_CNT] = {
    ...
    BIT_FCIE_CLK_192M,
    BIT_FCIE_CLK_172M,
    /*BIT_FCIE_CLK_144M,*/ BIT_FCIE_CLK_123M, /*BIT_FCIE_CLK_108M,*/
    BIT_FCIE_CLK_86M,
    /*BIT_FCIE_CLK_80M, BIT_FCIE_CLK_72M,*/ BIT_FCIE_CLK_62M,
    BIT_FCIE_CLK_54M,
    /*BIT_FCIE_CLK_48M, BIT_FCIE_CLK_43_2M,*/ BIT_FCIE_CLK_40M,
    /*BIT_FCIE_CLK_36M,*/ BIT_FCIE_CLK_32M,
    BIT_FCIE_CLK_24M,
    BIT_FCIE_CLK_12M /*, BIT_FCIE_CLK_1200K, BIT_FCIE_CLK_300K*/
};
...
U32 eMMC_FCIE_DetectDDRTiming(void)
{
    ...
    for (u8_dqs = 1; u8_dqs <= (BIT_DQS_MODE_MASK >> BIT_DQS_MDOE_SHIFT); u8_dqs++)
    {
        ...
        if (u8_dqs < (BIT_DQS_MODE_MASK >> BIT_DQS_MDOE_SHIFT))
            u8_delay_Sel_max = (au8_DQS_10T[u8_dqs + 1] - au8_DQS_10T[u8_dqs]) * u32_ts / (FCIE_DELAY_CELL_ts * 10);
        else
    ...
    eMMC_debug(eMMC_DEBUG_LEVEL_HIGH, 0, "\n W0, Cnt:%Xh, [%Xh %Xh], [%Xh %Xh]\n", sg_DDRTWindow[0].u8_Cnt,
               sg_DDRTWindow[0].aParam[0].u8_DQS, sg_DDRTWindow[0].aParam[0].u8_Cell, sg_DDRTWindow[0].aParam[1].u8_DQS,
               sg_DDRTWindow[0].aParam[1].u8_Cell);
    for (u8_i = 1; u8_i <= BIT_DQS_MODE_MASK >> BIT_DQS_MDOE_SHIFT; u8_i++)
        eMMC_debug(eMMC_DEBUG_LEVEL_HIGH, 0, "DQSValidCellCnt[%u]:%u \n", u8_i,
                   sg_DDRTWindow[0].au8_DQSValidCellCnt[u8_i]);

    eMMC_debug(eMMC_DEBUG_LEVEL_HIGH, 0, "\n W1, Cnt:%Xh, [%Xh %Xh], [%Xh %Xh]\n", sg_DDRTWindow[1].u8_Cnt,
               sg_DDRTWindow[1].aParam[0].u8_DQS, sg_DDRTWindow[1].aParam[0].u8_Cell, sg_DDRTWindow[1].aParam[1].u8_DQS,
               sg_DDRTWindow[1].aParam[1].u8_Cell);
    for (u8_i = 1; u8_i <= BIT_DQS_MODE_MASK >> BIT_DQS_MDOE_SHIFT; u8_i++)
        eMMC_debug(eMMC_DEBUG_LEVEL_HIGH, 0, "DQSValidCellCnt[%u]:%u \n", u8_i,
                   sg_DDRTWindow[1].au8_DQSValidCellCnt[u8_i]);
        ...
        if (eMMC_ST_SUCCESS == u32_err)
        {
            ...
            if (NULL != pWindow)
            {
                ...
                if (0 != u8_DqsIdx) // do not use 0T, this should be always TRUE
                {
                    ...
                    {
                        u8_tmp =
                            (pWindow->au8_DQSValidCellCnt[u8_DqsIdx] + pWindow->au8_DQSValidCellCnt[u8_DqsIdx - 1]) / 2;
                        ...
                        if (u8_tmp < pWindow->au8_DQSValidCellCnt[u8_DqsIdx - 1])
                        {
                            ...
                            u8_CellBase =
                                pWindow->au8_DQSTryCellCnt[u8_DqsIdx - 1] - pWindow->au8_DQSValidCellCnt[u8_DqsIdx - 1];
                        ...
                        else
                        {
                            g_eMMCDrv.DDRTable.Set[u8_SetIdx].Param.u8_DQS = au8_DQSRegVal[u8_DqsIdx];
                            g_eMMCDrv.DDRTable.Set[u8_SetIdx].Param.u8_Cell =
                                (pWindow->au8_DQSValidCellCnt[u8_DqsIdx - 1] + pWindow->au8_DQSValidCellCnt[u8_DqsIdx])
                                / 2;
                        }
                    }
                }
...
U32 eMMC_BootPartitionHandler_WR(U8 *pDataBuf, U16 u16_PartType, U32 u32_StartSector, U32 u32_SectorCnt, U8 u8_OP)
{
    ...
    if (eMMC_BOOT_PART_W == u8_OP)
        return eMMC_WriteBootPart(pDataBuf, u32_SectorCnt << eMMC_SECTOR_512BYTE_BITS, u32_StartSector, 1);
    else
        return eMMC_ReadBootPart(pDataBuf, u32_SectorCnt << eMMC_SECTOR_512BYTE_BITS, u32_StartSector, 1);
}
...
char *gpas8_eMMCPartName[] = {"e2pbak", "nvrambak", "hwcfgs", "recovery", "os",         "fdd",  "tdd",
                              "blogo",  "apanic",   "misc",   "cus",      "e2p0",       "e2p1", "nvram0",
                              "nvram1", "system",   "cache",  "data",     "internal sd"};
...
U32 eMMC_clock_setting(U16 u16_ClkParam)
{
    ...
    switch (u16_ClkParam)
    {
        case NFIE_REG_4XCLK_1_3M:
            g_eMMCDrv.u32_ClkKHz = 1300;
            break;
        case NFIE_REG_4XCLK_26M:
            g_eMMCDrv.u32_ClkKHz = 26000;
            break;
        case NFIE_REG_4XCLK_48M:
            g_eMMCDrv.u32_ClkKHz = 48000;
            break;
        case NFIE_REG_4XCLK_80M:
            g_eMMCDrv.u32_ClkKHz = 80000;
            break;
        case NFIE_REG_4XCLK_96M:
            g_eMMCDrv.u32_ClkKHz = 96000;
            break;
        case NFIE_REG_4XCLK_120M:
            g_eMMCDrv.u32_ClkKHz = 120000;
            break;
        case NFIE_REG_4XCLK_147M:
            g_eMMCDrv.u32_ClkKHz = 147000;
            break;
        case NFIE_REG_4XCLK_160M:
            g_eMMCDrv.u32_ClkKHz = 160000;
            break;
        case NFIE_REG_4XCLK_176_8M:
            g_eMMCDrv.u32_ClkKHz = 176800;
            break;
        case NFIE_REG_4XCLK_192M:
            g_eMMCDrv.u32_ClkKHz = 192000;
            break;
        case NFIE_REG_4XCLK_221M:
            g_eMMCDrv.u32_ClkKHz = 221000;
            break;
        case NFIE_REG_4XCLK_240M:
            g_eMMCDrv.u32_ClkKHz = 240000;
            break;
        case NFIE_REG_4XCLK_294_6M:
            g_eMMCDrv.u32_ClkKHz = 294600;
            break;
        case NFIE_REG_4XCLK_353_6M:
            g_eMMCDrv.u32_ClkKHz = 353600;
            break;
        case NFIE_REG_4XCLK_60M:
            g_eMMCDrv.u32_ClkKHz = 60000;
            break;
        default:
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: invalid clk: %Xh\n", u16_ClkParam);
            return eMMC_ST_ERR_INVALID_PARAM;
...
U16          gau16_FCIEClkSel[eMMC_FCIE_VALID_CLK_CNT] = {NFIE_REG_4XCLK_192M, NFIE_REG_4XCLK_160M, NFIE_REG_4XCLK_120M,
...
U32 eMMC_FCIE_DetectDDRTiming(void)
{
    ...
    for (u8_dqs = 1; u8_dqs <= (BIT_DQS_MODE_MASK >> BIT_DQS_MDOE_SHIFT); u8_dqs++)
    {
        ...
        if (u8_dqs < (BIT_DQS_MODE_MASK >> BIT_DQS_MDOE_SHIFT))
            u8_delay_Sel_max =
                (U8)((au8_DQS_10T[u8_dqs + 1] - au8_DQS_10T[u8_dqs]) * u32_ts / (FCIE_DELAY_CELL_ts * 10));
        else
            u8_delay_Sel_max = (BIT_DQS_DELAY_CELL_MASK >> BIT_DQS_DELAY_CELL_SHIFT);
        ...
        if (u8_delay_Sel_max > (BIT_DQS_DELAY_CELL_MASK >> BIT_DQS_DELAY_CELL_SHIFT))
        {
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1,
                       "let u8_delay_Sel_max be (BIT_DQS_DELAY_CELL_MASK>>BIT_DQS_DELAY_CELL_SHIFT)\r\n");
            u8_delay_Sel_max = (BIT_DQS_DELAY_CELL_MASK >> BIT_DQS_DELAY_CELL_SHIFT);
        }
#else
...
U32 eMMC_FCIE_BuildDDRTimingTable(void)
{
        ...
        && (0 != g_eMMCDrv.DDRTable.u8_SetCnt))
    {
        eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 0,
                   "((g_eMMCDrv.DDRTable.Set[eMMC_DDRT_SET_MAX].u16_Clk == gau16_FCIEClkSel[0]) && (0 != "
                   "g_eMMCDrv.DDRTable.u8_SetCnt))");
        u32_ret = eMMC_ST_SUCCESS;
    }
    else
...
U32 eMMC_CheckIfMemCorrupt(void)
{
    ...
    || (defined(eMMC_DRV_INFINITY6B0_UBOOT) && eMMC_DRV_INFINITY6B0_UBOOT) \
    || (defined(eMMC_DRV_MERCURY6_UBOOT) && eMMC_DRV_MERCURY6_UBOOT)
// check some fix value, print only when setting wrong
#define A_RIU_BASE   (0x1F000000)
#define A_SDPLL_BANK GET_REG_ADDR(A_RIU_BASE, 0xA0C80) // Bank: 0x1419
...
{
#if (defined(eMMC_DRV_MERCURY6_UBOOT) && eMMC_DRV_MERCURY6_UBOOT)
#ifdef CONFIG_SSTAR_USE_EMMC0
    U16 u16Reg           = 0;
    U8  u8Timeout        = 0;
#endif
#endif
...
#error "IP_SELECT Error !"
...
#elif (defined(eMMC_DRV_MERCURY6_UBOOT) && eMMC_DRV_MERCURY6_UBOOT)
#ifdef CONFIG_SSTAR_USE_EMMC0
    REG_FCIE(GET_REG_ADDR(A_SDPLL_BANK, 0x1A)) = 0x00;        // reg_emmc_test
    REG_FCIE_SETBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x1A), BIT10); // set this bit to enable clk for m6

    // 1. Disable OSP : FALSE =>(ENABLE)
    REG_FCIE_CLRBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x1D), BIT15);

    // 2. Set OSP counter[15:8] = 0x30
    REG_FCIE_CLRBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x37), BIT15 | BIT14 | BIT13 | BIT12 | BIT11 | BIT10 | BIT9 | BIT8);
    REG_FCIE_SETBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x37), BIT13 | BIT12);

    // 3. Switch to 3.3V or 1.8V
    REG_FCIE_CLRBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x37), BIT4 | BIT2);

    // 4. Turning on LDO  1->0
    REG_FCIE_SETBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x37), BIT5);
    eMMC_hw_timer_delay(HW_TIMER_DELAY_10ms);
    REG_FCIE_CLRBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x37), BIT5);

    // 5. Check if power is ready
    do
    {
        u16Reg = REG_FCIE(GET_REG_ADDR(A_SDPLL_BANK, 0x10)) & BIT12;
...
#endif
    if (u32Mode == FCIE_MODE_8BITS_MACRO_HIGH_SPEED || FCIE_eMMC_BYPASS_8X == u32Mode)
    {
        REG_FCIE_CLRBIT(GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x60), BIT7 | BIT8 | BIT9); // clear ej_mode
        REG_FCIE_SETBIT(reg_emmc_config, (BIT_EMMC_MODE_8X));                      // 8B mode
        eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "8X-MOD\r\n");
    }
    else
...
#ifndef CONFIG_SSTAR_USE_EMMC0
    REG_FCIE_SETBIT(NC_CIFD1_EVENT, BIT4);
#endif
#endif
    // fcie
    ...
    if (u32Mode == FCIE_eMMC_BYPASS || FCIE_eMMC_BYPASS_8X == u32Mode)
    {
        REG_FCIE_SETBIT(FCIE_DDR_MODE, BIT_PAD_IN_BYPASS);
    }
    else
    {
...
U32 eMMC_clock_setting(U16 u16_ClkParam)
{
    ...
    // }
    REG_FCIE_SETBIT(reg_ckg_fcie, BIT_FCIE_CLK_SRC_SEL);
#ifdef SDIO_SETTING_ONLY
    REG_FCIE_SETBIT(reg_sc_gp_ctrl, BIT_CKG_SD_VALUE);
#else
    ...
    REG_FCIE_SETBIT(reg_sc_gp_ctrl, BIT7); // reg_ckg_sd [B3]SDIO30 [B7]SD30
#else
    REG_FCIE_SETBIT(reg_sc_gp_ctrl, BIT3); // reg_ckg_sd [B3]SDIO30 [B7]SD30
#endif
