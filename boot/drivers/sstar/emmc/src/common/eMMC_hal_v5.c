...
void       eMMC_FCIE_DumpRegisters(void)
{
    ...
    eMMC_debug(eMMC_DEBUG_LEVEL, 1, "\r\n\r\nFCIE Reg:x%x(x%x)", FCIE_REG_BASE_ADDR,
               (FCIE_REG_BASE_ADDR & 0x00FFFFFF) >> 9);
    ...
    eMMC_debug(eMMC_DEBUG_LEVEL, 1, "\r\n\r\nPAD_CHIPTOP Reg:x%x(BK:x%x)", PAD_CHIPTOP_BASE,
               (PAD_CHIPTOP_BASE & 0x00FFFFFF) >> 9);
...
U32 eMMC_FCIE_SendCmd_Rboot(U16 u16_Mode, U16 u16_Ctrl, U32 u32_Arg, U8 u8_CmdIdx, U8 u8_RspByteCnt)
{
    // U32 u32_err;
...
U32 eMMC_CMD1(void)
{
    ...
    u32_arg = BIT30
              | (BIT23 | BIT22 | BIT21 | BIT20 | BIT19 | BIT18 | BIT17 | BIT16
                 | BIT15); // ARG[<=2G : >2G]/[x00_FF_80_00 : x40_FF_80_00]
    ...
    if (u16_reg & BIT_SD_RSP_TIMEOUT)
    {
        ...
        eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Warn: CMD1 no Rsp, SD_STS: %04Xh \n", u16_reg);
...
U32 eMMC_CMD2(void)
{
    ...
    { // check status
        ...
        if (u16_reg & (BIT_SD_RSP_TIMEOUT | BIT_SD_RSP_CRC_ERR))
        {
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD2 SD_STS: %04Xh\n", u16_reg);
            return u32_err;
        }
        else
    ...
    else
    {
        ...
        if (!(7 == u8_CmdIdx && u16_RCA != g_eMMCDrv.u16_RCA))
        {
            if (u16_reg & (BIT_SD_RSP_TIMEOUT | BIT_SD_RSP_CRC_ERR))
            {
                if (3 == u8_CmdIdx)
                {
                    eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD%u SD_STS: %04Xh, Retry: %u\n", u8_CmdIdx,
                ...
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD%u SD_STS: %04Xh, Retry: %u\n", u8_CmdIdx, u16_reg,
                           u8_retry_fcie);
                eMMC_FCIE_ErrHandler_Stop();
            }
            else
...
LABEL_SEND_CMD:
    ...
    { // check status
        ...
        if (u16_reg & (BIT_SD_RSP_TIMEOUT | BIT_SD_RSP_CRC_ERR))
        {
            ...
            {
                u8_retry_fcie++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD9 SD_STS: %04Xh, Retry: %u\n", u16_reg,
                           u8_retry_fcie);
                eMMC_FCIE_ErrHandler_Retry();
                goto LABEL_SEND_CMD;
            }
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD9 SD_STS: %04Xh, Retry fail: %u\n", u16_reg,
                       u8_retry_fcie);
            eMMC_FCIE_ErrHandler_Stop();
        }
        else
...
LABEL_SEND_CMD:
    ...
    if (eMMC_ST_SUCCESS != u32_err || (u16_reg & BIT_SD_FCIE_ERR_FLAGS))
    {
        ...
        {
            u8_retry_fcie++;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD8 CIFD SD_STS: %04Xh, Err: %Xh, Retry: %u\n", u16_reg,
        ...
        eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD8 CIFD SD_STS: %04Xh, Err: %Xh, Retry: %u\n", u16_reg,
                   u32_err, u8_retry_fcie);
        eMMC_FCIE_ErrHandler_Stop();
        goto LABEL_END;
    }
...
LABEL_SEND_CMD:
    ...
    if (eMMC_ST_SUCCESS != u32_err || (u16_reg & BIT_SD_FCIE_ERR_FLAGS))
    {
        ...
        {
            u8_retry_fcie++;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD8 SD_STS: %04Xh, Err: %Xh, Retry: %u\r\n", u16_reg,
                       u32_err, u8_retry_fcie);
            eMMC_FCIE_ErrHandler_Retry();
            goto LABEL_SEND_CMD;
        }
        u32_err = eMMC_ST_ERR_CMD8_MIU;
        eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD8 SD_STS: %04Xh, Err: %Xh, Retry: %u\r\n", u16_reg, u32_err,
                   u8_retry_fcie);
        eMMC_FCIE_ErrHandler_Stop();
        goto LABEL_END;
    }
...
U32 eMMC_SetPwrOffNotification(U8 u8_SetECSD34)
{
    ...
    switch (u8_SetECSD34)
    {
        case eMMC_PwrOffNotif_OFF:
            g_eMMCDrv.u32_DrvFlag |= DRV_FLAG_PwrOffNotif_OFF;
            break;
        case eMMC_PwrOffNotif_ON:
            g_eMMCDrv.u32_DrvFlag |= DRV_FLAG_PwrOffNotif_ON;
            break;
        case eMMC_PwrOffNotif_SHORT:
            g_eMMCDrv.u32_DrvFlag |= DRV_FLAG_PwrOffNotif_SHORT;
            break;
        case eMMC_PwrOffNotif_LONG:
            g_eMMCDrv.u32_DrvFlag |= DRV_FLAG_PwrOffNotif_LONG;
            break;
    }
...
LABEL_SEND_CMD:
    ...
    { // check status
        ...
        if (u16_reg & (BIT_SD_RSP_TIMEOUT | BIT_SD_RSP_CRC_ERR))
        {
            ...
            {
                u8_retry_fcie++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD6 SD_STS: %04Xh, Retry: %u\n", u16_reg,
                           u8_retry_fcie);
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD6 SD_STS: %04Xh, Retry: %u\n", u16_reg, u8_retry_fcie);
            eMMC_FCIE_ErrHandler_Stop();
        }
        else
        { // CMD3 ok, do things here
...
LABEL_SEND_CMD:
    ...
    else
    {
        ...
        if (u16_reg & (BIT_SD_RSP_TIMEOUT | BIT_SD_RSP_CRC_ERR))
        {
            ...
            {
                u8_retry_fcie++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD38 SD_STS: %04Xh, Retry: %u\n", u16_reg,
                           u8_retry_fcie);
                eMMC_FCIE_ErrHandler_Retry();
                goto LABEL_SEND_CMD;
            }
            ...
            u32_err = eMMC_ST_ERR_CMD3_CMD7;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD38 SD_STS: %04Xh, Retry: %u\n", u16_reg, u8_retry_fcie);
            eMMC_FCIE_ErrHandler_Stop();
        }
        else
...
LABEL_SEND_CMD:
    ...
    { // check status
        ...
        if (u16_reg & (BIT_SD_RSP_TIMEOUT | BIT_SD_RSP_CRC_ERR))
        {
            ...
            {
                u8_retry_fcie++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD13 SD_STS: %04Xh, Retry: %u\n", u16_reg,
                           u8_retry_fcie);
                eMMC_FCIE_ErrHandler_Retry();
                goto LABEL_SEND_CMD;
            }
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD13 SD_STS: %04Xh, Retry: %u\n", u16_reg, u8_retry_fcie);
            eMMC_FCIE_ErrHandler_Stop();
        }
        else
...
LABEL_SEND_CMD:
    ...
    { // check status
        ...
        if (u16_reg & (BIT_SD_RSP_TIMEOUT | BIT_SD_RSP_CRC_ERR))
        {
            ...
            {
                u8_retry_fcie++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD16 SD_STS: %04Xh, Retry: %u\n", u16_reg,
                           u8_retry_fcie);
                eMMC_FCIE_ErrHandler_Retry();
                goto LABEL_SEND_CMD;
            }
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD16 SD_STS: %04Xh, Retry: %u\n", u16_reg, u8_retry_fcie);
            eMMC_FCIE_ErrHandler_Stop();
        }
        else
...
LABEL_SEND_CMD:
    ...
    REG_FCIE_W(FCIE_MIU_DMA_ADDR_15_0, u32_dma_addr & 0xFFFF);
    REG_FCIE_W(FCIE_MIU_DMA_ADDR_31_16, (u32_dma_addr >> 16) & 0xFFFF);
    ...
    if (eMMC_ST_SUCCESS != u32_err || (u16_reg & BIT_SD_FCIE_ERR_FLAGS))
    {
        if (!g_eMMCDrv.u8_disable_retry)
        {
            ...
            {
                u8_retry_fcie++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD17 SD_STS: %04Xh, Err: %Xh, Retry: %u, Arg: %Xh\n",
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD17 SD_STS: %04Xh, Err: %Xh, Retry: %u, Arg: %Xh\n",
                       u16_reg, u32_err, u8_retry_fcie, u32_arg);
            eMMC_FCIE_ErrHandler_Stop();
            goto LABEL_END;
        }
        ...
        {
            u32_err = eMMC_ST_ERR_CMD17_MIU;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD17 SD_STS: %04Xh, Err: %Xh, Arg: %Xh\r\n", u16_reg,
                       u32_err, u32_arg);
    ...
    if (eMMC_ST_SUCCESS != u32_err)
    {
        if (!g_eMMCDrv.u8_disable_retry)
        {
            ...
            {
                u8_retry_r1++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD17 check R1 error: %Xh, Retry: %u, Arg: %Xh\n",
            ...
            {
                u32_err = eMMC_ST_ERR_CMD17_MIU;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD17 check R1 error: %Xh, Retry: %u, Arg: %Xh\n",
                           u32_err, u8_retry_r1, u32_arg);
                eMMC_FCIE_ErrHandler_Stop();
                goto LABEL_END;
            }
        ...
        {
            u32_err = eMMC_ST_ERR_CMD17_MIU;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD17 check R1 error: %Xh, Arg: %Xh\r\n", u32_err,
                       u32_arg);
            eMMC_FCIE_ErrHandler_Stop();
            goto LABEL_END;
        }
...
LABEL_SEND_CMD:
    ...
    if (eMMC_ST_SUCCESS != u32_err || (u16_reg & BIT_SD_FCIE_ERR_FLAGS))
    {
        if (u8_retry_fcie < eMMC_CMD_API_ERR_RETRY_CNT && 0 == eMMC_IF_TUNING_TTABLE())
        {
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1,
                       ...
                       u8_retry_fcie, u32_arg);
            eMMC_FCIE_ErrHandler_Retry();
            goto LABEL_SEND_CMD;
        }
        u32_err = eMMC_ST_ERR_CMD17_CIFD;
        eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD17 CIFD SD_STS: %04Xh, Err: %Xh, Retry: %u, Arg: %Xh\r\n",
                   u16_reg, u32_err, u8_retry_fcie, u32_arg);
        eMMC_FCIE_ErrHandler_Stop();
        goto LABEL_END;
    }
    ...
    if (eMMC_ST_SUCCESS != u32_err)
    {
        ...
        {
            u8_retry_r1++;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD17 CIFD check R1 error: %Xh, Retry: %u, Arg: %Xh\r\n",
                       u32_err, u8_retry_r1, u32_arg);
            eMMC_FCIE_ErrHandler_Retry();
            goto LABEL_SEND_CMD;
        }
        ...
        u32_err = eMMC_ST_ERR_CMD17_CIFD;
        eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD17 CIFD check R1 error: %Xh, Retry: %u, Arg: %Xh\r\n",
                   u32_err, u8_retry_r1, u32_arg);
        eMMC_FCIE_ErrHandler_Stop();
        goto LABEL_END;
    }
...
U32 eMMC_CMD12(U16 u16_RCA)
{
    ...
    { // check status
        ...
        if (u16_reg & (BIT_SD_RSP_TIMEOUT | BIT_SD_RSP_CRC_ERR))
        {
            ...
            {
                u8_retry_fcie++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD12 check SD_STS: %Xh, %Xh, retry: %u\n", u16_reg,
                           u32_err, u8_retry_fcie);
                eMMC_FCIE_ErrHandler_ReInit();
                return u32_err;
            }
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD12 check SD_STS: %Xh, %Xh, retry: %u\n", u16_reg,
                       u32_err, u8_retry_fcie);
            eMMC_FCIE_ErrHandler_Stop();
        }
        else
...
LABEL_SEND_CMD:
    ...
    if (eMMC_ST_SUCCESS != u32_err || (u16_reg & BIT_SD_FCIE_ERR_FLAGS))
    {
        ...
        {
            u8_retry_fcie++;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD18 SD_STS: %04Xh, Err: %Xh, Retry: %u\n", u16_reg,
                       u32_err, u8_retry_fcie);
        ...
        eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD18 SD_STS: %04Xh, Err: %Xh, Retry: %u\n", u16_reg, u32_err,
                   u8_retry_fcie);
        eMMC_FCIE_ErrHandler_Stop();
        goto LABEL_END;
    }
    ...
    if (eMMC_ST_SUCCESS != u32_err)
    {
        ...
        {
            u8_retry_r1++;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD18 check R1 error: %Xh, Retry: %u, Arg: %Xh\n",
                       u32_err, u8_retry_r1, u32_arg);
        ...
        u32_err = eMMC_ST_ERR_CMD18;
        eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD18 check R1 error: %Xh, Retry: %u, Arg: %Xh\n", u32_err,
                   u8_retry_r1, u32_arg);
        eMMC_FCIE_ErrHandler_Stop();
        goto LABEL_END;
    }
...
LABEL_SEND_CMD:
    ...
    { // check status
        ...
        if (u16_reg & (BIT_SD_RSP_TIMEOUT | BIT_SD_RSP_CRC_ERR))
        {
            ...
            {
                u8_retry_fcie++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD23 SD_STS: %04Xh, Retry: %u\n", u16_reg,
                           u8_retry_fcie);
                eMMC_FCIE_ErrHandler_Retry();
                goto LABEL_SEND_CMD;
            }
            ...
            u32_err = eMMC_ST_ERR_CMD13;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD23 SD_STS: %04Xh, Retry: %u\n", u16_reg, u8_retry_fcie);
            eMMC_FCIE_ErrHandler_Stop();
        }
        else
        { // CMD13 ok, do things here
...
#if defined(eMMC_BURST_LEN_AUTOCFG) && eMMC_BURST_LEN_AUTOCFG
    {
        ...
        if (g_eMMCDrv.BurstWriteLen_t.u16_BestBrustLen)
            while (u16_blk_pos < u16_BlkCnt)
            {
                ...
                u16_blk_cnt =
                    u16_blk_cnt == g_eMMCDrv.BurstWriteLen_t.u16_WorstBrustLen ? u16_blk_cnt / 2 : u16_blk_cnt;
...
U32 eMMC_CMD21_MIU(void)
{
    ...
    // u32_err = eMMC_FCIE_WaitEvents(FCIE_MIE_EVENT, BIT_MIU_LAST_DONE|BIT_CARD_DMA_END, TIME_WAIT_1_BLK_END); // edit
    // for MIU
...
LABEL_SEND_CMD:
    ...
    if (eMMC_ST_SUCCESS != u32_err || (u16_reg & (BIT_SD_RSP_TIMEOUT | BIT_SD_RSP_CRC_ERR)))
    {
        if (!g_eMMCDrv.u8_disable_retry)
        {
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD25 SD_STS: %04Xh, Err: %Xh, Retry: %u, Arg: %Xh\n",
                       u16_reg, u32_err, u8_retry_fcie, u32_arg);
            eMMC_FCIE_ErrHandler_Stop();
            goto LABEL_END;
        }
        ...
        {
            u32_err = eMMC_ST_ERR_CMD25;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD25 SD_STS: %04Xh, Err: %Xh, Arg: %Xh\n", u16_reg,
                       u32_err, u32_arg);
            eMMC_FCIE_ErrHandler_ReInit();
            // eMMC_FCIE_ErrHandler_Stop();
            goto LABEL_END;
    ...
    if (eMMC_ST_SUCCESS != u32_err)
    {
        if (!g_eMMCDrv.u8_disable_retry)
        {
            ...
            {
                u8_retry_r1++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD25 check R1 error: %Xh, Retry: %u, Arg: %Xh\n",
                           u32_err, u8_retry_r1, u32_arg);
                eMMC_CMD12_NoCheck(g_eMMCDrv.u16_RCA);
                eMMC_FCIE_ErrHandler_ReInit();
                eMMC_FCIE_ErrHandler_Retry();
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD25 check R1 error: %Xh, Retry: %u, Arg: %Xh\n", u32_err,
                       u8_retry_r1, u32_arg);
            eMMC_FCIE_ErrHandler_Stop();
            goto LABEL_END;
        }
    ...
    u32_err = eMMC_FCIE_WaitEvents(FCIE_MIE_EVENT, BIT_DMA_END, TIME_WAIT_n_BLK_END * (1 + (u16_BlkCnt >> 7)) << 2);
    ...
    if (eMMC_ST_SUCCESS != u32_err || (u16_reg & (BIT_SD_W_FAIL | BIT_SD_W_CRC_ERR)))
    {
        if (!g_eMMCDrv.u8_disable_retry)
        {
            ...
            {
                u8_retry_fcie++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD25 SD_STS: %04Xh, Err: %Xh, Retry: %u, Arg: %Xh\n",
                           u16_reg, u32_err, u8_retry_fcie, u32_arg);
                eMMC_CMD12_NoCheck(g_eMMCDrv.u16_RCA);
                eMMC_FCIE_ErrHandler_ReInit();
                eMMC_FCIE_ErrHandler_Retry();
...
LABEL_SEND_CMD:
    ...
    if (eMMC_ST_SUCCESS != u32_err || (u16_reg & (BIT_SD_RSP_TIMEOUT | BIT_SD_RSP_CRC_ERR)))
    {
        if (!g_eMMCDrv.u8_disable_retry)
        {
            ...
            {
                u8_retry_fcie++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD24 SD_STS: %04Xh, Err: %Xh, Retry: %u, Arg: %Xh\n",
                           u16_reg, u32_err, u8_retry_fcie, u32_arg);
                eMMC_FCIE_ErrHandler_ReInit();
                eMMC_FCIE_ErrHandler_Retry();
                goto LABEL_SEND_CMD;
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD24 SD_STS: %04Xh, Err: %Xh, Retry: %u, Arg: %Xh\n",
                       u16_reg, u32_err, u8_retry_fcie, u32_arg);
            eMMC_FCIE_ErrHandler_Stop();
            goto LABEL_END;
        }
        ...
        {
            u32_err = eMMC_ST_ERR_CMD24_MIU;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD24 SD_STS: %04Xh, Err: %Xh, Arg: %Xh\r\n", u16_reg,
                       u32_err, u32_arg);
            eMMC_FCIE_ErrHandler_Stop();
            goto LABEL_END;
        }
    ...
    if (eMMC_ST_SUCCESS != u32_err)
    {
        if (!g_eMMCDrv.u8_disable_retry)
        {
            ...
            {
                u8_retry_r1++;
                eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD24 check R1 error: %Xh, Retry: %u, Arg: %Xh\n",
                           u32_err, u8_retry_r1, u32_arg);
                eMMC_FCIE_ErrHandler_ReInit();
                eMMC_FCIE_ErrHandler_Retry();
                goto LABEL_SEND_CMD;
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD24 check R1 error: %Xh, Retry: %u, Arg: %Xh\n", u32_err,
                       u8_retry_r1, u32_arg);
            eMMC_FCIE_ErrHandler_Stop();
            goto LABEL_END;
        }
        ...
        {
            u32_err = eMMC_ST_ERR_CMD24_MIU_CHK_R1;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD24 check R1 error: %Xh, Arg: %Xh\n", u32_err, u32_arg);
            eMMC_FCIE_ErrHandler_Stop();
            goto LABEL_END;
        }
    }
...
LABEL_SEND_CMD:
    ...
    if (eMMC_ST_SUCCESS != u32_err)
    {
        ...
        {
            u8_retry_r1++;
            eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC WARN: CMD24 CIFD check R1 error: %Xh, Retry: %u, Arg: %Xh \n",
                       u32_err, u8_retry_r1, u32_arg);
            eMMC_FCIE_ErrHandler_Retry();
            goto LABEL_SEND_CMD;
        }
        u32_err = eMMC_ST_ERR_CMD24_CIFD_CHK_R1;
        eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD24 CIFD check R1 error: %Xh, Retry: %u, Arg: %Xh \n",
                   u32_err, u8_retry_r1, u32_arg);
        eMMC_FCIE_ErrHandler_Stop();
        goto LABEL_END;
    }
    ...
    if (eMMC_ST_SUCCESS != u32_err || (u16_reg & (BIT_SD_W_FAIL | BIT_SD_W_CRC_ERR)))
    {
        ...
        eMMC_debug(eMMC_DEBUG_LEVEL_ERROR, 1, "eMMC Err: CMD24 CIFD SD_STS: %04Xh, Err: %Xh, Retry: %u, Arg: %Xh\n",
                   u16_reg, u32_err, u8_retry_fcie, u32_arg);
        eMMC_FCIE_ErrHandler_Stop();
        goto LABEL_END;
    }
