...
#define eMMC_ERR_R1_31_24                                                                                        \
    (eMMC_R1_ADDRESS_OUT_OF_RANGE | eMMC_R1_ADDRESS_MISALIGN | eMMC_R1_BLOCK_LEN_ERROR | eMMC_R1_ERASE_SEQ_ERROR \
     | eMMC_R1_ERASE_PARAM | eMMC_R1_WP_VIOLATION | eMMC_R1_LOCK_UNLOCK_FAILED)
#define eMMC_ERR_R1_23_16                                                                                           \
    (eMMC_R1_COM_CRC_ERROR | eMMC_R1_ILLEGAL_COMMAND | eMMC_R1_DEVICE_ECC_FAILED | eMMC_R1_CC_ERROR | eMMC_R1_ERROR \
     | eMMC_R1_CID_CSD_OVERWRITE)
#define eMMC_ERR_R1_15_8 (eMMC_R1_WP_ERASE_SKIP | eMMC_R1_ERASE_RESET)
...
#define eMMC_ERR_R1_NEED_RETRY \
    (eMMC_R1_COM_CRC_ERROR | eMMC_R1_DEVICE_ECC_FAILED | eMMC_R1_CC_ERROR | eMMC_R1_ERROR | eMMC_R1_SWITCH_ERROR)
//===========================================================
// driver error codes
//===========================================================
