...
#ifndef SWAP16
#define SWAP16(x) ((U16)((((U16)(x) & (U16)0x00ffU) << 8) | (((U16)(x) & (U16)0xff00U) >> 8)))
#endif
#ifndef SWAP32
#define SWAP32(x)                                                                         \
...
#ifndef SWAP64
#define SWAP64(x)                                                                                                      \
    ((U64)((U64)(((U64)(x) & (U64)0x00000000000000ffULL) << 56) | (U64)(((U64)(x) & (U64)0x000000000000ff00ULL) << 40) \
           | (U64)(((U64)(x) & (U64)0x0000000000ff0000ULL) << 24)                                                      \
           | (U64)(((U64)(x) & (U64)0x00000000ff000000ULL) << 8) | (U64)(((U64)(x) & (U64)0x000000ff00000000ULL) >> 8) \
...
extern U32 eMMC_WritePartition(U16 u16_PartType, U8 *pu8_DataBuf, U32 u32_StartPhySector, U32 u32_SectorCnt,
                               U32 u32_LogicIdx);
extern U32 eMMC_ReadPartition(U16 u16_PartType, U8 *pu8_DataBuf, U32 u32_StartPhySector, U32 u32_SectorCnt,
                              U32 u32_LogicIdx);
extern U32 eMMC_GetPartitionCapacity(U16 u16_PartType, U32 *pu32_Cap);
