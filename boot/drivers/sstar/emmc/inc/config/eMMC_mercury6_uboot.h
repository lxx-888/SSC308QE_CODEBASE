/*
 * eMMC_mercury6_uboot.h- Sigmastar
 *
...
#ifndef __eMMC_MERCURY6_UBOOT__
#define __eMMC_MERCURY6_UBOOT__
...
#define EMMC_SEL_INTERFACE 2 //[0:1:2]/[FCIE:SDIO:SD]

#ifdef CONFIG_SSTAR_USE_EMMC0
#define ONLY_4_BITS_MODE (1)
#endif

#ifdef CONFIG_SSTAR_USE_EMMC0
#define REG_BANK_FCIE0 0x20980U // sdio0:x1413
#else
#define REG_BANK_FCIE0 0x20800U // sdio1:x1410
#endif
#define REG_BANK_FCIE1 0x20A00U // sd1:x1414
#define REG_BANK_FCIE2 0x20A80U // sd2:x1415
#define REG_BANK_FCIE3 0x20980U // sdio1:x1413
...
#define FCIE1_REG_BASE_ADDR    GET_REG_ADDR(FCIE3_BASE, 0x00)
...
#define REG_BANK_SC_GP_CTRL (0x1133 - 0x1000) * 0x80 // BK:x1133 reg_block
#define SC_GP_CTRL_BASE     GET_REG_ADDR(RIU_BASE, REG_BANK_SC_GP_CTRL)
#define reg_sc_gp_ctrl      GET_REG_ADDR(SC_GP_CTRL_BASE, 0x25) // reg_ckg_sd [B3]SDIO30 [B7]SD30
...
#define PAD_PADTOP_BASE  GET_REG_ADDR(RIU_BASE, REG_BANK_CHIPTOP) // CHIPTOP OR PADTOP

#define reg_emmc_rstz_en GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x61) //[B3]reg_emmc0_rst_mode [B7:B6] reg_emmc1_rst_mode
#ifdef CONFIG_SSTAR_USE_EMMC0
#define BIT_EMMC_RST (BIT4)
#else
#define BIT_EMMC_RST (BIT14)
#endif

#define reg_all_pad_in GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x50)
#define BIT_ALL_PAD_IN (BIT15)

#define reg_sd_config    GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x67)
#define BIT_SD_MODE_MASK (BIT8 | BIT9 | BIT10 | BIT12 | BIT13 | BIT14)
#define BIT_SD_MODE_1    (BIT8) //[8]reg_sd0_mode
//#define BIT_SD0_CDZ_MODE                (BIT9)  //[9]reg_sd0_cdz_mode
//#define BIT_SD1_MODE                    (BIT12) //[13:12]reg_sd1_mode

#define reg_sdio_config    GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x68)
#define BIT_SDIO_MODE_MASK (BIT12 | BIT13 | BIT14) //[B14~B12]reg_sd1_cdz_mode

#define reg_emmc_config GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x61)
#define BIT_EMMC0_MODE_MASK \
    (BIT0 | BIT1 | BIT2 | BIT3 | BIT4 | BIT5) //[1:0]reg_emmc0_4b_mode   [3:2]reg_emmc0_8b_mode [5:4]reg_emmc0_rst_mode
#define BIT_EMMC1_MODE_MASK                    \
    (BIT6 | BIT7 | BIT8 | BIT9 | BIT12 | BIT13 \
     | BIT14) //[7:6]reg_emmc1_4b_mode [9:8]reg_emmc1_8b_mode  [14:12]reg_emmc1_rst_mode
#define BIT_EMMC_MODE_MASK (BIT_EMMC0_MODE_MASK | BIT_EMMC1_MODE_MASK)
#ifdef CONFIG_SSTAR_USE_EMMC0
#define BIT_EMMC_MODE_1  (BIT0 | BIT_EMMC_RST) //[0]reg_emmc0_4b_mode   [4]reg_emmc0_rst_mode [14]reg_emmc1_rst_mode
#define BIT_EMMC_MODE_8X (BIT2 | BIT_EMMC_RST) //[2]reg_emmc0_8b_mode
#else
#define BIT_EMMC_MODE_1  (BIT6 | BIT_EMMC_RST) //[6]reg_emmc0_4b_mode   [4]reg_emmc0_rst_mode [14]reg_emmc1_rst_mode
#define BIT_EMMC_MODE_8X (BIT8 | BIT_EMMC_RST) //[8]reg_emmc0_8b_mode
#endif

//--------------------------------clock gen------------------------------------
#define BIT_SD_CLK_48M   0x0
#define BIT_SD_CLK_43_2M 0x1
#define BIT_SD_CLK_40M   0x2
#define BIT_SD_CLK_36M   0x3
#define BIT_SD_CLK_32M   0x4
#define BIT_SD_CLK_20M   0x5
#define BIT_CLK_XTAL_12M 0x6
#define BIT_SD_CLK_300K  0x7

#define BIT_FCIE_CLK_20M   BIT_SD_CLK_20M
#define BIT_FCIE_CLK_32M   BIT_SD_CLK_32M
#define BIT_FCIE_CLK_36M   BIT_SD_CLK_36M
#define BIT_FCIE_CLK_40M   BIT_SD_CLK_40M
#define BIT_FCIE_CLK_43_2M BIT_SD_CLK_43_2M
#define BIT_FCIE_CLK_300K  BIT_SD_CLK_300K
#define BIT_FCIE_CLK_48M   BIT_SD_CLK_48M
...
#define eMMC_RST_L()                                         \
    {                                                        \
        REG_FCIE_SETBIT(reg_emmc_rstz_en, BIT_EMMC_RST);     \
...
#define eMMC_RST_H()                                         \
    {                                                        \
        ...
        REG_FCIE_CLRBIT(FCIE_BOOT_CONFIG, BIT_EMMC_RSTZ_EN); \
    }
...
#define FCIE_eMMC_BYPASS_8X              9
#define FCIE_MODE_4BITS_MACRO_HIGH_SPEED 1
#define FCIE_MODE_8BITS_MACRO_HIGH_SPEED 2

#ifdef ONLY_4_BITS_MODE
#define FCIE_eMMC_SDR FCIE_MODE_4BITS_MACRO_HIGH_SPEED
#else
#if (EMMC_WORKING_BUS_CFG == 8)
