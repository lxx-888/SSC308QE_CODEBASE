...
#ifndef __eMMC_REG_H__
#define __eMMC_REG_H__
...
#define BIT_ALL_CARD_INT_EVENTS \
    (BIT_MMA_DATA_END | BIT_SD_CMD_END | BIT_SD_DATA_END | BIT_CARD_DMA_END | BIT_MIU_LAST_DONE | BIT_CARD_BOOT_DONE)
...
#define BIT_HS200_PATCH_MASK \
    (BIT_HS200_RDDAT_PATCH | BIT_HS200_NORSP_PATCH | BIT_HS200_WCRC_PATCH | BIT_sbit_lose_patch)
