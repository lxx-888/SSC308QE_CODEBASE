...
#define ENABLE_INFINITY6B0 1
#elif defined(CONFIG_ARCH_MERCURY6)
#define ENABLE_MERCURY6 1
#endif
...
#elif ENABLE_INFINITY6B0
#define eMMC_DRV_INFINITY6B0_UBOOT 1
#elif ENABLE_MERCURY6
#define eMMC_DRV_MERCURY6_UBOOT 1
#endif
...
#include "eMMC_infinity6b0_uboot.h"
#elif defined(eMMC_DRV_MERCURY6_UBOOT) && eMMC_DRV_MERCURY6_UBOOT
#include "eMMC_mercury6_uboot.h"
#else
