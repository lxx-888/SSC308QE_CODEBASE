...
static const char* const uart_parents[] = {"CLK_mpll_172m", "CLK_mpll_288m_div2", "CLK_xtali_24m", "CLK_uart_synth"};

static const char* const fuart_parents[] = {"CLK_mpll_172m", "CLK_mpll_288m_div2", "CLK_xtali_12m", "CLK_fuart_synth"};

static const char* const mspi_parents[] = {
    "CLK_mpll_288m_div2", "CLK_mpll_432m_div8", "CLK_xtali_12m", "CLK_mpll_432m_div4",
    "CLK_spi_synth_pll",  "CLK_mpll_288m_div4", "CLK_VOID",      "CLK_VOID"};

static const char* const gphy0_parents[] = {"CLK_gmacpll_25a", "CLK_gmacpll_250_div5", "CLK_void", "CLK_void"};

static const char* const gphy1_parents[] = {"CLK_gmacpll_25b", "CLK_gmacpll_250_div5", "CLK_void", "CLK_void"};
...
const sstar_clk_data clk_list[] = {
    ...
    SSTAR_CLK_FIXED_RATE(SSTAR_CLK_SPI_SYNTH_PLL, "CLK_spi_synth_pll", 266000000),
    ...
    SSTAR_CLK_COMPOSITE(SSTAR_CLK_MSPI1, "CLK_mspi1", mspi_parents, ARRAY_SIZE(mspi_parents), REG_CKG_MSPI1_BASE,
                        REG_CKG_MSPI1_OFFSET + 2, 3, REG_CKG_MSPI1_OFFSET, 0),
    SSTAR_CLK_COMPOSITE(SSTAR_CLK_MSPI2, "CLK_mspi2", mspi_parents, ARRAY_SIZE(mspi_parents), REG_CKG_MSPI2_BASE,
                        REG_CKG_MSPI2_OFFSET + 2, 3, REG_CKG_MSPI2_OFFSET, 0),
    SSTAR_CLK_COMPOSITE(SSTAR_CLK_MSPI3, "CLK_mspi3", mspi_parents, ARRAY_SIZE(mspi_parents), REG_CKG_MSPI3_BASE,
                        REG_CKG_MSPI3_OFFSET + 2, 3, REG_CKG_MSPI3_OFFSET, 0),
    SSTAR_CLK_COMPOSITE(SSTAR_CLK_UART3, "CLK_uart3", uart_parents, ARRAY_SIZE(uart_parents), REG_CKG_FUART3_BASE,
                        REG_CKG_FUART3_OFFSET + 2, 2, REG_CKG_FUART3_OFFSET, 0),
    SSTAR_CLK_COMPOSITE(SSTAR_CLK_UART4, "CLK_uart4", uart_parents, ARRAY_SIZE(uart_parents), REG_CKG_FUART4_BASE,
                        REG_CKG_FUART4_OFFSET + 2, 2, REG_CKG_FUART4_OFFSET, 0),
    SSTAR_CLK_COMPOSITE(SSTAR_CLK_UART5, "CLK_uart5", uart_parents, ARRAY_SIZE(uart_parents), REG_CKG_FUART5_BASE,
                        REG_CKG_FUART5_OFFSET + 2, 2, REG_CKG_FUART5_OFFSET, 0),
    SSTAR_CLK_COMPOSITE(SSTAR_CLK_UART6, "CLK_uart6", uart_parents, ARRAY_SIZE(uart_parents), REG_CKG_FUART6_BASE,
                        REG_CKG_FUART6_OFFSET + 2, 2, REG_CKG_FUART6_OFFSET, 0),
    SSTAR_CLK_COMPOSITE(SSTAR_CLK_UART7, "CLK_uart7", uart_parents, ARRAY_SIZE(uart_parents), REG_CKG_FUART7_BASE,
                        REG_CKG_FUART7_OFFSET + 2, 2, REG_CKG_FUART7_OFFSET, 0),
};
