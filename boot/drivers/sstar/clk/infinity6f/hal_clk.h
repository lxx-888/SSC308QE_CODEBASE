...
#define SSTAR_CLK_MIIC4         CCP_ID(11)
#define SSTAR_CLK_MIIC5         CCP_ID(12)
#define SSTAR_CLK_UART0         CCP_ID(13)
#define SSTAR_CLK_UART1         CCP_ID(14)
#define SSTAR_CLK_UART2         CCP_ID(15)
#define SSTAR_CLK_FUART         CCP_ID(16)
#define SSTAR_CLK_MSPI0         CCP_ID(17)
#define SSTAR_CLK_GPHY0_REF     CCP_ID(18)
#define SSTAR_CLK_GPHY1_REF     CCP_ID(19)
#define SSTAR_CLK_PM_PWM        CCP_ID(20)
#define SSTAR_CLK_MSPI1         CCP_ID(21)
#define SSTAR_CLK_MSPI2         CCP_ID(22)
#define SSTAR_CLK_MSPI3         CCP_ID(23)
#define SSTAR_CLK_UART3         CCP_ID(24)
#define SSTAR_CLK_UART4         CCP_ID(25)
#define SSTAR_CLK_UART5         CCP_ID(26)
#define SSTAR_CLK_UART6         CCP_ID(27)
#define SSTAR_CLK_UART7         CCP_ID(28)
