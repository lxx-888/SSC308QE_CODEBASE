...
#ifndef _MHAL_EMAC_H_
#define _MHAL_EMAC_H_
...
//#define CONFIG_SSTAR_ETHERNET_ALBANY
...
#define JULIAN_100_VAL_MII  (0x0000F011)
#define JULIAN_100_VAL_RMII (0x0000F017)

// Base address here:
#ifdef CONFIG_SSTAR_EMAC1
#define REG_ADDR_BASE (0x1F000000 | (REG_BANK_EMAC0 << 9))
#else
...
#define REG_BANK_PADTOP   0x103C
//#define REG_BANK_ANA_MISC                   0x110C

#ifdef CONFIG_SSTAR_EMAC1
#define REG_BANK_EMAC0 0x1514
#define REG_BANK_EMAC1 0x1515
#define REG_BACK_EMAC2 0x1516
#define REG_BANK_EMAC3 0x1517
#else
...
#define REG_BANK_ALBANY0 0x1518
#define REG_BANK_ALBANY1 0x1519
#define REG_BANK_ALBANY2 0x151A
