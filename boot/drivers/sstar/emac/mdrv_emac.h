...
#ifndef _MDRV_EMAC_H_
#define _MDRV_EMAC_H_
...
#endif
// Descriptor part
#define RXD_SIZE     (0x0008)
#define RBQP_SIZE    (RXD_SIZE * RBQP_LENG) // ==8bytes*?==?descriptors
...
#elif defined(CONFIG_SSTAR_ETHERNET_RMII)
