...
#define PWM_DEBUG 0
#if PWM_DEBUG
#define pwm_err(fmt, ...) printk("%s: " fmt, __func__, ##__VA_ARGS__)
#define pwm_dbg(fmt, ...) printk("%s: " fmt, __func__, ##__VA_ARGS__)
#else
#define pwm_err(fmt, ...) printk("%s: " fmt, __func__, ##__VA_ARGS__)
#define pwm_dbg(fmt, ...)
#endif
...
extern void hal_pwm_sync_mode_enbale(struct hal_pwm_cfg *pwm_cfg, u8 enable);
...
extern u64  hal_pwm_get_period(struct hal_pwm_cfg *pwm_cfg);
extern int  hal_pwm_set_period(struct hal_pwm_cfg *pwm_cfg, u64 period_wf, u8 sync);
extern u64  hal_pwm_get_duty(struct hal_pwm_cfg *pwm_cfg);
extern int  hal_pwm_set_duty(struct hal_pwm_cfg *pwm_cfg, u64 duty_wf, u8 sync);
extern u64  hal_pwm_get_shift(struct hal_pwm_cfg *pwm_cfg);
...
#ifdef HAL_PWM_REG_CFG
#define HAL_PWM_MAX_GROUP      3
#define HAL_PWM_MAX_CHANNEL    14
...
static const struct hal_pwm_com_res pwm_hold_mode[] = {
    ...
    {.bank = 0x1019, .offset = 0x71, .bit = HAL_PWM_BIT2},
};
...
static const struct hal_pwm_com_res pwm_stop_mode[] = {
    ...
    {.bank = 0x1019, .offset = 0x72, .bit = HAL_PWM_BIT2},
};
...
static const struct hal_pwm_com_res pwm_group_enable[] = {
    ...
    {.bank = 0x1019, .offset = 0x73, .bit = HAL_PWM_BIT2},
};
...
static const struct hal_pwm_com_res pwm_sync_mode[] = {
    ...
    {.bank = 0x1019, .offset = 0x74, .bit = HAL_PWM_BIT8},  {.bank = 0x1019, .offset = 0x74, .bit = HAL_PWM_BIT9},
    {.bank = 0x1019, .offset = 0x74, .bit = HAL_PWM_BIT10}, {.bank = 0x1019, .offset = 0x74, .bit = HAL_PWM_BIT11},
};
...
static const struct hal_pwm_com_res pwm_hold_int[] = {
    ...
    {.bank = 0x1019, .offset = 0x75, .bit = HAL_PWM_BIT2},
};
...
static const struct hal_pwm_com_res pwm_round_int[] = {
    ...
    {.bank = 0x1019, .offset = 0x75, .bit = HAL_PWM_BIT5},
};
...
static const struct hal_pwm_com_res pwm_channel_reset[] = {
    ...
    {.bank = 0x1019, .offset = 0x7F, .bit = HAL_PWM_BIT8},  {.bank = 0x1019, .offset = 0x7F, .bit = HAL_PWM_BIT9},
    {.bank = 0x1019, .offset = 0x7F, .bit = HAL_PWM_BIT10}, {.bank = 0x1019, .offset = 0x7F, .bit = HAL_PWM_BIT14},
...
static const struct hal_pwm_com_res pwm_group_reset[] = {
    ...
    {.bank = 0x1019, .offset = 0x7F, .bit = HAL_PWM_BIT13},
};
