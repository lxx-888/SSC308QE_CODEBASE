                              ...
                              enum hal_i2c_speed_mode para_speed_mode)
{
    ...
    if (para_hal_ctrl->output_mode == HAL_I2C_OPEN_DRAIN_OEN_CLKSTR)
    {
    ...
    para_hal_ctrl->clock_count.cnt_sda_hold  = cnt_scl_low / 2;
...
s32 hal_i2c_cnt_reg_set(struct hal_i2c_ctrl *para_hal_ctrl)
{
    ...
    ret |= hal_i2c_sda_cnt_set(para_hal_ctrl, para_hal_ctrl->clock_count.cnt_sda_hold); // tHD:DAT
...
s32 hal_i2c_init(struct hal_i2c_ctrl *para_hal_ctrl)
{
    ...
    switch (para_hal_ctrl->output_mode)
    {
        ...
        case HAL_I2C_OPEN_DRAIN_OEN:
            ...
            break;
        case HAL_I2C_OPEN_DRAIN_OEN_CLKSTR:
            para_hal_ctrl->config |= HAL_I2C_CONFIG_OEN_PUSH_EN;
            HAL_I2C_WRITE_REG_MASK(HAL_I2C_REG_CNT_TSUTHD_OPEN, BIT6, HAL_I2C_MASK_SCL_ODN_SDA_OEN);
            break;
