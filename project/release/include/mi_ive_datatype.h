...
typedef enum
{
    E_MI_IVE_CSC_MODE_PIC_BT601_YUV2RGB        =  0x0,   /*CSC: NV12_YUV2RGB, picture transfer mode, RGB value range [0, 255]*/
    E_MI_IVE_CSC_MODE_PIC_BT601_YUV2BGR        =  0x1,   /*CSC: NV12_YUV2BGR, picture transfer mode, BGR value range [0, 255]*/
    E_MI_IVE_CSC_MODE_PIC_BT601_RGB2YUV        =  0x2,   /*CSC: RGB2YUV_NV12, picture transfer mode, YUV_NV12:value range [0, 255]*/
    E_MI_IVE_CSC_MODE_PIC_BT601_BGR2YUV        =  0x3,   /*CSC: BGR2YUV_NV12, picture transfer mode, YUV_NV12:value range [0, 255]*/
    E_MI_IVE_CSC_MODE_PIC_BT601_NV21_YUV2RGB   =  0x4,   /*CSC: NV21_YUV2RGB, picture transfer mode, RGB value range [0, 255]*/
    E_MI_IVE_CSC_MODE_PIC_BT601_NV21_YUV2BGR   =  0x5,   /*CSC: NV21_YUV2BGR, picture transfer mode, BGR value range [0, 255]*/
    E_MI_IVE_CSC_MODE_PIC_BT601_RGB2YUV_NV21   =  0x6,   /*CSC: RGB2YUV_NV21, picture transfer mode, YUV_NV21:value range [0, 255]*/
    E_MI_IVE_CSC_MODE_PIC_BT601_BGR2YUV_NV21   =  0x7,   /*CSC: BGR2YUV_NV21, picture transfer mode, YUV_NV21:value range [0, 255]*/
...
typedef struct MI_IVE_Ccl_CTRL_S
{
    ...
    MI_IVE_CclMode_e eCclMode;       /*CCL mode*/
}MI_IVE_CclCtrl_t;
...
typedef struct _MVE_IVE_ResizeCtrl_s
{
    ...
    MI_IVE_ResizeMethod_e eResizeMethod; /*Resize Method*/
...
typedef struct MI_IVE_MatrTranfCtrl_S
{
    ...
    MVE_IVE_MatrTranfCtrlMode_e enCtrlMode;
...
typedef enum
{
    E_MI_IVE_BGBLUR_MODE_BLUR            = 0x00, /*BackGround Blur*/
    E_MI_IVE_BGBLUR_MODE_REPLACE         = 0x01, /*BackGround Replace*/
    E_MI_IVE_BGBLUR_MODE_MOSAIC          = 0x02, /*BackGround Mosaic*/
    E_MI_IVE_BGBLUR_MODE_BLUR_AND_MOSAIC = 0x03, /*BackGround Blur and Mosaic*/
...
{
    MI_IVE_BgBlurMode_e   eBgBlurMode;    /*Working mode*/
    MI_U8                 u8MaskThr;      /*Threshold for Input mask binarization*/
    MI_U8                 u8BlurLv;       /*Level of BackGround Blur*/
    MI_U8                 u8ScalingStage; /*Stages of scaling, indicates max Blur strength*/
    MI_IVE_BgBlurMaskOp_e eBgBlurMaskOp;  /*PreProcess for Mask*/
