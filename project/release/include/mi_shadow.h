...
#define SHADOW_VERSION_STR(major_version, sub_version)                                                                 \
    (                                                                                                                  \
        {                                                                                                              \
            char *tmp =                                                                                                \
                sub_version / 100  ? "mi_shadow_version_" MACRO_TO_STR(major_version) "." MACRO_TO_STR(sub_version)    \
                : sub_version / 10 ? "mi_shadow_version_" MACRO_TO_STR(major_version) ".0" MACRO_TO_STR(sub_version)   \
                                   : "mi_shadow_version_" MACRO_TO_STR(major_version) ".00" MACRO_TO_STR(sub_version); \
            tmp;                                                                                                       \
        })
...
extern "C"
{
    ...
    MI_S32 MI_SHADOW_GetOutputPortBuf(MI_SHADOW_HANDLE hShadow, MI_U32 u32ChnId, MI_U32 u32PortId,
                                      MI_SYS_BufConf_t *pstBufConfig,

                                      MI_BOOL *pbBlockedByRateCtrl, MI_SYS_BufInfo_t *pstBufInfo,
                                      MI_SYS_BUF_HANDLE *phBufHandle);
    MI_S32 MI_SHADOW_GetInputPortBuf(MI_SHADOW_HANDLE hShadow, MI_U32 u32ChnId, MI_U32 u32PortId,

                                     MI_SYS_BufInfo_t *pstBufInfo, MI_SYS_BUF_HANDLE *phBufHandle);
    ...
    MI_S32 MI_SHADOW_SetInputPortBufExtConf(MI_SHADOW_HANDLE hShadow, MI_U32 u32ChnId, MI_U32 u32PortId,
                                            MI_SYS_FrameBufExtraConfig_t *pstBufExtraConf);
    MI_S32 MI_SHADOW_SetOutputPortBufExtConf(MI_SHADOW_HANDLE hShadow, MI_U32 u32ChnId, MI_U32 u32PortId,
                                             MI_SYS_FrameBufExtraConfig_t *pstBufExtraConf);
