...
extern "C"
{
    ...
    MI_S32 MI_ISP_SetAiBnrAttr(MI_ISP_DEV DevId, MI_ISP_CHANNEL ChnId, MI_ISP_AiBnrAttr_t *pstAiAttr);
    MI_S32 MI_ISP_LoadAiBnrModel(MI_ISP_DEV DevId, MI_ISP_CHANNEL ChnId, char *pModelPath);
    MI_S32 MI_ISP_UnloadAiBnrModel(MI_ISP_DEV DevId, MI_ISP_CHANNEL ChnId);
#ifdef __cplusplus
}
#endif
