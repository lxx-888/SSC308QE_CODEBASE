...
typedef enum _MI_VG_RET_E
{
    ...
    MI_VG_RET_INVALID_POLYGON_REGION_COORDINATE_POINTER  = 0x1000031A,   /*Invalid polygon region coordinate pointer*/
    MI_VG_RET_INVALID_POLYGON_REGION_MAGIC_NUMBER        = 0x1000031B,   /*Invalid POLYGON region magic number*/
    MI_VG_RET_INVALID_POLYGON_REGION_COORDINATE          = 0x1000031C    /*Invalid polygon region coordinate*/
} MI_VG_RET;
...
typedef struct _MI_VgDetectThd_t
{
...
MI_VG_RET MI_VG_SetPolygonRegionAndDir(MI_VgSet_t* vg_user_info, MI_VgRegion_t* region_coordinate);
