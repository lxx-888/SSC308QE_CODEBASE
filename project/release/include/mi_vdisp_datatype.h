...
#define VDISP_MAX_OVERLAYINPUTCHN_NUM 48
...
#define MI_VDISP_ERR_NOMEM         (MI_DEF_ERR(E_MI_MODULE_ID_VDISP, E_MI_ERR_LEVEL_ERROR, E_MI_ERR_NOMEM))
...
#define MI_VDISP_ERR_DEV_NOT_CLOSE \
    (MI_DEF_ERR(E_MI_MODULE_ID_VDISP, E_MI_ERR_LEVEL_ERROR, E_MI_VDISP_ERR_DEV_NOT_CLOSE))
...
#define MI_VDISP_ERR_PORT_NOT_UNBIND \
    (MI_DEF_ERR(E_MI_MODULE_ID_VDISP, E_MI_ERR_LEVEL_ERROR, E_MI_VDISP_ERR_PORT_NOT_UNBIND))
