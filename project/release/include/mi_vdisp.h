...
#define VDISP_SUB_VERSION   6
#define MACRO_TO_STR(macro) #macro
#define VDISP_VERSION_STR(major_version, sub_version)                                                                 \
    (                                                                                                                 \
        {                                                                                                             \
            char *tmp =                                                                                               \
                sub_version / 100  ? "mi_vdisp_version_" MACRO_TO_STR(major_version) "." MACRO_TO_STR(sub_version)    \
                : sub_version / 10 ? "mi_vdisp_version_" MACRO_TO_STR(major_version) ".0" MACRO_TO_STR(sub_version)   \
                                   : "mi_vdisp_version_" MACRO_TO_STR(major_version) ".00" MACRO_TO_STR(sub_version); \
            tmp;                                                                                                      \
        })
...
extern "C"
{
    ...
    MI_S32 MI_VDISP_SetInputChannelAttr(MI_VDISP_DEV DevId, MI_VDISP_CHN ChnId,
                                        MI_VDISP_InputChnAttr_t *pstInputChnAttr);
    MI_S32 MI_VDISP_GetInputChannelAttr(MI_VDISP_DEV DevId, MI_VDISP_CHN ChnId,
                                        MI_VDISP_InputChnAttr_t *pstInputChnAttr);
