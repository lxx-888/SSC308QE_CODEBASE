...
#define E_LX_MEM_LEN                                           0x000FEE0000
#define E_LX_MEM_MEMORY_TYPE                                   (MIU0 | TYPE_NONE | UNCACHE | TYPE_NONE)
#define E_LX_MEM_CMA_HID                                       0

/* E_MMAP_ID_EMI   */
#define E_MMAP_ID_EMI_LAYER                                    0
#define E_MMAP_ID_EMI_AVAILABLE                                0x000FEE0000
#define E_MMAP_ID_EMI_ADR                                      0x000FEE0000  //Alignment 0x01000
...
#define MIU0_END_ADR                                           0x000FF00000
#define MMAP_COUNT                                             0x0000000002
