...
#define E_LX_MEM_LEN                                           0x0007FE0000
#define E_LX_MEM_MEMORY_TYPE                                   (MIU0 | TYPE_NONE | UNCACHE | TYPE_NONE)
#define E_LX_MEM_CMA_HID                                       0

/* E_MMAP_ID_EMI   */
#define E_MMAP_ID_EMI_LAYER                                    0
#define E_MMAP_ID_EMI_AVAILABLE                                0x0007FE0000
#define E_MMAP_ID_EMI_ADR                                      0x0007FE0000  //Alignment 0x01000
