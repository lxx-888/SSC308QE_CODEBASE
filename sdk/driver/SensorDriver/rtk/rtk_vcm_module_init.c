...
#endif
#if defined (_VCM_LC898249_)
extern int  LC898249_init_driver(unsigned char chmap);
#endif
...
#if defined (_VCM_LC898249_)
    #if (_VCM_LC898249_ == 0)
        LC898249_init_driver(_VCM0_CHMAP_);
    #elif (_VCM_LC898249_ == 1)
        LC898249_init_driver(_VCM1_CHMAP_);
    #endif
#endif
