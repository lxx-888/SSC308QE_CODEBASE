...
static int ps5250_SetPatternMode(ss_cus_sensor *handle,u32 mode)
{
    ...
    switch(status)
    {
        case CUS_FRAME_INACTIVE:
            ...
            if(params->orient_dirty)
            {
                ...
                handle->sensor_if_api->SetSkipFrame(idx, params->expo.cur_fps, 1);
...
static int cus_camsensor_init_handle(ss_cus_sensor* drv_handle) {
   ss_cus_sensor *handle = drv_handle;
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->strSensorStreamName, "ps5250_MIPI");
    ////////////////////////////////////
    ...
    handle->video_res_supported.ulcur_res = 0;
    handle->video_res_supported.res[1].u16width = 1928;
    handle->video_res_supported.res[1].u16height = 1088;
    ...
    handle->video_res_supported.res[1].u16OutputWidth= 1928;
    handle->video_res_supported.res[1].u16OutputHeight= 1088;
    sprintf(handle->video_res_supported.res[1].strResDesc, "1928x1088@30fps");
#endif
    // i2c
