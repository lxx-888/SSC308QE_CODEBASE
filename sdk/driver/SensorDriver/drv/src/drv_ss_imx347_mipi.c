...
static int imx347_SetPatternMode(ss_cus_sensor *handle,u32 mode)
{
    int i;
    switch(mode)
    {
...
static int IMX347_GetShutterInfo(struct __ss_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
...
static int IMX347_GetShutterInfo_HDR_DOL_SEF(struct __ss_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
    imx347_params *params = (imx347_params *)handle->private_data;
...
int cus_camsensor_init_handle_linear(ss_cus_sensor* drv_handle)
{
    ...
    //    sensor model ID             //
    ////////////////////////////////////
    sprintf(handle->strSensorStreamName,"IMX347_MIPI_Linear");
   ...
   //handle->video_res_supported.num_res = LINEAR_RES_END;
    for (res = 0; res < LINEAR_RES_END; res++) {
        ...
        handle->video_res_supported.res[res].u16width         = imx347_mipi_linear[res].senif.preview_w;
        handle->video_res_supported.res[res].u16height        = imx347_mipi_linear[res].senif.preview_h;
        handle->video_res_supported.res[res].u16max_fps       = imx347_mipi_linear[res].senout.max_fps;
        handle->video_res_supported.res[res].u16min_fps       = imx347_mipi_linear[res].senout.min_fps;
        handle->video_res_supported.res[res].u16crop_start_x  = imx347_mipi_linear[res].senif.crop_start_X;
        handle->video_res_supported.res[res].u16crop_start_y  = imx347_mipi_linear[res].senif.crop_start_y;
        handle->video_res_supported.res[res].u16OutputWidth  = imx347_mipi_linear[res].senout.width;
        handle->video_res_supported.res[res].u16OutputHeight = imx347_mipi_linear[res].senout.height;
    ...
    handle->sensor_ae_info_cfg.u32AEShutter_max                   = 1000000000/imx347_mipi_linear[0].senout.min_fps;
...
int cus_camsensor_init_handle_hdr_dol_sef(ss_cus_sensor* drv_handle)
{
    ...
    //    sensor model ID             //
    ////////////////////////////////////
    sprintf(handle->strSensorStreamName,"IMX347_MIPI_HDR_SEF");
    ...
    handle->interface_attr.attr_mipi.mipi_hdr_mode                = SENSOR_HDR_MODE;  // SONY IMX347 as VC mode
    ...
    for (res = 0; res < HDR_RES_END; res++) {
        handle->video_res_supported.num_res = res+1;
        handle->video_res_supported.res[res].u16width         = imx347_mipi_hdr[res].senif.preview_w;
        handle->video_res_supported.res[res].u16height        = imx347_mipi_hdr[res].senif.preview_h;
        handle->video_res_supported.res[res].u16max_fps       = imx347_mipi_hdr[res].senout.max_fps;
        handle->video_res_supported.res[res].u16min_fps       = imx347_mipi_hdr[res].senout.min_fps;
        handle->video_res_supported.res[res].u16crop_start_x  = imx347_mipi_hdr[res].senif.crop_start_X;
        handle->video_res_supported.res[res].u16crop_start_y  = imx347_mipi_hdr[res].senif.crop_start_y;
        handle->video_res_supported.res[res].u16OutputWidth  = imx347_mipi_hdr[res].senout.width;
        handle->video_res_supported.res[res].u16OutputHeight = imx347_mipi_hdr[res].senout.height;
...
static int IMX347_GetShutterInfo_HDR_DOL_LEF(struct __ss_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
...
static int cus_camsensor_init_handle_hdr_dol_lef(ss_cus_sensor* drv_handle)
{
    ...
    //    sensor model ID             //
    ////////////////////////////////////
    sprintf(handle->strSensorStreamName,"IMX347_MIPI_HDR_LEF");
    ...
    handle->sensor_ae_info_cfg.u32AEGain_max                      = SENSOR_MAX_GAIN;
    handle->sensor_ae_info_cfg.u32AEShutter_min                   = (Preview_line_period_HDR_DOL_4LANE * 2);
    handle->sensor_ae_info_cfg.u32AEShutter_max                   = 1000000000/imx347_mipi_hdr[0].senout.min_fps;
    handle->sensor_ae_info_cfg.u32AEShutter_step                  = Preview_line_period_HDR_DOL_4LANE;
