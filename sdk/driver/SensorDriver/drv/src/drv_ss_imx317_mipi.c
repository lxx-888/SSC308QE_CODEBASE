...
int cus_camsensor_release_handle_dol_lef(ss_cus_sensor*handle);
...
static int imx317_SetPatternMode(ss_cus_sensor*handle,u32 mode)
{
    int i;
...
static int pCus_init_4lane_linear_30fps(ss_cus_sensor*handle)
{
    imx317_params *params = (imx317_params *)handle->private_data;
    int i, cnt;
...
static int pCus_init_4lane_linear_15fps(ss_cus_sensor*handle)
{
    imx317_params *params = (imx317_params *)handle->private_data;
    int i, cnt;
...
static int pCus_init_4lane_dol_30fps(ss_cus_sensor*handle)
{
    imx317_params *params = (imx317_params *)handle->private_data;
    int i,cnt=0;
...
static int pCus_init_4lane_dol_15fps(ss_cus_sensor*handle)
{
    imx317_params *params = (imx317_params *)handle->private_data;
    int i,cnt=0;
...
static int pCus_SetVideoRes(ss_cus_sensor*handle, u32 res_idx)
{
    ...
    switch (res_idx) {
        case 0: //"3840x2160@30fps"
            ...
            params->expo.fps = handle->video_res_supported.res[res_idx].u16max_fps;
...
static int pCus_sensor_GetAEInfo_SEF(ss_cus_sensor *handle, CUS_SENSOR_AE_INFO_t *info)
{
    ...
    info->u32AEGain_min                      = SENSOR_MIN_GAIN;
    info->u32AEGain_max                      = SENSOR_MAX_GAIN;
    info->u32AEShutter_min                   = params->expo.us_per_line * 2;
    info->u32AEShutter_max                   = 1000000000/handle->video_res_supported.res[handle->video_res_supported.ulcur_res].u16min_fps;
    info->u32AEShutter_step                  = params->expo.us_per_line;
    return SUCCESS;
}
...
static int pCus_sensor_GetAEInfo_LEF(ss_cus_sensor *handle, CUS_SENSOR_AE_INFO_t *info)
{
    ...
    info->u32AEGain_min                      = SENSOR_MIN_GAIN;
    info->u32AEGain_max                      = SENSOR_MAX_GAIN;
    info->u32AEShutter_min                   = params->expo.us_per_line * 4;
    info->u32AEShutter_max                   = 1000000000/handle->video_res_supported.res[handle->video_res_supported.ulcur_res].u16min_fps;
    info->u32AEShutter_step                  = params->expo.us_per_line;
    return SUCCESS;
}
...
int cus_camsensor_init_handle_linear(ss_cus_sensor* drv_handle)
{
    ...
    //    sensor model ID                                   //
    ////////////////////////////////////
    CamOsSnprintf(handle->strSensorStreamName,sizeof(handle->strSensorStreamName),"IMX317_MIPI");
    ...
    handle->video_res_supported.res[0].u16OutputHeight= 0x87E;
    handle->video_res_supported.res[0].u16RowTime = (1000000000 / (2310 * Preview_MAX_FPS));
    handle->video_res_supported.res[0].u16MinFrameLengthLine = 2310;
    //sprintf(handle->video_res_supported.res[0].strResDesc, "3840x2160@30fps");
    CamOsStrncpy(handle->video_res_supported.res[0].strResDesc, "3840x2160@30fps",CamOsStrlen("3840x2160@30fps"));
    ...
    handle->video_res_supported.res[1].u16max_fps= 15;
    ...
    handle->video_res_supported.res[1].u16OutputWidth= 0xF18;
    handle->video_res_supported.res[1].u16OutputHeight= 0x87E;
    handle->video_res_supported.res[1].u16RowTime = (1000000000 / (2243 * 15));
    handle->video_res_supported.res[1].u16MinFrameLengthLine = 2243;
    //sprintf(handle->video_res_supported.res[1].strResDesc, "3840x2160@15fps");
    CamOsStrncpy(handle->video_res_supported.res[1].strResDesc, "3840x2160@15fps",CamOsStrlen("3840x2160@15fps"));
    ...
    params->expo.vts = 4620;
    params->expo.fps = handle->video_res_supported.res[0].u16max_fps;
    params->expo.us_per_line = 1000000000 / (params->expo.vts * params->expo.fps);
...
int cus_camsensor_init_handle_hdr_dol_sef(ss_cus_sensor* drv_handle)
{
    ...
    CamOsSnprintf(handle->strSensorStreamName,sizeof(handle->strSensorStreamName),"IMX317_MIPI_HDR_SEF");
    ...
    handle->video_res_supported.res[0].u16crop_start_y= Preview_CROP_START_Y;
    handle->video_res_supported.res[0].u16OutputWidth= 0xF18;
    handle->video_res_supported.res[0].u16OutputHeight= 0x881;
    //sprintf(handle->video_res_supported.res[0].strResDesc, "3840x2160@30fps_HDR");
    CamOsStrncpy(handle->video_res_supported.res[0].strResDesc, "3840x2160@30fps_HDR",CamOsStrlen("3840x2160@30fps_HDR"));
    ...
    handle->video_res_supported.res[1].u16crop_start_y= Preview_CROP_START_Y;
    handle->video_res_supported.res[1].u16OutputWidth= 0xF18;
    handle->video_res_supported.res[1].u16OutputHeight= 0x881;
    //sprintf(handle->video_res_supported.res[1].strResDesc, "3840x2160@15fps_HDR");
    CamOsStrncpy(handle->video_res_supported.res[1].strResDesc, "3840x2160@15fps_HDR",CamOsStrlen("3840x2160@15fps_HDR"));
...
int cus_camsensor_init_handle_hdr_dol_lef(ss_cus_sensor* drv_handle)
{
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    CamOsSnprintf(handle->strSensorStreamName,sizeof(handle->strSensorStreamName),"IMX317_MIPI_HDR_LEF");
    ...
    handle->video_res_supported.res[0].u16crop_start_y= Preview_CROP_START_Y;
    handle->video_res_supported.res[0].u16OutputWidth= 0xF18;
    handle->video_res_supported.res[0].u16OutputHeight= 0x8AA;
    //sprintf(handle->video_res_supported.res[0].strResDesc, "3840x2160@30fps_HDR");
    CamOsStrncpy(handle->video_res_supported.res[0].strResDesc, "3840x2160@30fps_HDR",CamOsStrlen("3840x2160@30fps_HDR"));
    ...
    handle->video_res_supported.res[1].u16crop_start_y= Preview_CROP_START_Y;
    handle->video_res_supported.res[1].u16OutputWidth= 0xF18;
    handle->video_res_supported.res[1].u16OutputHeight= 0x8AA;
    //sprintf(handle->video_res_supported.res[1].strResDesc, "3840x2160@15fps_HDR");
    CamOsStrncpy(handle->video_res_supported.res[1].strResDesc, "3840x2160@15fps_HDR",CamOsStrlen("3840x2160@15fps_HDR"));
