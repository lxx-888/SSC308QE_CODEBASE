...
static int gc4653_SetPatternMode(ss_cus_sensor *handle,u32 mode)
{
...
static int gc4653_GetShutterInfo(struct __ss_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
...
int cus_camsensor_init_handle(ss_cus_sensor* drv_handle) {
   ss_cus_sensor *handle = drv_handle;
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    strcpy(handle->strSensorStreamName,"gc4653_MIPI");
