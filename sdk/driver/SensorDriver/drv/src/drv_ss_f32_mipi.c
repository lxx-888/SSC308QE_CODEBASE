...
static int F32_SetPatternMode(ss_cus_sensor *handle,u32 mode)
{
...
static int F32_GetShutterInfo(struct __ss_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
...
static int F32_GetShutterInfo_HDR_LEF(struct __ss_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
    info->max = 1000000000/Preview_MIN_FPS; ///12;
...
static int F32_GetShutterInfo_HDR_SEF(struct __ss_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
    F32_params *params = (F32_params *)handle->private_data;
...
static int cus_camsensor_init_handle(ss_cus_sensor* drv_handle) {
   ss_cus_sensor *handle = drv_handle;
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->strSensorStreamName,"F32_MIPI_Linear");
...
int cus_camsensor_init_handle_HDR_SEF(ss_cus_sensor* drv_handle)
{
    ...
    sprintf(handle->strSensorStreamName,"F32_MIPI_HDR_SEF");
    ...
    handle->sensor_ae_info_cfg.u32AEShutter_step                  = Preview_line_period_HDR*2;//2
...
int cus_camsensor_init_handle_HDR_LEF(ss_cus_sensor* drv_handle) {
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->strSensorStreamName,"F32_MIPI_HDR_LEF");
