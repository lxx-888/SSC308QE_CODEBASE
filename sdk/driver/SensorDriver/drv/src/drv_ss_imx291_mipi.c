...
//AE info
#define SENSOR_MAX_GAIN                       3980*1024
...
static int imx291_SetPatternMode(ss_cus_sensor *handle,u32 mode)
{
    int i;
    switch(mode)
    {
...
static int IMX291_GetShutterInfo(struct __ss_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
...
static int cus_camsensor_init_handle(ss_cus_sensor* drv_handle) {
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->strSensorStreamName,"IMX291_MIPI");
