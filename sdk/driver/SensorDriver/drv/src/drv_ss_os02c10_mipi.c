...
//AE info
#define SENSOR_MAX_GAIN                             (248 * 1024)
...
static struct {     // LINEAR
    ...
    {LINEAR_RES_1, {1920, 1080, 5, 30}, {0, 0, 1920, 1080}, {"1920x1080@30fps"}},
};
static struct {     // HDR
    // Modify it based on number of support resolution
    ...
    {HDR_RES_1, {1920, 1080, 5, 30}, {0, 0, 1920, 1080}, {"1920x1080@30fps_HDR"}},
};
...
static int pCus_sensor_GetAEInfo(ss_cus_sensor *handle, CUS_SENSOR_AE_INFO_t *info)
{
    ...
    else
    {
        ...
        {
            info->u32AEShutter_max                   = Preview_line_period_HDR * params->expo.max_short;
        }
        else
        {
            info->u32AEShutter_max                   = handle->sensor_ae_info_cfg.u32AEShutter_max;
...
/////////////////// image function /////////////////////////
static int OS02C10_SetPatternMode(ss_cus_sensor *handle,u32 mode)
{
...
static int pCus_SetFPS(ss_cus_sensor *handle, u32 fps);
//static int pCus_AEStatusNotify(ss_cus_sensor *handle, CUS_CAMSENSOR_AE_STATUS_NOTIFY status);
...
int cus_camsensor_init_handle_linear(ss_cus_sensor* drv_handle)
{
    ...
    sprintf(handle->strSensorStreamName,"OS02C10_MIPI");
    ...
    for (res = 0; res < LINEAR_RES_END; res++) {
        ...
        handle->video_res_supported.res[res].u16width             = os02c10_mipi_linear[res].senif.preview_w;
        handle->video_res_supported.res[res].u16height            = os02c10_mipi_linear[res].senif.preview_h;
        handle->video_res_supported.res[res].u16max_fps           = os02c10_mipi_linear[res].senout.max_fps;
        handle->video_res_supported.res[res].u16min_fps           = os02c10_mipi_linear[res].senout.min_fps;
        handle->video_res_supported.res[res].u16crop_start_x      = os02c10_mipi_linear[res].senif.crop_start_X;
        handle->video_res_supported.res[res].u16crop_start_y      = os02c10_mipi_linear[res].senif.crop_start_y;
        handle->video_res_supported.res[res].u16OutputWidth       = os02c10_mipi_linear[res].senout.width;
        handle->video_res_supported.res[res].u16OutputHeight      = os02c10_mipi_linear[res].senout.height;
        sprintf(handle->video_res_supported.res[res].strResDesc, os02c10_mipi_linear[res].senstr.strResDesc);
    }
    ...
    handle->sensor_ae_info_cfg.u32AEShutter_max                   = 1000000000/os02c10_mipi_linear[0].senout.min_fps;
...
int cus_camsensor_init_handle_hdr_dol_sef(ss_cus_sensor* drv_handle)
{
    ...
    params = (OS02C10_params *)handle->private_data;
    cus_camsensor_init_handle_linear(handle);

    ////////////////////////////////////////////////////
    // Sensor Stream Name info
    ////////////////////////////////////////////////////

    sprintf(handle->strSensorStreamName,"OS02C10_MIPI_HDR_SEF");
    ...
    for (res = 0; res < HDR_RES_END; res++) {
        handle->video_res_supported.num_res = res+1;
        handle->video_res_supported.res[res].u16width             = os02c10_mipi_hdr[res].senif.preview_w;
        handle->video_res_supported.res[res].u16height            = os02c10_mipi_hdr[res].senif.preview_h;
        handle->video_res_supported.res[res].u16max_fps           = os02c10_mipi_hdr[res].senout.max_fps;
        handle->video_res_supported.res[res].u16min_fps           = os02c10_mipi_hdr[res].senout.min_fps;
        handle->video_res_supported.res[res].u16crop_start_x      = os02c10_mipi_hdr[res].senif.crop_start_X;
        handle->video_res_supported.res[res].u16crop_start_y      = os02c10_mipi_hdr[res].senif.crop_start_y;
        handle->video_res_supported.res[res].u16OutputWidth       = os02c10_mipi_hdr[res].senout.width;
        handle->video_res_supported.res[res].u16OutputHeight      = os02c10_mipi_hdr[res].senout.height;
        sprintf(handle->video_res_supported.res[res].strResDesc, os02c10_mipi_hdr[res].senstr.strResDesc);
    }
    ...
    handle->sensor_ae_info_cfg.u32AEShutter_max                   = Preview_line_period_HDR * params->expo.max_short;
...
static int cus_camsensor_init_handle_hdr_dol_lef(ss_cus_sensor* drv_handle)
{
    ...
    sprintf(handle->strSensorStreamName,"OS02C10_MIPI_HDR_LEF");
    ...
    handle->sensor_ae_info_cfg.u32AEGain_max                      = SENSOR_MAX_GAIN;
    handle->sensor_ae_info_cfg.u32AEShutter_min                   = Preview_line_period_HDR;
    handle->sensor_ae_info_cfg.u32AEShutter_max                   = 1000000000/os02c10_mipi_hdr[0].senout.min_fps;
    handle->sensor_ae_info_cfg.u32AEShutter_step                  = Preview_line_period_HDR;
    handle->pCus_sensor_CustDefineFunction                        = pCus_sensor_CustDefineFunction;
    handle->pCus_sensor_GetAEInfo                                 = pCus_sensor_GetAEInfo;
    ///////////////////////////////////////////////////////
