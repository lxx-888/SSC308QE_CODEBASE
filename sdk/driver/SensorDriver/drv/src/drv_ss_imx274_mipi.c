...
static int pCus_SetAEUSecsHDR_DOL_SEF_Binning(ss_cus_sensor *handle, u32 us);
...
static int pCus_sensor_GetAEInfo(ss_cus_sensor *handle, CUS_SENSOR_AE_INFO_t *info)
{
    ...
    {
        info->u32AEShutter_step                  = Preview_line_period_HDR_DOL;
        if (handle->interface_attr.attr_mipi.mipi_hdr_virtual_channel_num == 1)
        {
            info->u32AEShutter_min                   = Preview_line_period_HDR_DOL*2;
            info->u32AEShutter_max                   = Preview_line_period_HDR_DOL*(params->vts_to_rhs1 - 2198 - Preview_CROP_START_Y_DOL);
        }
        else
        {
            info->u32AEShutter_min                   = Preview_line_period_HDR_DOL*4;
            info->u32AEShutter_max                   = handle->sensor_ae_info_cfg.u32AEShutter_max;
        }
    }
    return SUCCESS;
...
static int imx274_SetPatternMode(ss_cus_sensor *handle,u32 mode)
{
    int i;
  switch(mode)
  {
...
static int pCus_init_mipi4lane_linear_4K15fps(ss_cus_sensor *handle)
{
    imx274_params *params = (imx274_params *)handle->private_data;
    //SENSOR_DMSG("\n\n[%s]", __FUNCTION__);
    int i,cnt;
...
static int pCus_init_mipi4lane_linear_4K20fps(ss_cus_sensor *handle)
{
    imx274_params *params = (imx274_params *)handle->private_data;
    //SENSOR_DMSG("\n\n[%s]", __FUNCTION__);
    int i,cnt;
...
static int pCus_init_mipi4lane_linear_5M30fps(ss_cus_sensor *handle)
{
    imx274_params *params = (imx274_params *)handle->private_data;
    //SENSOR_DMSG("\n\n[%s]", __FUNCTION__);
    int i,cnt;
...
static int pCus_init_mipi4lane_linear_4P8M30fps(ss_cus_sensor *handle)
{
    imx274_params *params = (imx274_params *)handle->private_data;
    //SENSOR_DMSG("\n\n[%s]", __FUNCTION__);
    int i,cnt;
...
static int pCus_init_mipi4lane_linear_3P6M30fps(ss_cus_sensor *handle)
{
    imx274_params *params = (imx274_params *)handle->private_data;
    //SENSOR_DMSG("\n\n[%s]", __FUNCTION__);
    int i,cnt;
...
static int pCus_init_mipi4lane_linear_2M60fps(ss_cus_sensor *handle)
{
    imx274_params *params = (imx274_params *)handle->private_data;
    //SENSOR_DMSG("\n\n[%s]", __FUNCTION__);
    int i,cnt;
...
static int pCus_init_mipi4lane_linear_4K30fps(ss_cus_sensor *handle)
{
    imx274_params *params = (imx274_params *)handle->private_data;
    //SENSOR_DMSG("\n\n[%s]", __FUNCTION__);
    int i,cnt;
...
static int pCus_init_mipi4lane_HDR_DOL_4k15fps(ss_cus_sensor *handle)
{
    imx274_params *params = (imx274_params *)handle->private_data;
    int i,cnt=0;
...
static int pCus_init_mipi4lane_HDR_DOL_4k20fps(ss_cus_sensor *handle)
{
    imx274_params *params = (imx274_params *)handle->private_data;
    int i,cnt=0;
...
static int pCus_init_mipi4lane_HDR_DOL_4k30fps(ss_cus_sensor *handle)
{
    imx274_params *params = (imx274_params *)handle->private_data;
    int i,cnt=0;
...
static int pCus_init_mipi4lane_HDR_DOL_2M30fps(ss_cus_sensor *handle)
{
    imx274_params *params = (imx274_params *)handle->private_data;
    int i,cnt=0;
...
static int pCus_GetShutterInfo(struct __ss_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
...
#if 0
static int pCus_GetVideoRes_hdr_dol_lef( ss_cus_sensor *handle, u32 res_idx, cus_camsensor_res **res )
{
    *res = &handle->video_res_supported.res[res_idx];
    return SUCCESS;
}

static int pCus_SetVideoRes_hdr_dol_lef( ss_cus_sensor *handle, u32 res )
{
...
#if 0
static int pCus_GetShutterInfo_hdr_dol_lef(struct __ss_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
    info->max = 1000000000/Preview_MIN_FPS;
...
static int pCus_GetShutterInfo_hdr_dol_sef(struct __ss_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
    imx274_params *params = (imx274_params *)handle->private_data;
...
int cus_camsensor_init_handle_linear(ss_cus_sensor* drv_handle)
{
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->strSensorStreamName,"IMX274_MIPI_Linear");
    ...
    params->cur_orien      = SENSOR_ORIT;      //CUS_ORIT_M1F1;
    ...
    handle->video_res_supported.res[0].u16OutputWidth= 3864;
    handle->video_res_supported.res[0].u16OutputHeight= 2202;
    ...
    handle->video_res_supported.res[1].u16max_fps= 20;
    ...
    handle->video_res_supported.res[1].u16OutputWidth= 3864;
    handle->video_res_supported.res[1].u16OutputHeight= 2202;
    sprintf(handle->video_res_supported.res[1].strResDesc, "3840x2160@20fps");

    handle->video_res_supported.num_res = 3;
    handle->video_res_supported.ulcur_res = 0; //default resolution index is 0.
    handle->video_res_supported.res[2].u16width = 2592;
    handle->video_res_supported.res[2].u16height = 1944;
    handle->video_res_supported.res[2].u16max_fps= 30;
    handle->video_res_supported.res[2].u16min_fps= Preview_MIN_FPS;
    handle->video_res_supported.res[2].u16crop_start_x= Preview_CROP_START_X;
    handle->video_res_supported.res[2].u16crop_start_y= Preview_CROP_START_Y;
    handle->video_res_supported.res[2].u16OutputWidth= 2592;
    handle->video_res_supported.res[2].u16OutputHeight= 1944;
    sprintf(handle->video_res_supported.res[2].strResDesc, "2592x1944@30fps");

    handle->video_res_supported.num_res = 4;
    handle->video_res_supported.ulcur_res = 0; //default resolution index is 0.
    handle->video_res_supported.res[3].u16width = 2944;
    handle->video_res_supported.res[3].u16height = 1656;
    handle->video_res_supported.res[3].u16max_fps= 30;
    handle->video_res_supported.res[3].u16min_fps= Preview_MIN_FPS;
    handle->video_res_supported.res[3].u16crop_start_x= Preview_CROP_START_X;
    handle->video_res_supported.res[3].u16crop_start_y= Preview_CROP_START_Y;
    handle->video_res_supported.res[3].u16OutputWidth= 2944;
    handle->video_res_supported.res[3].u16OutputHeight= 1656;
    sprintf(handle->video_res_supported.res[3].strResDesc, "2944x1656@30fps");

    handle->video_res_supported.num_res = 5;
    handle->video_res_supported.ulcur_res = 0; //default resolution index is 0.
    handle->video_res_supported.res[4].u16width = 2560;
    handle->video_res_supported.res[4].u16height = 1440;
    handle->video_res_supported.res[4].u16max_fps= 30;
    handle->video_res_supported.res[4].u16min_fps= Preview_MIN_FPS;
    handle->video_res_supported.res[4].u16crop_start_x= Preview_CROP_START_X;
    handle->video_res_supported.res[4].u16crop_start_y= Preview_CROP_START_Y;
    handle->video_res_supported.res[4].u16OutputWidth= 2560;
    handle->video_res_supported.res[4].u16OutputHeight= 1440;
    sprintf(handle->video_res_supported.res[4].strResDesc, "2560x1440@30fps");

    handle->video_res_supported.num_res = 6;
    handle->video_res_supported.ulcur_res = 0; //default resolution index is 0.
    handle->video_res_supported.res[5].u16width = 1920;
    handle->video_res_supported.res[5].u16height = 1080;
    handle->video_res_supported.res[5].u16max_fps= 60;
    handle->video_res_supported.res[5].u16min_fps= Preview_MIN_FPS;
    handle->video_res_supported.res[5].u16crop_start_x= Preview_CROP_START_X;
    handle->video_res_supported.res[5].u16crop_start_y= Preview_CROP_START_Y;
    handle->video_res_supported.res[5].u16OutputWidth= 1920;
    handle->video_res_supported.res[5].u16OutputHeight= 1080;
    sprintf(handle->video_res_supported.res[5].strResDesc, "1920x1080@60fps");

    handle->video_res_supported.num_res = 7;
    handle->video_res_supported.ulcur_res = 0; //default resolution index is 0.
    handle->video_res_supported.res[6].u16width = Preview_WIDTH;
    handle->video_res_supported.res[6].u16height = Preview_HEIGHT;
    handle->video_res_supported.res[6].u16max_fps= 30;
    handle->video_res_supported.res[6].u16min_fps= Preview_MIN_FPS;
    handle->video_res_supported.res[6].u16crop_start_x= Preview_CROP_START_X;
    handle->video_res_supported.res[6].u16crop_start_y= Preview_CROP_START_Y;
    handle->video_res_supported.res[6].u16OutputWidth= 3864;
    handle->video_res_supported.res[6].u16OutputHeight= 2202;
...
int cus_camsensor_init_handle_hdr_dol_sef(ss_cus_sensor* drv_handle)
{
    ...
    sprintf(handle->strSensorStreamName,"IMX274_MIPI_HDR_SEF");
    ...
    handle->video_res_supported.res[0].u16min_fps= Preview_MIN_FPS;
    handle->video_res_supported.res[0].u16crop_start_x= Preview_CROP_START_X;
    handle->video_res_supported.res[0].u16crop_start_y= Preview_CROP_START_Y_DOL;
    handle->video_res_supported.res[0].u16OutputWidth= 0xF18;
    handle->video_res_supported.res[0].u16OutputHeight= 0x886;
    sprintf(handle->video_res_supported.res[0].strResDesc, "3840x2160@15fps_HDR");

    handle->video_res_supported.num_res = 2;
    handle->video_res_supported.ulcur_res = 0; //default resolution index is 0.
    handle->video_res_supported.res[1].u16width = 1920;
    handle->video_res_supported.res[1].u16height = 1080;
    handle->video_res_supported.res[1].u16max_fps= 30;
    handle->video_res_supported.res[1].u16min_fps= 3;
    handle->video_res_supported.res[1].u16crop_start_x= 0;
    handle->video_res_supported.res[1].u16crop_start_y= Preview_CROP_START_Y_DOL;
    handle->video_res_supported.res[1].u16OutputWidth= 0x78C;
    handle->video_res_supported.res[1].u16OutputHeight= 0x44E;
    sprintf(handle->video_res_supported.res[1].strResDesc, "1920x1080@30fps_HDR");

    handle->video_res_supported.num_res = 3;
    handle->video_res_supported.ulcur_res = 0; //default resolution index is 0.
    handle->video_res_supported.res[2].u16width = Preview_WIDTH;
    handle->video_res_supported.res[2].u16height = Preview_HEIGHT;
    handle->video_res_supported.res[2].u16max_fps= 20;
    handle->video_res_supported.res[2].u16min_fps= Preview_MIN_FPS;
    handle->video_res_supported.res[2].u16crop_start_x= Preview_CROP_START_X;
    handle->video_res_supported.res[2].u16crop_start_y= Preview_CROP_START_Y_DOL;
    handle->video_res_supported.res[2].u16OutputWidth= 0xF18;
    handle->video_res_supported.res[2].u16OutputHeight= 0x886;
    sprintf(handle->video_res_supported.res[2].strResDesc, "3840x2160@20fps_HDR");

    handle->video_res_supported.num_res = 4;
    handle->video_res_supported.ulcur_res = 0; //default resolution index is 0.
    handle->video_res_supported.res[3].u16width = Preview_WIDTH;
    handle->video_res_supported.res[3].u16height = Preview_HEIGHT;
    handle->video_res_supported.res[3].u16max_fps= 30;
    handle->video_res_supported.res[3].u16min_fps= Preview_MIN_FPS;
    handle->video_res_supported.res[3].u16crop_start_x= Preview_CROP_START_X;
    handle->video_res_supported.res[3].u16crop_start_y= Preview_CROP_START_Y_DOL+8;
    handle->video_res_supported.res[3].u16OutputWidth= 0xF18;
    handle->video_res_supported.res[3].u16OutputHeight= 0x886;
    ...
    handle->sensor_ae_info_cfg.u32AEGain_min                      = SENSOR_MIN_GAIN;
    handle->sensor_ae_info_cfg.u32AEGain_max                      = SENSOR_MAX_GAIN;
    handle->sensor_ae_info_cfg.u32AEShutter_min                   = Preview_line_period_HDR_DOL*2;
    handle->sensor_ae_info_cfg.u32AEShutter_max                   = Preview_line_period_HDR_DOL*(params->vts_to_rhs1 - 2198 - Preview_CROP_START_Y_DOL);
    handle->sensor_ae_info_cfg.u32AEShutter_step                  = Preview_line_period_HDR_DOL*1;
...
int cus_camsensor_init_handle_hdr_dol_lef(ss_cus_sensor* drv_handle)
{
    ss_cus_sensor *handle = drv_handle;
    imx274_params *params;
    if (!handle) {
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->strSensorStreamName,"IMX274_MIPI_HDR_LEF");
    ...
    handle->sensor_ae_info_cfg.u32AEGain_min                      = SENSOR_MIN_GAIN;
    handle->sensor_ae_info_cfg.u32AEGain_max                      = SENSOR_MAX_GAIN;
    handle->sensor_ae_info_cfg.u32AEShutter_min                   = Preview_line_period_HDR_DOL*4;
    handle->sensor_ae_info_cfg.u32AEShutter_max                   = 1000000000/Preview_MIN_FPS;
    handle->sensor_ae_info_cfg.u32AEShutter_step                  = Preview_line_period_HDR_DOL*1;
