...
//AE info
#define SENSOR_MAX_GAIN                       ((15875*31750)/1000000)
...
{
//cleaned_0x11_SC301IOT_MIPI_24Minput_2lane_10bit_540Mbps_2048x1536_30fps
    {0x0103,0x01},
    {0x0100,0x00},
    {0x36e9,0x80},
    {0x37f9,0x80},
...
static int pCus_SetAEGain(ss_cus_sensor *handle, u32 gain) {
    SC301iot_params *params = (SC301iot_params *)handle->private_data;
    u8 i=0 ;
    u32 gain_factor = 0, ANA_Fine_gain_reg =0x40, DIG_gain_reg=0x00, DIG_Fine_gain_reg=0x80;
    ...
    if (gain_factor < 1569)
    {
       ANA_Fine_gain_reg = 0x00;
       DIG_gain_reg = 0x00;
       DIG_Fine_gain_reg = gain_factor * 128 / 1000 ;

    }
    else if( gain_factor < 3138)
    {
       ANA_Fine_gain_reg = 0x40;
       DIG_gain_reg = 0x00;
       DIG_Fine_gain_reg = gain_factor * 128 / 1569 ;

    }
    else if( gain_factor < 6276)
    {
       ANA_Fine_gain_reg = 0x48;
       DIG_gain_reg = 0x00;
       DIG_Fine_gain_reg = gain_factor * 128 / 3138 ;

    }
    else if( gain_factor < 12522)
    {
       ANA_Fine_gain_reg = 0x49;
       DIG_gain_reg = 0x00;
       DIG_Fine_gain_reg = gain_factor * 128 / 6276 ;

    }
    else if( gain_factor < 25104)
    {
       ANA_Fine_gain_reg = 0x4b;
       DIG_gain_reg = 0x00;
       DIG_Fine_gain_reg = gain_factor * 128 / 12522 ;

    }
    else if( gain_factor < 50208)
    {
       ANA_Fine_gain_reg = 0x4f;
       DIG_gain_reg = 0x00;
       DIG_Fine_gain_reg = gain_factor * 128 / 25104 ;

    }
    else if( gain_factor < 50208*2)     // open dgain begin    max digital gain 31.5X
    {
        ANA_Fine_gain_reg = 0x5f;
        DIG_gain_reg = 0x00;
        DIG_Fine_gain_reg = gain_factor * 128 / 50208 ;

    }
    else if( gain_factor < 50208*4)
    {
        ANA_Fine_gain_reg = 0x5f;
        DIG_gain_reg = 0x01;
        DIG_Fine_gain_reg = gain_factor * 128 / 50208 / 2 ;

    }
    else if( gain_factor < 50208*8)
    {
        ANA_Fine_gain_reg = 0x5f;
        DIG_gain_reg = 0x03;
        DIG_Fine_gain_reg = gain_factor * 128 / 108512 / 4 ;

    }
    else if( gain_factor < 50208*16)
    {
        ANA_Fine_gain_reg = 0x5f;
        DIG_gain_reg = 0x07;
        DIG_Fine_gain_reg = gain_factor * 128 / 108512 / 8 ;

    }
    else if( gain_factor < 50208*31)
    {
        ANA_Fine_gain_reg = 0x5f;
        DIG_gain_reg = 0x0f;
        DIG_Fine_gain_reg = gain_factor * 128 / 108512 / 16 ;
    ...
    else
    {
        ANA_Fine_gain_reg = 0x5f;
        DIG_gain_reg = 0x0f;
        DIG_Fine_gain_reg = 0xf8;
    }

    params->tGain_reg[2].data = ANA_Fine_gain_reg;  // 0x3e09
    params->tGain_reg[1].data = DIG_Fine_gain_reg;  // 0x3e07
    params->tGain_reg[0].data = DIG_gain_reg;  // 0x3e06
