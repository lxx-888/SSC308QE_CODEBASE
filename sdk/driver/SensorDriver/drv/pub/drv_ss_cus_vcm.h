...
#ifndef DRV_SS_CUS_VCM_H_
#define DRV_SS_CUS_VCM_H_
...
typedef struct __ss_cus_vcm{
    ...
    @retval SUCCESS or FAIL if error occurs.
    */
    int (*pCus_vcm_PowerOn)(struct __ss_cus_vcm* handle, u32 idx);
    ...
    @retval SUCCESS or FAIL if error occurs.
    */
    int (*pCus_vcm_PowerOff)(struct __ss_cus_vcm* handle, u32 idx);
    ...
    */
    int (*pCus_vcm_Init)(struct __ss_cus_vcm* handle);
    ...
    */
    int (*pCus_vcm_SetPos)(struct __ss_cus_vcm* handle, u32 pos);
    ...
    @retval Return SUCCESS or FAIL if error occurs.
    */
    int (*pCus_vcm_GetCurPos)(struct __ss_cus_vcm* handle, u32 *cur_pos);
    ...
    */
    int (*pCus_vcm_GetMinMaxPos)(struct __ss_cus_vcm* handle, u32 *min_pos, u32 *max_pos);

} ss_cus_vcm;

typedef int (*VcmInitHandle)(ss_cus_vcm* handle);

#ifdef __cplusplus
}
#endif

#endif /* DRV_SS_CUS_VCM_H_ */
