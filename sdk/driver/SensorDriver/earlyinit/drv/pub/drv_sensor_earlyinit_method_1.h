...
#define CMDQ_STATUS_TEMP_READY 0x03
...
////////////////////////////////////////
#define SNR_HDR_SHUTTER_FPS_1A1D(slava_ddr, Lefshutter, Sefshutter, Mefshutter,fps)\
        sizeof(EarlyInitHDRShutterFps_t),  /*u8Size*/\
        E_EARLY_INIT_CMD_HDR_SHUTTER_FPS,   /*u8CmdID*/\
        (Lefshutter)&0xFF,\
        ((Lefshutter)>>8)&0xFF,\
        ((Lefshutter)>>16)&0xFF,\
        ((Lefshutter)>>24)&0xFF,\
...
#define SNR_HDR_SHUTTER_FPS_2A1D(slava_ddr,Lefshutter, Sefshutter, Mefshutter,fps)\
        sizeof(EarlyInitHDRShutterFps_t),  /*u8Size*/\
        E_EARLY_INIT_CMD_HDR_SHUTTER_FPS,   /*u8CmdID*/\
        (Lefshutter)&0xFF,\
        ((Lefshutter)>>8)&0xFF,\
...
#define SNR_HDR_SHUTTER_FPS_2A2D(slava_ddr,Lefshutter, Sefshutter, Mefshutter,fps)\
        sizeof(EarlyInitHDRShutterFps_t),  /*u8Size*/\
        E_EARLY_INIT_CMD_HDR_SHUTTER_FPS,   /*u8CmdID*/\
        (Lefshutter)&0xFF,\
        ((Lefshutter)>>8)&0xFF,\
...
#define SNR_HDR_GAIN_1A1D(slave_addr, Lefgain, Sefgain, Mefgain)\
        sizeof(EarlyInitHDRGain_t),         /*u8Size*/\
        E_EARLY_INIT_CMD_HDR_GAIN,       /*u8CmdID*/\
        (Lefgain)&0xFF,\
        ((Lefgain)>>8)&0xFF,\
        ((Lefgain)>>16)&0xFF,\
        ((Lefgain)>>24)&0xFF,\
...
#define SNR_HDR_GAIN_2A1D(slave_addr, Lefgain, Sefgain, Mefgain)\
        sizeof(EarlyInitHDRGain_t),         /*u8Size*/\
        E_EARLY_INIT_CMD_HDR_GAIN,       /*u8CmdID*/\
        (Lefgain)&0xFF,\
        ((Lefgain)>>8)&0xFF,\
...
#define SNR_HDR_GAIN_2A2D(slave_addr, Lefgain, Sefgain, Mefgain)\
        sizeof(EarlyInitHDRGain_t),         /*u8Size*/\
        E_EARLY_INIT_CMD_HDR_GAIN,       /*u8CmdID*/\
        (Lefgain)&0xFF,\
        ((Lefgain)>>8)&0xFF,\
...
#define SNR_ORIENTATION_1A1D(slava_ddr,Mirror,Flip)\
        sizeof(EarlyInitOrientation_t),  /*u8Size*/\
        E_EARLY_INIT_CMD_ORITATION,      /*u8CmdID*/\
        Mirror,\
        Flip,\
        slava_ddr,\
        E_EARLY_INIT_CMD_I2C_1A1D_W

#define SNR_ORIENTATION_2A1D(slava_ddr,Mirror,Flip)\
        sizeof(EarlyInitOrientation_t),  /*u8Size*/\
        E_EARLY_INIT_CMD_ORITATION,      /*u8CmdID*/\
        Mirror,\
        Flip,\
...
#define SNR_ORIENTATION_2A2D(slava_ddr,Mirror,Flip)\
        sizeof(EarlyInitOrientation_t),  /*u8Size*/\
        E_EARLY_INIT_CMD_ORITATION,      /*u8CmdID*/\
        Mirror,\
        Flip,\
...
#define SNR_STREAM_ONOFF_1A1D(slava_ddr,StreamOnOff)\
        sizeof(EarlyInitStreamOnoff_t),  /*u8Size*/\
        E_EARLY_INIT_CMD_STREAM_ONOFF,   /*u8CmdID*/\
        StreamOnOff,\
        slava_ddr,\
        E_EARLY_INIT_CMD_I2C_1A1D_W

#define SNR_STREAM_ONOFF_2A1D(slava_ddr,StreamOnOff)\
        sizeof(EarlyInitStreamOnoff_t),  /*u8Size*/\
        E_EARLY_INIT_CMD_STREAM_ONOFF,   /*u8CmdID*/\
        StreamOnOff,\
        slava_ddr,\
...
#define SNR_STREAM_ONOFF_2A2D(slava_ddr,StreamOnOff)\
        sizeof(EarlyInitStreamOnoff_t),  /*u8Size*/\
        E_EARLY_INIT_CMD_STREAM_ONOFF,   /*u8CmdID*/\
        StreamOnOff,\
        slava_ddr,\
...
#define SNR_CSI_CONFIG(u32clk,u32pack,u32pack2,u8lane,u8hdr)\
            sizeof(EarlyInitCsiCfg_t),  /*u8Size*/\
            E_EARLY_INIT_CMD_CSI_CONFIG,   /*u8CmdID*/\
            (u32clk)&0xFF,\
            ((u32clk)>>8)&0xFF,\
            ((u32clk)>>16)&0xFF,\
            ((u32clk)>>24)&0xFF,\
