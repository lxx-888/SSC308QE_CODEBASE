...
#ifndef _SS_UVC_XU_DATATYPE_H_
#define _SS_UVC_XU_DATATYPE_H_
...
typedef struct _MSX_face_authentication {
    char bNumEntries;
    char bInterfaceNumber;
    char bmControlFlags0;
    char bmControlFlags1;
    char bmControlFlags2;
    char bmControlFlags3;
    char bmControlFlags4;
    char bmControlFlags5;
    char bmControlFlags6;
} MSX_face_authentication;

typedef struct _MSX_metadata_control {
    unsigned long dwValue_Metadata ;
} MSX_metadata_control;
