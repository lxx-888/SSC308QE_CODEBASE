...
*/
#ifndef _SS_UVC_DATATYPE_H_
#define _SS_UVC_DATATYPE_H_
...
#define DWC3_DIR "/sys/class/udc/1f100400.dwc3"

#define v4l2_fourcc_usr(a, b, c, d)\
    ((__u32)(a) | ((__u32)(b) << 8) | ((__u32)(c) << 16) | ((__u32)(d) << 24))
#define UVC_SUPPORT_DEBUG
#define UVC_VC_EXTENSION1_UNIT_ID   6 //ISP
#define UVC_VC_EXTENSION2_UNIT_ID   2 //customer
#define UVC_VC_EXTENSION3_UNIT_ID   4 //Microsoft
...
static const struct uvc_frame_info uvc_frames_yuyv[] = {
    ...
    { 2592, 1944,{ 333333, 666666, 1000000, 0 }, },
...
static const struct uvc_frame_info uvc_frames_mjpg[] = {
    ...
    { 2592, 1944,{ 333333,  666666, 1000000, 0 }, },
    { 3840,2160, { 333333,  666666, 1000000, 0 }, },
    { 8160,2448, { 333333, 666666, 1000000,  0 }, },
    { 0, 0, { 0, }, },
};
...
static const struct uvc_frame_info uvc_frames_ir[] = {
    {  340, 340, { 333333, 666666, 1000000,  0 }, },
    { 0, 0, { 0, }, },
};

static const struct uvc_frame_info uvc_frames_av1[] = {
    {  320, 240, { 333333, 666666, 1000000,  0 }, },
    {  640, 480, { 333333, 666666, 1000000,  0 }, },
    { 1280, 720, { 333333, 666666, 1000000,  0 }, },
    { 1920,1080, { 333333, 666666, 1000000,  0 }, },
...
static const struct uvc_format_info uvc_formats_wh[] = {
...
static const struct uvc_format_info uvc_formats[] = {
    ...
    { V4L2_PIX_FMT_AV01,  uvc_frames_av1  },
};

static const struct uvc_format_info uvc_formats_ir[] = {
    { V4L2_PIX_FMT_GREY,  uvc_frames_ir },
};
...
static const struct uvc_frame_info uvc_still_frames_av1[] = {
    { 1920,1080, { 0, }, },
    { 0, 0, { 0, }, },
};
...
static const struct uvc_format_info uvc_still_formats[] = {
    ...
    { V4L2_PIX_FMT_H265,  uvc_still_frames_av1  },
};
...
typedef struct SS_UVC_Setting_s {
    /* buffer related*/
    uint8_t nbuf;
    /* payload related*/
    uint32_t maxpacket;
    ...
    UVC_DEV_TYPE_e dev_type;
} SS_UVC_Setting_t;

typedef struct SS_UVC_BufInfo_s {
...
typedef struct SS_UVC_USERPTR_BufOpts_s {
    int32_t  (* UVC_DevFillBuffer)(void *uvc,SS_UVC_BufInfo_t *bufInfo);
    int32_t  (* UVC_DevFinishBuffer)(void *uvc,SS_UVC_BufInfo_t *bufInfo);
} SS_UVC_USERPTR_BufOpts_t;

typedef struct SS_UVC_MMAP_BufOpts_s {
    int32_t  (* UVC_DevFillBuffer)(void *uvc,SS_UVC_BufInfo_t *bufInfo);
} SS_UVC_MMAP_BufOpts_t;

typedef struct SS_UVC_OPS_s {
    int32_t  (* UVC_Inputdev_Init)  (void *uvc);
    int32_t  (* UVC_Inputdev_Deinit)(void *uvc);
    union {
        SS_UVC_MMAP_BufOpts_t m;
        SS_UVC_USERPTR_BufOpts_t u;
    };
...
typedef struct SS_UVC_ChnAttr_s {
    SS_UVC_Setting_t setting;
    SS_UVC_OPS_t fops;
} SS_UVC_ChnAttr_t;

typedef struct SS_UVC_Device_s {
...
#define GET_NOD(magic) (magic & UVC_NOD_MAGIC_MASK)
    ...
    struct list_head ListHeadRoi;
    pthread_mutex_t ListMutexRoi;

} SS_UVC_Device_t;

typedef void* SS_UVC_Handle_h;
#endif //_SS_UVC_DATATYPE_H_
