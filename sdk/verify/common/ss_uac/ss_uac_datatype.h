...
*/
#ifndef _SS_UAC_DATATYPE_H_
#define _SS_UAC_DATATYPE_H_
...
typedef struct SS_UAC_Frame_s {
    SS_AUDIO_BitWidth_e bitwith;
    void *data;
    uint32_t length;
} SS_UAC_Frame_t;

typedef struct SS_UAC_Volume_s {
    int32_t  s32Min;
    int32_t  s32Max;
    int32_t  s32Volume;
} SS_UAC_Volume_t;

typedef struct SS_UAC_Config_s {
    uint8_t card;
    uint8_t device;
    uint32_t flags;
...
typedef struct SS_UAC_OPS_s {
    int32_t  (* UAC_AUDIO_Init)(void *, uint32_t, uint8_t);
    int32_t  (* UAC_AUDIO_BufTask)(void *, SS_UAC_Frame_t *);
    int32_t  (* UAC_AUDIO_Deinit)(void *);
    int32_t  (* UAC_AUDIO_SetVol)(SS_UAC_Volume_t);
} SS_UAC_OPS_t;

typedef struct SS_UAC_Device_s {
    int32_t magic;
...
} SS_UAC_ControlType_e;

typedef void* SS_UAC_Handle_h;
#define SS_UAC_SUCCESS 0
#endif//_SS_UAC_DATATYPE_H_
