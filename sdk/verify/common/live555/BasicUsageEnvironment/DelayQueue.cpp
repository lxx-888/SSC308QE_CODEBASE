...
///// DelayQueue /////
pthread_mutex_t DelayQueue::m_ObjMutex = PTHREAD_MUTEX_INITIALIZER;
...
void DelayQueue::synchronize() {
  ...
  while ((NULL != curEntry) && (timeSinceLastSync >= curEntry->fDeltaTimeRemaining)) {
