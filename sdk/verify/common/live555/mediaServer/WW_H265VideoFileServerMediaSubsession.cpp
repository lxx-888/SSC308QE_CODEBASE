                                        ...
                                        , unsigned bitRate)
{
	...
	return new WW_H265VideoFileServerMediaSubsession(env, fileName, reuseFirstSource
									...
									, iFrameRate
                                    , CallbackFunArg, iCallbackFunArgSize, copyArgFlag, usingDiscreteFramer
                                    , maxSize, bitRate);
}
	...
	, fFileSize(0)
{
    ...
    m_usingDiscreteFramer = usingDiscreteFramer;
...
FramedSource* WW_H265VideoFileServerMediaSubsession::createNewStreamSource(unsigned /*clientSessionId*/, unsigned& estBitrate)
{
    ...
    if (m_usingDiscreteFramer)
    {
        return H265VideoStreamDiscreteFramer::createNew(envir(), fileSource);
    }
...
void WW_H265VideoFileServerMediaSubsession::startStream(unsigned clientSessionId,
						void* streamToken,
