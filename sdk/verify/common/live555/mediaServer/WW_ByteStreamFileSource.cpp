...
void WW_ByteStreamFileSource::doReadFromFile() 
{
	...
	struct timeval presentationTime = {.tv_sec = -1, .tv_usec = -1};
	fFrameSize = 0;
	int iFrameSize = m_ReadStreamFun(fFid, fTo, fMaxSize, &presentationTime, m_CallbackFunArg);
