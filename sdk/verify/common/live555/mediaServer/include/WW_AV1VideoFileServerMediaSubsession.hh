...
#ifndef _WW_AV1_VIDEO_FILE_SERVER_MEDIA_SUBSESSION_HH
#define _WW_AV1_VIDEO_FILE_SERVER_MEDIA_SUBSESSION_HH


#include "OnDemandServerMediaSubsession.hh"

#include "WW_CallbackFunction.hh"
class WW_AV1VideoFileServerMediaSubsession: public OnDemandServerMediaSubsession {
public:
	static WW_AV1VideoFileServerMediaSubsession*createNew(UsageEnvironment& env
...
protected:
	WW_AV1VideoFileServerMediaSubsession(UsageEnvironment& env, char const* fileName
	...
	virtual ~WW_AV1VideoFileServerMediaSubsession();

	void setDoneFlag() { fDoneFlag = ~0; }

protected: // redefined virtual functions
    // Canlet virtual char const* sdpLines();
