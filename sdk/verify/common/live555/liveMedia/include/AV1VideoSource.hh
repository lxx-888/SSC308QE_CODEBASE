...
#define _AV1_VIDEO_SOURCE_HH

#ifndef _FRAMED_SOURCE_HH
#include "FramedSource.hh"
#endif

class AV1VideoSource: public FramedSource {
public:
...
protected:
  AV1VideoSource(UsageEnvironment& env); // abstract base class
  virtual ~AV1VideoSource();

private:
  // redefined virtual functions:
  virtual Boolean isAV1VideoSource() const;
};
