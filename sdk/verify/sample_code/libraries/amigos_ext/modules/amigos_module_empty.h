...
#ifndef __AMIGOS_MODULE_EMPTY_H__
#define __AMIGOS_MODULE_EMPTY_H__

#include "amigos_module_base.h"
#include "amigos_surface_empty.h"
#include "ss_packet.h"

class AmigosModuleEmpty: public AmigosSurfaceEmpty, public AmigosModuleBase
{
    public:
        explicit AmigosModuleEmpty(const std::string &strInSection);
        ~AmigosModuleEmpty() override;
