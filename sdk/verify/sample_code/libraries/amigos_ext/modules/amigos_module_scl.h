...
#ifndef __AMIGOS_MODULE_SCL_H__
#define __AMIGOS_MODULE_SCL_H__
...
class AmigosModuleScl : public AmigosSurfaceScl, public AmigosModuleSclBase
{
public:
    explicit AmigosModuleScl(const std::string &strSection);
    ~AmigosModuleScl() override;
