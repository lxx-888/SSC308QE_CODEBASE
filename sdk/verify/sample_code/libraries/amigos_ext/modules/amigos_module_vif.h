...
#ifndef __AMIGOS_MODULE_VIF_H__
#define __AMIGOS_MODULE_VIF_H__

#include "amigos_module_mi_base.h"
#include "amigos_surface_vif.h"

class AmigosModuleVif: public AmigosSurfaceVif, public AmigosModuleMiBase
{
    public:
        explicit AmigosModuleVif(const std::string &strInSection);
        ~AmigosModuleVif() override;
    ...
    private:
        ...
        AmigosSurfaceVif *pVifSurface;
        static std::map<unsigned int, unsigned int> mapGroupEnable;
};
#endif
