...
*/
#ifndef __AMIGOS_MODULE_AUDIOENCODE_H__
#define __AMIGOS_MODULE_AUDIOENCODE_H__

#include "amigos_surface_audioencode.h"
#include "amigos_module_base.h"
#include "audio_code.hpp"

class AmigosModuleAudioEncode : public AmigosSurfaceAudioEncode, public AmigosModuleBase
{
public:
    explicit AmigosModuleAudioEncode(const std::string &strInSection);
    ~AmigosModuleAudioEncode() override;
...
#endif // !__AMIGOS_MODULE_AUDIOENCODE_H__
