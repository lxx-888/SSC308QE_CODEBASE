...
#ifndef __AMIGOS_MODULE_HVP_H__
#define __AMIGOS_MODULE_HVP_H__

#include "amigos_module_mi_base.h"
#include "amigos_surface_hvp.h"

class AmigosModuleHvp: public AmigosSurfaceHvp, public AmigosModuleMiBase
{
    public:
        explicit AmigosModuleHvp(const std::string &strInSection);
        ~AmigosModuleHvp() override;
