...
#ifndef __AMIGOS_MODULE_OSD_H__
#define __AMIGOS_MODULE_OSD_H__

#include "amigos_module_base.h"
#include "amigos_surface_osd.h"
#include "ss_packet.h"

class AmigosModuleOsd: public AmigosSurfaceOsd, public AmigosModuleBase
{
    public:
        explicit AmigosModuleOsd(const std::string &strInSection);
        ~AmigosModuleOsd() override;
