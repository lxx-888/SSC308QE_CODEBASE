...
*/
#ifndef __AMIGOS_MODULE_DISP_H__
#define __AMIGOS_MODULE_DISP_H__

#include "amigos_module_mi_base.h"
#include "amigos_surface_disp.h"

class AmigosModuleDisp: public AmigosSurfaceDisp, public AmigosModuleMiBase
{
    public:
        explicit AmigosModuleDisp(const std::string &strInSection);
        ~AmigosModuleDisp() override;
