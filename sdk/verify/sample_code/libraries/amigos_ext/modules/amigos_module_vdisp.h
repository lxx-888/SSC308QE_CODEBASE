...
#ifndef __AMIGOS_MODULE_VDISP_H__
#define __AMIGOS_MODULE_VDISP_H__

#include "amigos_module_mi_base.h"
#include "amigos_surface_vdisp.h"

class AmigosModuleVdisp: public AmigosSurfaceVdisp, public AmigosModuleMiBase
{
    public:
        explicit AmigosModuleVdisp(const std::string &strInSection);
        ~AmigosModuleVdisp() override;
