...
SRC += $(MODULE_PATH)/ptree_kernel.c
CLANG_FORMAT_ENABLE := yes
CLANG_TIDY_ENABLE   := yes
#CLANG_FORMAT_FILTER += $(MODULE_PATH)/ptree_kernel.c
CLANG_TIDY_FILTER   += $(MODULE_PATH)/ptree_kernel.c
...
CLANG_FORMAT_FILTER += $(MODULE_PATH)/auto_gen_ptree_bin.h
CLANG_TIDY_FILTER   += $(MODULE_PATH)/auto_gen_ptree_bin.h

KO_NAME := sstar_ptree_ext
